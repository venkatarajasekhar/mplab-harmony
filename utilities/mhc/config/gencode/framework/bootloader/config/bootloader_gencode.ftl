...
config BOOTLOADER_APP_USART_BAUDRATE_INDEX${INSTANCE}
	int
	set DRV_USART_BAUD_RATE_IDX0 to "115200" if BOOTLOADER_APP_USART_INSTANCE_INDEX${INSTANCE} = 0
	set DRV_USART_BAUD_RATE_IDX1 to "115200" if BOOTLOADER_APP_USART_INSTANCE_INDEX${INSTANCE} = 1
	set DRV_USART_BAUD_RATE_IDX2 to "115200" if BOOTLOADER_APP_USART_INSTANCE_INDEX${INSTANCE} = 2
	set DRV_USART_BAUD_RATE_IDX3 to "115200" if BOOTLOADER_APP_USART_INSTANCE_INDEX${INSTANCE} = 3
	set DRV_USART_BAUD_RATE_IDX4 to "115200" if BOOTLOADER_APP_USART_INSTANCE_INDEX${INSTANCE} = 4
	set DRV_USART_BAUD_RATE_IDX5 to "115200" if BOOTLOADER_APP_USART_INSTANCE_INDEX${INSTANCE} = 5		

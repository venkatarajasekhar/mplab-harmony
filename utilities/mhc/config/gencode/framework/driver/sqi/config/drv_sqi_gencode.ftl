...
config APP_DRV_SST26_SQI_DMA${INSTANCE}
    ...
    default n
    set DRV_SQI_DRIVER_MODE to "DYNAMIC" if APP_DRV_SST26_SQI_DMA${INSTANCE}
	set USE_DRV_SQI_DEVICE_0 to n if APP_DRV_SST26_SQI_DMA${INSTANCE}
	set USE_DRV_SQI_DEVICE_1 to y if APP_DRV_SST26_SQI_DMA${INSTANCE}
	set DRV_SQI_DEVICE_1_LSB_FIRST to n if APP_DRV_SST26_SQI_DMA${INSTANCE}
	set SYS_CLK_REFCLK1_ENABLE to y if APP_DRV_SST26_SQI_DMA${INSTANCE}
	set SYS_CLK_RODIV1 to 1 if  APP_DRV_SST26_SQI_DMA${INSTANCE}
    ---help---
    <!DOCTYPE HTML>
    <html>

...
static uint32_t __attribute__ ((aligned (16))) ${APP_NAME?lower_case}_sst26_write_buffer[XFER_SIZE];
static uint32_t __attribute__ ((aligned (16))) ${APP_NAME?lower_case}_sst26_read_buffer[XFER_SIZE];
</#if>
</#macro>

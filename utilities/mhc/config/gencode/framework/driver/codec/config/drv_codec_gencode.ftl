...
config GENERATE_CODE_DRV_AK4384${INSTANCE}
	...
	set SELECT_DRV_AK4384 to y if GENERATE_CODE_DRV_AK4384${INSTANCE} 
	set USE_DRV_AK4384_MCLK to n if GENERATE_CODE_DRV_AK4384${INSTANCE} 
	set DRV_I2S_ENABLE_DMA to y if GENERATE_CODE_DRV_AK4384${INSTANCE} 
	set DRV_I2S_SUPPORT_TRANSMIT_DMA to y if GENERATE_CODE_DRV_AK4384${INSTANCE}
	set DRV_I2S_BAUD_RATE to 48000 if GENERATE_CODE_DRV_AK4384${INSTANCE}
	set DRV_I2S_AUDIO_PROTOCOL_MODE_IDX0 to "DRV_I2S_AUDIO_RIGHT_JUSTIFIED" if GENERATE_CODE_DRV_AK4384${INSTANCE}
	set SPI_AUDIO_COMM_WIDTH_IDX0 to "SPI_AUDIO_COMMUNICATION_16DATA_16FIFO_32CHANNEL" if GENERATE_CODE_DRV_AK4384${INSTANCE}
	set DRV_TMR_PERIPHERAL_ID_IDX0 to "TMR_ID_4" if GENERATE_CODE_DRV_AK4384${INSTANCE}
	set DRV_TMR_INTERRUPT_PRIORITY_IDX0 to "INT_PRIORITY_LEVEL4" if GENERATE_CODE_DRV_AK4384${INSTANCE}
	set SYS_CLK_REFCLK_ENABLE to y if GENERATE_CODE_DRV_AK4384${INSTANCE}
	set SYS_CLK_REFCLK_OE to y if GENERATE_CODE_DRV_AK4384${INSTANCE}
	set SYS_CLK_REFCLK_SOURCE to "USB PLL UPLL" if GENERATE_CODE_DRV_AK4384${INSTANCE}
	set SYS_CLK_RODIV to 3 if GENERATE_CODE_DRV_AK4384${INSTANCE}
	set SYS_CLK_ROTRIM to 464 if GENERATE_CODE_DRV_AK4384${INSTANCE}
	set SYS_CLK_CONFIG_SECONDARY_XTAL to 32768 if GENERATE_CODE_DRV_AK4384${INSTANCE}
	set SYS_DMA_CHANNEL_ID_IDX0 to "DMA_CHANNEL_2" if GENERATE_CODE_DRV_AK4384${INSTANCE}
	set SYS_DMA_INTERRUPT_PRIORITY_CH0 to "INT_PRIORITY_LEVEL2" if GENERATE_CODE_DRV_AK4384${INSTANCE}
	set USE_SYS_PORTS_CN_INTERRUPT to y if GENERATE_CODE_DRV_AK4384${INSTANCE}
	set SYS_PORTS_CN_INTERRUPT_PRIORITY to "INT_PRIORITY_LEVEL5" if GENERATE_CODE_DRV_AK4384${INSTANCE}
	set XC32_HEAP to "8000" if GENERATE_CODE_DRV_AK4384${INSTANCE}
	default n
    ---help---
	<!DOCTYPE HTML>
	<html>

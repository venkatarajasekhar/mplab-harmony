...
config GENERATE_CODE_DRV_I2C${INSTANCE}
    bool "I2C?"
    default n
    set USE_DRV_I2C to y if GENERATE_CODE_DRV_I2C${INSTANCE}
    ---help---
...
config APP_DRV_I2C_MASTER_TRANSMIT${INSTANCE}
    ...
    default n
	set DRV_I2C_DRIVER_MODE to "DYNAMIC" if APP_DRV_I2C_MASTER_TRANSMIT${INSTANCE} 
	set DRV_I2C_INTERRUPT_MODE to y if APP_DRV_I2C_MASTER_TRANSMIT${INSTANCE}
    set DRV_I2C_OPERATION_MODE_IDX0 to "DRV_I2C_MODE_MASTER" if APP_DRV_I2C_MASTER_TRANSMIT${INSTANCE} = y  && APP_DRV_I2C_INSTANCE_INDEX${INSTANCE} = 0
    set DRV_I2C_OPERATION_MODE_IDX1 to "DRV_I2C_MODE_MASTER" if APP_DRV_I2C_MASTER_TRANSMIT${INSTANCE} = y  && APP_DRV_I2C_INSTANCE_INDEX${INSTANCE} = 1
    set DRV_I2C_OPERATION_MODE_IDX2 to "DRV_I2C_MODE_MASTER" if APP_DRV_I2C_MASTER_TRANSMIT${INSTANCE} = y  && APP_DRV_I2C_INSTANCE_INDEX${INSTANCE} = 2
    set DRV_I2C_OPERATION_MODE_IDX3 to "DRV_I2C_MODE_MASTER" if APP_DRV_I2C_MASTER_TRANSMIT${INSTANCE} = y  && APP_DRV_I2C_INSTANCE_INDEX${INSTANCE} = 3
    set DRV_I2C_OPERATION_MODE_IDX4 to "DRV_I2C_MODE_MASTER" if APP_DRV_I2C_MASTER_TRANSMIT${INSTANCE} = y  && APP_DRV_I2C_INSTANCE_INDEX${INSTANCE} = 4
    #set DRV_I2C_OPERATION_MODE_IDX5 to "DRV_I2C_MODE_MASTER" if APP_DRV_I2C_MASTER_TRANSMIT${INSTANCE} = y  && APP_DRV_I2C_INSTANCE_INDEX${INSTANCE} = 5
    #set DRV_I2C_OPERATION_MODE_IDX6 to "DRV_I2C_MODE_MASTER" if APP_DRV_I2C_MASTER_TRANSMIT${INSTANCE} = y  && APP_DRV_I2C_INSTANCE_INDEX${INSTANCE} = 6
    #set DRV_I2C_OPERATION_MODE_IDX7 to "DRV_I2C_MODE_MASTER" if APP_DRV_I2C_MASTER_TRANSMIT${INSTANCE} = y  && APP_DRV_I2C_INSTANCE_INDEX${INSTANCE} = 7
    #set DRV_I2C_OPERATION_MODE_IDX8 to "DRV_I2C_MODE_MASTER" if APP_DRV_I2C_MASTER_TRANSMIT${INSTANCE} = y  && APP_DRV_I2C_INSTANCE_INDEX${INSTANCE} = 8
    #set DRV_I2C_OPERATION_MODE_IDX9 to "DRV_I2C_MODE_MASTER" if APP_DRV_I2C_MASTER_TRANSMIT${INSTANCE} = y  && APP_DRV_I2C_INSTANCE_INDEX${INSTANCE} = 9
...
config APP_DRV_I2C_SLAVE_RECEIVE${INSTANCE}
	...
	set DRV_I2C_DRIVER_MODE to "DYNAMIC" if APP_DRV_I2C_SLAVE_RECEIVE${INSTANCE} 
	set DRV_I2C_INTERRUPT_MODE to y if APP_DRV_I2C_SLAVE_RECEIVE${INSTANCE}
    set DRV_I2C_OPERATION_MODE_IDX0 to "DRV_I2C_MODE_SLAVE" if APP_DRV_I2C_SLAVE_RECEIVE${INSTANCE} = y  && APP_DRV_I2C_INSTANCE_INDEX${INSTANCE} = 0
    set DRV_I2C_OPERATION_MODE_IDX1 to "DRV_I2C_MODE_SLAVE" if APP_DRV_I2C_SLAVE_RECEIVE${INSTANCE} = y  && APP_DRV_I2C_INSTANCE_INDEX${INSTANCE} = 1
    set DRV_I2C_OPERATION_MODE_IDX2 to "DRV_I2C_MODE_SLAVE" if APP_DRV_I2C_SLAVE_RECEIVE${INSTANCE} = y  && APP_DRV_I2C_INSTANCE_INDEX${INSTANCE} = 2
    set DRV_I2C_OPERATION_MODE_IDX3 to "DRV_I2C_MODE_SLAVE" if APP_DRV_I2C_SLAVE_RECEIVE${INSTANCE} = y  && APP_DRV_I2C_INSTANCE_INDEX${INSTANCE} = 3
    set DRV_I2C_OPERATION_MODE_IDX4 to "DRV_I2C_MODE_SLAVE" if APP_DRV_I2C_SLAVE_RECEIVE${INSTANCE} = y  && APP_DRV_I2C_INSTANCE_INDEX${INSTANCE} = 4
    #set DRV_I2C_OPERATION_MODE_IDX5 to "DRV_I2C_MODE_SLAVE" if APP_DRV_I2C_SLAVE_RECEIVE${INSTANCE} = y  && APP_DRV_I2C_INSTANCE_INDEX${INSTANCE} = 5
    #set DRV_I2C_OPERATION_MODE_IDX6 to "DRV_I2C_MODE_SLAVE" if APP_DRV_I2C_SLAVE_RECEIVE${INSTANCE} = y  && APP_DRV_I2C_INSTANCE_INDEX${INSTANCE} = 6
    #set DRV_I2C_OPERATION_MODE_IDX7 to "DRV_I2C_MODE_SLAVE" if APP_DRV_I2C_SLAVE_RECEIVE${INSTANCE} = y  && APP_DRV_I2C_INSTANCE_INDEX${INSTANCE} = 7
    #set DRV_I2C_OPERATION_MODE_IDX8 to "DRV_I2C_MODE_SLAVE" if APP_DRV_I2C_SLAVE_RECEIVE${INSTANCE} = y  && APP_DRV_I2C_INSTANCE_INDEX${INSTANCE} = 8
    #set DRV_I2C_OPERATION_MODE_IDX9 to "DRV_I2C_MODE_SLAVE" if APP_DRV_I2C_SLAVE_RECEIVE${INSTANCE} = y  && APP_DRV_I2C_INSTANCE_INDEX${INSTANCE} = 9
    default n

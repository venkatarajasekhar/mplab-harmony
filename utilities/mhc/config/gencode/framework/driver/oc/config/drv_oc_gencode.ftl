...
config APP_DRV_OC_TMR_PRESCALE${INSTANCE}
	string
	set DRV_TMR_PRESCALE_IDX0 to "TMR_PRESCALE_VALUE_1" if APP_DRV_OC_TMR_INSTANCE_INDEX${INSTANCE} = 0
	set DRV_TMR_PRESCALE_IDX1 to "TMR_PRESCALE_VALUE_1" if APP_DRV_OC_TMR_INSTANCE_INDEX${INSTANCE} = 1
	set DRV_TMR_PRESCALE_IDX2 to "TMR_PRESCALE_VALUE_1" if APP_DRV_OC_TMR_INSTANCE_INDEX${INSTANCE} = 2
	set DRV_TMR_PRESCALE_IDX3 to "TMR_PRESCALE_VALUE_1" if APP_DRV_OC_TMR_INSTANCE_INDEX${INSTANCE} = 3
	set DRV_TMR_PRESCALE_IDX4 to "TMR_PRESCALE_VALUE_1" if APP_DRV_OC_TMR_INSTANCE_INDEX${INSTANCE} = 4
	set DRV_TMR_PRESCALE_IDX5 to "TMR_PRESCALE_VALUE_1" if APP_DRV_OC_TMR_INSTANCE_INDEX${INSTANCE} = 5		
	set DRV_TMR_PRESCALE_IDX6 to "TMR_PRESCALE_VALUE_1" if APP_DRV_OC_TMR_INSTANCE_INDEX${INSTANCE} = 2
	set DRV_TMR_PRESCALE_IDX7 to "TMR_PRESCALE_VALUE_1" if APP_DRV_OC_TMR_INSTANCE_INDEX${INSTANCE} = 7
	set DRV_TMR_PRESCALE_IDX8 to "TMR_PRESCALE_VALUE_1" if APP_DRV_OC_TMR_INSTANCE_INDEX${INSTANCE} = 8

...
config APP_DRV_IC_TMR_OPERATION_MODE${INSTANCE}
	string
	set DRV_TMR_OPERATION_MODE_IDX0 to "DRV_TMR_OPERATION_MODE_32_BIT" if APP_DRV_IC_TMR_INSTANCE_INDEX${INSTANCE} = 0
	set DRV_TMR_OPERATION_MODE_IDX1 to "DRV_TMR_OPERATION_MODE_32_BIT" if APP_DRV_IC_TMR_INSTANCE_INDEX${INSTANCE} = 1
	set DRV_TMR_OPERATION_MODE_IDX2 to "DRV_TMR_OPERATION_MODE_32_BIT" if APP_DRV_IC_TMR_INSTANCE_INDEX${INSTANCE} = 2
	set DRV_TMR_OPERATION_MODE_IDX3 to "DRV_TMR_OPERATION_MODE_32_BIT" if APP_DRV_IC_TMR_INSTANCE_INDEX${INSTANCE} = 3
	set DRV_TMR_OPERATION_MODE_IDX4 to "DRV_TMR_OPERATION_MODE_32_BIT" if APP_DRV_IC_TMR_INSTANCE_INDEX${INSTANCE} = 4
	set DRV_TMR_OPERATION_MODE_IDX5 to "DRV_TMR_OPERATION_MODE_32_BIT" if APP_DRV_IC_TMR_INSTANCE_INDEX${INSTANCE} = 5		
	set DRV_TMR_OPERATION_MODE_IDX6 to "DRV_TMR_OPERATION_MODE_32_BIT" if APP_DRV_IC_TMR_INSTANCE_INDEX${INSTANCE} = 2
	set DRV_TMR_OPERATION_MODE_IDX7 to "DRV_TMR_OPERATION_MODE_32_BIT" if APP_DRV_IC_TMR_INSTANCE_INDEX${INSTANCE} = 7
	set DRV_TMR_OPERATION_MODE_IDX8 to "DRV_TMR_OPERATION_MODE_32_BIT" if APP_DRV_IC_TMR_INSTANCE_INDEX${INSTANCE} = 8

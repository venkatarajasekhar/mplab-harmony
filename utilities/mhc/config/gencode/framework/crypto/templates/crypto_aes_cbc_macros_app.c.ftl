...
static byte __attribute__ ((coherent, aligned (16))) ${APP_NAME?lower_case}_CBCEncPlainText[] = "${("CONFIG_CRYPTO_AES_ENCRYPT_MESSAGE" + "${HCONFIG_APP_INSTANCE}")?eval}";
static byte __attribute__ ((coherent, aligned (16))) ${APP_NAME?lower_case}_CBCEncKey[] = "${("CONFIG_CRYPTO_AES_ENCRYPT_KEY" + "${HCONFIG_APP_INSTANCE}")?eval}";
static byte __attribute__ ((coherent, aligned (16))) ${APP_NAME?lower_case}_CBCEncInitVect[] = "${("CONFIG_CRYPTO_AES_ENCRYPT_KEY" + "${HCONFIG_APP_INSTANCE}")?eval}";
static byte __attribute__ ((coherent, aligned (16))) ${APP_NAME?lower_case}_CBCEncryptedData[AES_BLOCK_SIZE * 4];
</#if>

<#if ("CONFIG_CRYPTO_AES_DECRYPT" + "${HCONFIG_APP_INSTANCE}")?eval>
/* Decryption related variables */
static byte __attribute__ ((coherent, aligned (16))) ${APP_NAME?lower_case}_CBCEncData[] = {${("CONFIG_CRYPTO_AES_DECRYPT_MESSAGE" + "${HCONFIG_APP_INSTANCE}")?eval}};
static byte __attribute__ ((coherent, aligned (16))) ${APP_NAME?lower_case}_CBCDecKey[] = "${("CONFIG_CRYPTO_AES_DECRYPT_KEY" + "${HCONFIG_APP_INSTANCE}")?eval}";
static byte __attribute__ ((coherent, aligned (16))) ${APP_NAME?lower_case}_CBCDecInitVect[] = "${("CONFIG_CRYPTO_AES_DECRYPT_KEY" + "${HCONFIG_APP_INSTANCE}")?eval}";
static byte __attribute__ ((coherent, aligned (16))) ${APP_NAME?lower_case}_CBCDecryptedText[AES_BLOCK_SIZE * 4];
</#if>
</#macro>
<#--
// *****************************************************************************

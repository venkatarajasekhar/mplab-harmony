...
<#if CONFIG_SYS_DMA_MODE == "DYNAMIC">
#include "system/dma/sys_dma.h"
<#else>
#include "system/dma/sys_dma_static.h"
</#if></#if>
...
<#if CONFIG_DRV_I2C_DRIVER_MODE == "DYNAMIC" || CONFIG_DRV_I2C_STATIC_DRIVER_MODE == "BUFFER_MODEL_STATIC">
<#if CONFIG_DRV_I2C_BB_USED == true>
#include "driver/i2c/drv_i2c_bb_a.h"
</#if>
<#if CONFIG_DRV_I2C_BB_USED == false>
...
<#if CONFIG_USE_GFX_FONTS == true || CONFIG_USE_GFX_IMAGES == true>
...
<#if CONFIG_DRV_GFX_GLCD_MODE == "DYNAMIC">
...
<#if CONFIG_3RDPARTY_SEGGER_EMWIN_LIBRARY == true >
...
<#if CONFIG_USE_GFX_STACK == true>
<#include "/framework/gfx/templates/gfx_definitions.h.ftl">
</#if>
<#if CONFIG_USE_TCPIP_STACK == true>

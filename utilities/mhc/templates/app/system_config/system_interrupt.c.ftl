...
<#include "/framework/system/ports/templates/sys_ports_int.c.ftl">
</#if>
...
<#include "/framework/driver/usart/templates/drv_usart_int.c.ftl">
</#if>
...
<#include "/framework/system/dma/templates/sys_dma_int.c.ftl">
</#if>
<#if CONFIG_USE_DRV_I2C == true>
<#include "/framework/driver/i2c/templates/drv_i2c_int.c.ftl">
</#if>
...
<#include "/framework/driver/camera/ovm7690/config/drv_ovm7690_int.c.ftl">
</#if>

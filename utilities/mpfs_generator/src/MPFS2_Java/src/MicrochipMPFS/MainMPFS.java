...
// MPLAB Harmony Default Path
    public String defaultHarmonySourceDirectoryPath =
            "C:\\Microchip\\harmony";
    public String defaultHarmonyProjectBinFilePath =
            "C:\\microchip\\mpfs_img2.bin";
    public String defaultHarmonyProjectDirectoryPath =
             "C:\\microchip";
    ...
    public String sourceDirectoryHarmonyPath =
    "../../apps/tcpip/web_server/firmware/src/web_pages2";

    public String sourceDirectoryPath_unifiedstack =
            "../../../tcpip/tcpip_web_server_demo_app/web_pages2";
    ...
    // "C:\\Microchip Solutions\\TCPIP\\Demo App\\MPFSImg2.bin";
    //         "C:\\Microchip Solutions\\TCPIP Demo App\\MPFSImg2.bin";
    public String projectBinFileHarmonyPath =
    "../../apps/tcpip/web_server/firmware/src/mpfs_img2.bin";
    public String projectDirectoryPath =
            "../../../TCPIP/Demo App";
    public String projectDirectoryPath_old =
            "../../../TCPIP Demo App";
    public String projectDirectoryPath_unifiedstack =
            "../../../tcpip/tcpip_web_server_demo_app";
    public String projectDirectoryHarmonyPath =
   ...
   public String xmlOuputfile = "MPFS2SettingDetails.xml";
    ...
    public MainMPFS() {
        ...
        xmlAttrInfoMap.put(eXmlNodeAttribute.UNIFIEDSTACK_USE,XMLNodeSettingAttribute[14]);
        ...
        aboutStr = "<html>"+"Date Sept,23 2015"+"<br>";
        String version = "Version MPFS 2.33";
...
// for unified stack
        File sourceFile_unifiedStack=new File(sourceDirectoryPath_unifiedstack);
        File projectDir_unifiedStack = new File(projectDirectoryPath_unifiedstack);
// for MPLAB Harmony stack
        File harmony_sourcedirectory_path =new File(sourceDirectoryHarmonyPath);
        File harmony_projectDir_path = new File(projectDirectoryHarmonyPath);
        File harmony_projectbinFile = new File(projectBinFileHarmonyPath);
        // source directory        File projectDir_unifiedStack = new File(projectDirectoryPath_unifiedstack);
        ...
        try
        {
            ...
            {
                sourceDirectoryPath = harmony_sourcedirectory_path.getCanonicalPath();
                if(harmony_sourcedirectory_path.exists() == false)
                {
...
//            }
        ...
        try
        {
            ...
            {
                projectBinFilePath = harmony_projectbinFile.getCanonicalPath();
                if(harmony_projectbinFile.exists() == false)
                {
...
//            }
        ...
        try
        {
            ...
            {
                projectDirectoryPath = harmony_projectDir_path.getCanonicalPath();
                if(harmony_projectDir_path.exists() == false)
                {
...
*/
    ...
    private void initComponents() {
        ...
        radWebDir.setFont(new java.awt.Font("Microsoft Sans Serif", 0, 11)); // NOI18N
        radWebDir.setSelected(true);
        radWebDir.setText("Source Directory");
        ...
        radPreBuildDir.setFont(new java.awt.Font("Microsoft Sans Serif", 0, 11)); // NOI18N
        ...
        btnSrcBrowse.setFont(new java.awt.Font("Microsoft Sans Serif", 0, 11)); // NOI18N
        ...
        groupLbl3.setFont(new java.awt.Font("Microsoft Sans Serif", 1, 14)); // NOI18N
        groupLbl3.setText("3.");
        jPanel3.add(groupLbl3, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 31, -1, -1));

        lblProjectDir.setFont(new java.awt.Font("Microsoft Sans Serif", 1, 12)); // NOI18N
        ...
        txtProjectDir.setFont(new java.awt.Font("Microsoft Sans Serif", 0, 11)); // NOI18N
        ...
        btnProjectDir.setFont(new java.awt.Font("Microsoft Sans Serif", 0, 11)); // NOI18N
        ...
        lblProjectImg.setFont(new java.awt.Font("Microsoft Sans Serif", 1, 12)); // NOI18N
        ...
        lbnImageType.setFont(new java.awt.Font("Microsoft Sans Serif", 0, 11)); // NOI18N
        ...
        jPanel2.setFont(new java.awt.Font("MS Reference Sans Serif", 0, 11)); // NOI18N
        jPanel2.setName("Source Settings"); // NOI18N
        jPanel2.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        groupLbl2.setFont(new java.awt.Font("Microsoft Sans Serif", 1, 14)); // NOI18N
        groupLbl2.setText("2.");
        jPanel2.add(groupLbl2, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 43, -1, -1));

        lblOuput.setFont(new java.awt.Font("Microsoft Sans Serif", 1, 12)); // NOI18N
        lblOuput.setText("Output:");
        jPanel2.add(lblOuput, new org.netbeans.lib.awtextra.AbsoluteConstraints(74, 31, -1, -1));

        lblProcess.setFont(new java.awt.Font("Microsoft Sans Serif", 1, 12)); // NOI18N
        ...
        groupLbl4.setFont(new java.awt.Font("Microsoft Sans Serif", 1, 14)); // NOI18N
        groupLbl4.setText("4.");
        jPanel4.add(groupLbl4, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 31, -1, -1));

        lblUploadImg.setFont(new java.awt.Font("Microsoft Sans Serif", 1, 12)); // NOI18N
        ...
        txtUploadPath.setFont(new java.awt.Font("Microsoft Sans Serif", 0, 11)); // NOI18N
        ...
        btnUploadSetting.setFont(new java.awt.Font("Microsoft Sans Serif", 0, 11)); // NOI18N
        ...
        jProgressBar1.setFont(new java.awt.Font("Microsoft Sans Serif", 0, 11)); // NOI18N
        ...
        jPanel6.add(jProgressBar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 173, 20));

        lblMessage.setText("[Generator Idle]");
        jPanel6.add(lblMessage, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 40, 410, 20));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jPanel6, javax.swing.GroupLayout.Alignment.LEADING, 0, 606, Short.MAX_VALUE)
...
//            System.out.println(" compresssion : ");
//            System.out.println(advSetting.getDynamicFileStr());
//            System.out.println(" \n\r do not compresssion :");
//            System.out.println(advSetting.getNoCompressionFileStr());
//            System.out.println("\r\n");
    ...
    public void saveXmlNodeValue(eXmlNodeAttribute xmlNodeValue,String sNodeValue,int cNodeValue,boolean bNodevalue)
    {
        switch(xmlNodeValue)
        {
            ...
            case UNIFIEDSTACK_USE:
                ...
                xmlIntrf.modifyExistingXmlFile(XMLNodeName[0], xmlAttrInfoMap.get(xmlNodeValue.UNIFIEDSTACK_USE), sNodeValue);
                break;
        }
    }
...
//long cmdstartTime  =  System.currentTimeMillis();
           ...
           // System.out.println("outputFile :"+outputFile);
            ...
            for(int i =0; i < (args.length - 3); i++)
            {
                ...
                else if(arg.compareTo("/pic32")==0 || arg.compareTo("/c")==0)
                {

...
//        private Thread manageTree=null;
    ...
    public TcpIpDiscoverTool() {
        ...
        String aboutStr = "<html>"+"Date  "+" - Aug,22 2014"+"<br>";
        String version = "Version"+" - TCPIP Discoverer 2.2";
 ...
 public void addDiscoveryEntry(DatagramPacket receivedPacket)
 {
    ...
    String defaultRouter = "Deafult Router";
    String defaultGateway = "Deafult Gateway";
    String harmonyNodeName = "Harmony";    
    byte[] temp ;
    int    i = 0;
    DefaultMutableTreeNode macNode=null,multicastListenerNode=null,ipNode=null;
    ...
    for(dataCnt=0;dataCnt<packetLen; )
    {
        switch(paktBuf[dataCnt])
        {
            ...
            case 0x03: // MAC Type
                ...
                macType = macType.concat(byteToStr);

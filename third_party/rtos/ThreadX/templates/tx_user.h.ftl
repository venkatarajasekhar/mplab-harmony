...
#define TX_MAX_PRIORITIES                       ${CONFIG_THREADX_TX_MAX_PRIORITIES}  
#define TX_MINIMUM_STACK                        ${CONFIG_THREADX_TX_MINIMUM_STACK} 
/*        
#define TX_THREAD_USER_EXTENSION                ????
*/


<#if CONFIG_THREADX_TX_DISABLE_ERROR_CHECKING == true>
...
<#if CONFIG_THREADX_TX_TIMER_PROCESS_IN_ISR == true>
...
#define TX_TIMER_PROCESS_IN_ISR
*/
#define TX_TIMER_THREAD_STACK_SIZE              ${CONFIG_THREADX_TX_TIMER_THREAD_STACK_SIZE}
#define TX_TIMER_THREAD_PRIORITY                ${CONFIG_THREADX_TX_TIMER_THREAD_PRIORITY}
</#if>
...
<#if CONFIG_THREADX_TX_REACTIVATE_INLINE == true>
...
<#if CONFIG_THREADX_TX_DISABLE_STACK_FILLING == true>
...
<#if CONFIG_THREADX_TX_ENABLE_STACK_CHECKING == true>
...
<#if CONFIG_THREADX_TX_DISABLE_PREEMPTION_THRESHOLD == true>
...
<#if CONFIG_THREADX_TX_DISABLE_REDUNDANT_CLEARING == true>
...
<#if CONFIG_THREADX_TX_DISABLE_NOTIFY_CALLBACKS == true>
...
<#if CONFIG_THREADX_TX_INLINE_THREAD_RESUME_SUSPEND == true>
...
<#if CONFIG_THREADX_TX_NOT_INTERRUPTABLE == true>
...
<#if CONFIG_THREADX_TX_ENABLE_EVENT_TRACE == true>
...
<#if CONFIG_THREADX_TX_BLOCK_POOL_ENABLE_PERFORMANCE_INFO == true>
...
<#if CONFIG_THREADX_TX_BYTE_POOL_ENABLE_PERFORMANCE_INFO == true>
...
<#if CONFIG_THREADX_TX_EVENT_FLAGS_ENABLE_PERFORMANCE_INFO == true>
...
<#if CONFIG_THREADX_TX_MUTEX_ENABLE_PERFORMANCE_INFO == true>
...
<#if CONFIG_THREADX_TX_QUEUE_ENABLE_PERFORMANCE_INFO == true>
...
<#if CONFIG_THREADX_TX_SEMAPHORE_ENABLE_PERFORMANCE_INFO == true>
...
<#if CONFIG_THREADX_TX_THREAD_ENABLE_PERFORMANCE_INFO == true>

...
#define  LIB_MEM_CFG_ARG_CHK_EXT_EN     <#if CONFIG_UCOSIII_LIB_MEM_CFG_ARG_CHK_EXT_EN == true>DEF_ENABLED<#else>DEF_DISABLED</#if>
...
#define  LIB_MEM_CFG_OPTIMIZE_ASM_EN    <#if CONFIG_UCOSIII_LIB_MEM_CFG_OPTIMIZE_ASM_EN == true>DEF_ENABLED<#else>DEF_DISABLED</#if>
...
#define  LIB_MEM_CFG_ALLOC_EN           <#if CONFIG_UCOSIII_LIB_MEM_CFG_ALLOC_EN == true>DEF_ENABLED<#else>DEF_DISABLED</#if>
                                                        /*   DEF_DISABLED     Memory allocation DISABLED                */
                                                        /*   DEF_ENABLED      Memory allocation ENABLED                 */


#define  LIB_MEM_CFG_HEAP_SIZE           ${CONFIG_UCOSIII_LIB_MEM_CFG_HEAP_SIZE}   /* Configure heap memory size         [see Note #2a].           */
...
#define  LIB_STR_CFG_FP_EN              <#if CONFIG_UCOSIII_LIB_STR_CFG_FP_EN == true>DEF_ENABLED<#else>DEF_DISABLED</#if>

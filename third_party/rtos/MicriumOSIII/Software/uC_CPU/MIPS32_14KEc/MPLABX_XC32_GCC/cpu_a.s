...
*                               :
*                       }
* Note(s): 1) An execution Hazard is created by the change in state to COP0 Status register.  Clear the 
*             execution hazard before moving on.  See MIPS documentation for an explanation of hazards.  
*          2) See compiler documentation for a description of register usage. GP $2 is used for returning 
*             values from functions. GP $4 is used for passing arguments to functions.
**********************************************************************************************************
*/

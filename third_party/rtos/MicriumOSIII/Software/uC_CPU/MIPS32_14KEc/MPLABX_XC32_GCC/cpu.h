...
/*
*********************************************************************************************************
*                                    Count Leading Zeros Instruction Present
*
* Note(s) : (1) Since this is dependant on the hardware the define is located in a file which is part of 
*               the port.
*           (2) See cpu_a.S for implementation of function which uses the 'clz' instruction.
*           (3) CPU_CntLeadZeros function makes use of the clz instruction.  See cpu_core.c for what gets
*               affected by this define being present. 
*********************************************************************************************************
*/
#define CPU_CFG_LEAD_ZEROS_ASM_PRESENT             1

...
#define  OS_VERSION  3020u                        /* Version of uC/OS-III (Vx.yy.z mult. by 1000)                     */
...
#define  OS_ERR_ILLEGAL_CREATE_RUN_TIME       (OS_ERR)(18001u)
#define  OS_ERR_INT_Q                         (OS_ERR)(18002u)
#define  OS_ERR_INT_Q_FULL                    (OS_ERR)(18003u)
#define  OS_ERR_INT_Q_SIZE                    (OS_ERR)(18004u)
...
#define  OS_ERR_STK_LIMIT_INVALID             (OS_ERR)(28206u)
...
#define  OS_OBJ_TYPE_MEM            (OS_OBJ_TYPE)(0x4D454D20u)  /* "MEM " in ASCII.                                   */
...
#define  OS_OBJ_TYPE_MEM            (OS_OBJ_TYPE)(0x204D454Du)  /* "MEM " in ASCII.                                   */
...
#define  OS_OBJ_TYPE_MEM            (OS_OBJ_TYPE)(0x454D204Du)  /* "MEM " in ASCII.                                   */
...
#define  DEF_OPT_TIME_OPTS_MASK             ((OS_OPT)(OS_OPT_TIME_DLY            | \
                                                      OS_OPT_TIME_TIMEOUT        | \
                                                      OS_OPT_TIME_PERIODIC       | \
                                                      OS_OPT_TIME_MATCH          | \
...
#define  OS_PRIO_INIT                       (OS_PRIO)(DEF_BIT       (sizeof(OS_PRIO) * DEF_OCTET_NBR_BITS) - 1u)

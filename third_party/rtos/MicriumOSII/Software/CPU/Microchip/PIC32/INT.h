 ...
 ********************************************************************/
extern inline unsigned int __attribute__((always_inline)) INTDisableInterrupts(void) 
{
 ...
 *                  in the status register
 ********************************************************************/
extern inline unsigned int __attribute__((always_inline)) INTEnableInterrupts(void)
{
    unsigned int status = 0;
 ...
 *                  in the status register
 ********************************************************************/
extern inline void __attribute__((always_inline)) INTRestoreInterrupts(unsigned int status)
{
 ...
 *					int     mCTGetIntEnable(void)
 *                  void    mCTClearIntEnable(void)
 *					void    mCTSetIntPriority(int priority)
 *					int     mCTGetIntPriority(void)
 *					void    mCTSetIntSubPriority(subPriority)
 *					int     mCTGetIntSubPriority(void)
 *
 * PreCondition:    EBASE and IntCtl.VS set up
 *
 ...
 *					int     mCS0GetIntFlag(void)
 *					void    mCS0SetIntEnable(void)
 *					int     mCS0GetIntEnable(void)
 *                  void    mCS0ClearIntEnable(void)
 *					void    mCS0SetIntPriority(int priority)
 *					int     mCS0GetIntPriority(void)
 *					void    mCS0SetIntSubPriority(subPriority)
 *					int     mCS0GetIntSubPriority(void)
 *
 * PreCondition:    EBASE and IntCtl.VS set up
 *
 * Inputs:			priority:  		A value between 0 - 7 inclusive.
 ...
 *					int     mCS1GetIntFlag(void)
 *					void    mCS1SetIntEnable(void)
 *					int     mCS1GetIntEnable(void)
 *                  void    mCS1ClearIntEnable(void)
 *					void    mCS1SetIntPriority(int priority)
 *					int     mCS1GetIntPriority(void)
 *					void    mCS1SetIntSubPriority(subPriority)
 *					int     mCS1GetIntSubPriority(void)
 *
 * PreCondition:    EBASE and IntCtl.VS set up
 *
 * Inputs:			priority:  		A value between 0 - 7 inclusive.
 ...
 *					int     mINTxGetIntFlag(void)
 *					void    mINTxSetIntEnable(void)
 *					int     mINTxGetIntEnable(void)
 *                  void    mINTxClearIntEnable(void)
 *					void    mINTxSetIntPriority(int priority)
 *					int     mINTxGetIntPriority(void)
 *					void    mINTxSetIntSubPriority(subPriority)
 *					int     mINTxGetIntSubPriority(void)
 *					void    mINTxSetEdgeRising(void)
 *					void    mINTxGetEdgeFalling(void)
 *					int     mINTxGetEdgeMode(void)
 *
 * PreCondition:    EBASE and IntCtl.VS set up
 *
 * Inputs:			priority:  		A value between 0 - 7 inclusive.
 ...
 *					int     mCNGetIntFlag(void)
 *					void    mCNSetIntEnable(void)
 *					int     mCNGetIntEnable(void)
 *                  void    mCNClearIntEnable(void)
 *					void    mCNSetIntPriority(int priority)
 *					int     mCNGetIntPriority(void)
 *					void    mCNSetIntSubPriority(subPriority)
 *					int     mCNGetIntSubPriority(void)
 *
 * PreCondition:    EBASE and IntCtl.VS set up
 *
 * Inputs:			priority:  		A value between 0 - 7 inclusive.
 ...
 *					int     mAD1GetIntEnable(void)
 *                  void    mAD1ClearIntEnable(void)
 *					void    mAD1SetIntPriority(int priority)
 *					int     mAD1GetIntPriority(void)
 *					void    mAD1SetIntSubPriority(subPriority)
 *					int     mGAD1etSubPriority(void)
 *
 * PreCondition:    EBASE and IntCtl.VS set up
 *
 * Inputs:			priority:  		A value between 0 - 7 inclusive.
 ...
 *					int     mDMAxGetIntFlag(void)
 *					void    mDMAxSetIntEnable(void)
 *					int     mDMAxGetIntEnable(void)
 *                  void    mDMAxClearIntEnable(void)
 *					void    mDMAxSetIntPriority(int priority)
 *					int     mDMAxGetIntPriority(void)
 *					void    mDMAxSetIntSubPriority(subPriority)
 *					int     mDMAxGetIntSubPriority(void)
 *
 * PreCondition:    EBASE and IntCtl.VS set up
 *
 * Inputs:			priority:  		A value between 0 - 7 inclusive.
...
#define mINTSetIFS2(flag)                    ( IFS2SET = (unsigned int)(flag)  )
/*********************************************************************
...
#define mINTClearIFS2(flag)                  ( IFS2CLR = (unsigned int)(flag)  )
/*********************************************************************
...
#define mINTSetIEC2(flag)                    ( IEC2SET = (unsigned int)(flag)  ) 
/*********************************************************************
...
#define mINTClearIEC2(flag)                  ( IEC2CLR = (unsigned int)(flag)  )

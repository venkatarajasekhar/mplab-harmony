...
typedef struct
{
    ...
    APP_I2C_BUFFER_HANDLE               appI2CWriteBufferHandle[MAX_NUMBER_OF_BUFFERS];
    
    APP_I2C_BUFFER_HANDLE               appI2CReadBufferHandle[MAX_NUMBER_OF_BUFFERS];
    
    APP_I2C_BUFFER_HANDLE               appI2CSlaveReadHandle;
    
    APP_I2C_BUFFER_HANDLE               appI2CSlaveWriteHandle;
...
/*  callback from I2C slave ISR to application to prepare Buffer to receive data
    OR prepare a Buffer to transmit data back to Master */

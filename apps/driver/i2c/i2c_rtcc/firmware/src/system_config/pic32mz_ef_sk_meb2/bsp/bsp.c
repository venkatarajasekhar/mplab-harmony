...
void BSP_Initialize(void )
{
    ...
    /* Switch off LEDs */
    BSP_LEDOff(LED_SUCCESS_STAGE1);
    BSP_LEDOff(LED_SUCCESS_STAGE2);
    BSP_LEDOff(BSP_LED_3);
    BSP_LEDOff(BSP_LED_D6);
    BSP_LEDOff(BSP_LED_D7);

    /* Required */
    PLIB_PORTS_PinSet(PORTS_ID_0, PORT_CHANNEL_H, PORTS_BIT_POS_11);
...
void BSP_BluetoothPinStateSet(BSP_BT_STATE state)
{
    PLIB_PORTS_PinWrite (PORTS_ID_0 , PORT_CHANNEL_B , PORTS_BIT_POS_2, state );
}

...
bool APP_Write_Tasks(void)
{
    ...
    switch (appWriteState)
    {
        ...
        {    
            ...
            if ( (appData.appI2CWriteBufferHandle[0] == (DRV_I2C_BUFFER_HANDLE) NULL) || 
        ...
        {
            if  ( (APP_Check_Transfer_Status(appData.drvI2CHandle_Master, appData.appI2CWriteBufferHandle[0]) == DRV_I2C_BUFFER_EVENT_COMPLETE) || 
                     (APP_Check_Transfer_Status(appData.drvI2CHandle_Master, appData.appI2CWriteBufferHandle[0]) == DRV_I2C_BUFFER_EVENT_ERROR) )
        ...
        case TxRx_TO_EXTERNAL_SLAVE_2:
        {
            ...
            if ( (appData.appI2CWriteBufferHandle[1] == (DRV_I2C_BUFFER_HANDLE) NULL) || 
        ...
        {
            if  ( (APP_Check_Transfer_Status(appData.drvI2CHandle_Master, appData.appI2CWriteBufferHandle[1]) == DRV_I2C_BUFFER_EVENT_COMPLETE ) ||
                    (APP_Check_Transfer_Status(appData.drvI2CHandle_Master, appData.appI2CWriteBufferHandle[1]) == DRV_I2C_BUFFER_EVENT_ERROR) )
        ...
        {    
            ...
            if ( (appData.appI2CWriteBufferHandle[2] == (DRV_I2C_BUFFER_HANDLE) NULL) || 
        ...
        {
            if ( (APP_Check_Transfer_Status(appData.drvI2CHandle_Master, appData.appI2CWriteBufferHandle[2]) == DRV_I2C_BUFFER_EVENT_COMPLETE ) ||
                   (APP_Check_Transfer_Status(appData.drvI2CHandle_Master, appData.appI2CWriteBufferHandle[2]) == DRV_I2C_BUFFER_EVENT_ERROR) )
        ...
        {    
            ...
            if ( (appData.appI2CWriteBufferHandle[3] == (DRV_I2C_BUFFER_HANDLE) NULL) || 
        ...
        {
            if ( (APP_Check_Transfer_Status(appData.drvI2CHandle_Master, appData.appI2CWriteBufferHandle[3]) == DRV_I2C_BUFFER_EVENT_COMPLETE ) ||
                    (APP_Check_Transfer_Status(appData.drvI2CHandle_Master, appData.appI2CWriteBufferHandle[3]) == DRV_I2C_BUFFER_EVENT_ERROR) )
        ...
        {    
            ...
            if ( (appData.appI2CWriteBufferHandle[4] == (DRV_I2C_BUFFER_HANDLE) NULL) || 
        ...
        {
            if ( (APP_Check_Transfer_Status(appData.drvI2CHandle_Master, appData.appI2CWriteBufferHandle[4]) == DRV_I2C_BUFFER_EVENT_COMPLETE) ||
                  (APP_Check_Transfer_Status(appData.drvI2CHandle_Master, appData.appI2CWriteBufferHandle[4]) == DRV_I2C_BUFFER_EVENT_ERROR)  ) 

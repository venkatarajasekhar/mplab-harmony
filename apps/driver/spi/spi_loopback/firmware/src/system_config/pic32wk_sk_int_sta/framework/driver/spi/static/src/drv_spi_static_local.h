...
int32_t DRV_SPI0_ISRMasterRM8BitTasks ( struct DRV_SPI_OBJ * dObj );
int32_t DRV_SPI0_ISRErrorTasks(struct DRV_SPI_OBJ * dObj);
int32_t DRV_SPI0_MasterRMSend8BitISR( struct DRV_SPI_OBJ * dObj );
int32_t DRV_SPI0_MasterRMReceive8BitISR( struct DRV_SPI_OBJ * dObj );

int32_t DRV_SPI1_ISRSlaveRM8BitTasks ( struct DRV_SPI_OBJ * dObj );
int32_t DRV_SPI1_ISRErrorTasks(struct DRV_SPI_OBJ * dObj);
int32_t DRV_SPI1_SlaveRMSend8BitISR( struct DRV_SPI_OBJ * dObj );
int32_t DRV_SPI1_SlaveRMReceive8BitISR( struct DRV_SPI_OBJ * dObj );
// DOM-IGNORE-BEGIN
#ifdef __cplusplus
}
#endif

...
void __ISR(_SPI2_TX_VECTOR, ipl1AUTO) _IntHandlerSPITxInstance1(void)
{
    DRV_SPI_Tasks(sysObj.spiObjectIdx1);
}
...
void __ISR(_SPI3_RX_VECTOR, ipl2AUTO) _IntHandlerSPIRxInstance2(void)
{
    DRV_SPI_Tasks(sysObj.spiObjectIdx2);
}
void __ISR(_SPI3_TX_VECTOR, ipl1AUTO) _IntHandlerSPITxInstance2(void)
{
    DRV_SPI_Tasks(sysObj.spiObjectIdx2);
}
void __ISR(_SPI3_FAULT_VECTOR, ipl1AUTO) _IntHandlerSPIFaultInstance2(void)
{
    DRV_SPI_Tasks(sysObj.spiObjectIdx2);
}

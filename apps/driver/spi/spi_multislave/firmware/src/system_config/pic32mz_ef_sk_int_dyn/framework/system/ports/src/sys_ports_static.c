...
void SYS_PORTS_Initialize(void)
{
    ...
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_SS2, INPUT_PIN_RPD0 );
    PLIB_PORTS_RemapInput(PORTS_ID_0, INPUT_FUNC_SS3, INPUT_PIN_RPB15 );
    ...
    PLIB_PORTS_RemapOutput(PORTS_ID_0, OUTPUT_FUNC_SDO3, OUTPUT_PIN_RPA15 );

...
typedef enum
{
    ...
    NON_COHERENT_CPU_WRITES_DATA,
    NON_COHERENT_DMA_TRANSFERS_DATA,
    NON_COHERENT_STALE_DATA_IS_RECEIVED,

    COHERENT_CPU_WRITES_DATA,
    COHERENT_DMA_TRANSFERS_DATA,
    COHERENT_CORRECT_DATA_IS_RECEIVED,

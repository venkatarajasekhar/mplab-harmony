...
typedef enum
{
    ...
    NON_COHERENT_DMA_TRANSFER_TO_BUFFER,
    NON_COHERENT_CPU_READS_VALID_DATA,
    NON_COHERENT_DMA_TRANSFERS_AGAIN,
    NON_COHERENT_CPU_READS_STALE_DATA,

    COHERENT_DMA_TRANSFER_TO_BUFFER,
    COHERENT_CPU_READS_VALID_DATA,
    COHERENT_DMA_TRANSFERS_AGAIN,
    COHERENT_CPU_READS_VALID_DATA_AGAIN,

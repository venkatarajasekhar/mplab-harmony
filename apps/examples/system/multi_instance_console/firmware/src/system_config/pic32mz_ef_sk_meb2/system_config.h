...
#define DRV_USART_RCV_INT_SUB_PRIORITY_IDX0         INT_SUBPRIORITY_LEVEL3
...
#define DRV_USART_XMIT_QUEUE_SIZE_IDX0              30
#define DRV_USART_RCV_QUEUE_SIZE_IDX0               30


#define DRV_USART_POWER_STATE_IDX0                  SYS_MODULE_POWER_RUN_FULL

#define DRV_USART_QUEUE_DEPTH_COMBINED              60

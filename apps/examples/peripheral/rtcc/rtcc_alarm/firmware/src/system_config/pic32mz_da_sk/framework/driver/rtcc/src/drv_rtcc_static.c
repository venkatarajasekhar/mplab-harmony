...
void DRV_RTCC_Initialize(void)
{
    ...
    PLIB_RTCC_OutputSelect(RTCC_ID_0, RTCC_OUTPUT_RTCC_CLOCK); /* Select ouput to be shown on RTCC */
    ...
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_RTCC, INT_PRIORITY_LEVEL2); /* Set interrupt priority */
...
void DRV_RTCC_ClockOutput(void)
{
    ...
    PLIB_RTCC_OutputSelect(RTCC_ID_0, RTCC_OUTPUT_RTCC_CLOCK);
}

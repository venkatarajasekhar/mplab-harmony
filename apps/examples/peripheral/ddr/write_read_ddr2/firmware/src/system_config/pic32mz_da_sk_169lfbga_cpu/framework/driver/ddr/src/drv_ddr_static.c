...
static void DDR_Init(void)
{
	...
	*(volatile uint32_t*)(0xBF8E8014) = 0x2000090B; /* MEM_CONFIG_0 */
	*(volatile uint32_t*)(0xBF8E8018) = 0x00001FFF; /* MEM_CONFIG_1 */
	*(volatile uint32_t*)(0xBF8E801C) = 0x00000000; /* MEM_CONFIG_2 */
	*(volatile uint32_t*)(0xBF8E8020) = 0x000001FF; /* MEM_CONFIG_3 */
	*(volatile uint32_t*)(0xBF8E8024) = 0x00000003; /* MEM_CONFIG_4 */

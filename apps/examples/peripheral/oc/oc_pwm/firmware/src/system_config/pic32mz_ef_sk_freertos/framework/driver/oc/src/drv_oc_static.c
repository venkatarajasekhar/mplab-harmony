...
void DRV_OC0_Initialize(void)
{
    ...
    PLIB_OC_PulseWidth16BitSet(OC_ID_5, 625);

    /* Setup Interrupt */
    PLIB_INT_SourceEnable(INT_ID_0, INT_SOURCE_OUTPUT_COMPARE_5);
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_OC5, INT_PRIORITY_LEVEL1);
    PLIB_INT_VectorSubPrioritySet(INT_ID_0, INT_VECTOR_OC5, INT_SUBPRIORITY_LEVEL0);
}

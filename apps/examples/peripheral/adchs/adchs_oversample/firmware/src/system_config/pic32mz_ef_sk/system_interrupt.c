...
void __ISR(_ADC_DF1_VECTOR, ipl3AUTO) _IntHandlerDrvAdc(void)
{
    if(true == DRV_ADC_DigitalFilter0_DataIsReady())
    {
        appData.overSampledDataReady = true;
        appData.overSampledResult = DRV_ADC_DigitalFilter0_DataRead();
    }

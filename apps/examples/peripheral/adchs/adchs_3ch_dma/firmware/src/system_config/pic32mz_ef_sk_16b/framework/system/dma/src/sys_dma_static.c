...
void SYS_DMA_Channel0TransferAdd(void)
{
   ...
   PLIB_DMA_ChannelXSourceStartAddressSet(DMA_ID_0, DMA_CHANNEL_0, (uint32_t)&ADCDATA0);
   PLIB_DMA_ChannelXDestinationStartAddressSet(DMA_ID_0, DMA_CHANNEL_0, (uint32_t)&adc_buf[0][0]);

   /* Set the source and destination sizes */
   PLIB_DMA_ChannelXSourceSizeSet(DMA_ID_0, DMA_CHANNEL_0, 4);
   PLIB_DMA_ChannelXDestinationSizeSet(DMA_ID_0, DMA_CHANNEL_0, 1024);
...
void SYS_DMA_Channel0Setup(SYS_DMA_CHANNEL_OP_MODE modeEnable)
{
    ...
    PLIB_DMA_ChannelXStartIRQSet(DMA_ID_0, DMA_CHANNEL_0, DMA_TRIGGER_ADC1_DATA0);
}
...
{          
	//check address error
    if (PLIB_DMA_ChannelXINTSourceFlagGet(DMA_ID_0, DMA_CHANNEL_0, DMA_INT_ADDRESS_ERROR))
    {
		PLIB_DMA_ChannelXINTSourceFlagClear(DMA_ID_0, DMA_CHANNEL_0, DMA_INT_ADDRESS_ERROR);
    }
	//check transfer abort 
    if (PLIB_DMA_ChannelXINTSourceFlagGet(DMA_ID_0, DMA_CHANNEL_0, DMA_INT_TRANSFER_ABORT))
    {
		PLIB_DMA_ChannelXINTSourceFlagClear(DMA_ID_0, DMA_CHANNEL_0, DMA_INT_TRANSFER_ABORT);
    }
...
// *****************************************************************************
// *****************************************************************************
// Section: DMA Channel 1 functions
// *****************************************************************************
// *****************************************************************************	
...
void SYS_DMA_Channel1TransferAdd(void)
{
   ...
   /* Set the source and destination addresses (addresses are converted from virtual to physical) */
   PLIB_DMA_ChannelXSourceStartAddressSet(DMA_ID_0, DMA_CHANNEL_1, (uint32_t)&ADCDATA1);
   PLIB_DMA_ChannelXDestinationStartAddressSet(DMA_ID_0, DMA_CHANNEL_1, (uint32_t)&adc_buf[1][0]);

   /* Set the source and destination sizes */
   PLIB_DMA_ChannelXSourceSizeSet(DMA_ID_0, DMA_CHANNEL_1, 4);
   PLIB_DMA_ChannelXDestinationSizeSet(DMA_ID_0, DMA_CHANNEL_1, 1024);
...
void SYS_DMA_Channel1Setup(SYS_DMA_CHANNEL_OP_MODE modeEnable)
{
    ...
    if(SYS_DMA_CHANNEL_OP_MODE_MATCH_ABORT & modeEnable)
    {
        PLIB_DMA_ChannelXTriggerEnable( DMA_ID_0,DMA_CHANNEL_1,DMA_CHANNEL_TRIGGER_PATTERN_MATCH_ABORT);
    }

    /* Channel chaining mode */
    if(SYS_DMA_CHANNEL_OP_MODE_CHAIN_LOW & modeEnable)
    {
        PLIB_DMA_ChannelXChainEnable( DMA_ID_0, DMA_CHANNEL_1);
    }

    /* Auto Enable mode */
    if(SYS_DMA_CHANNEL_OP_MODE_AUTO & modeEnable)
    {
        PLIB_DMA_ChannelXAutoEnable( DMA_ID_0, DMA_CHANNEL_1);
    }
    ...
    PLIB_DMA_ChannelXStartIRQSet(DMA_ID_0, DMA_CHANNEL_1, DMA_TRIGGER_ADC1_DATA1);
}
...
bool SYS_DMA_Channel1IsBusy(void)
{
    ...
    if(true == PLIB_DMA_ExistsChannelXBusy(DMA_ID_0))
    {
        if(true == PLIB_DMA_ChannelXBusyIsBusy( DMA_ID_0,DMA_CHANNEL_1))
        {
            isBusy = true;
        }
    }
...
{
   PLIB_DMA_AbortTransferSet(DMA_ID_0, DMA_CHANNEL_1);
}

void SYS_DMA_Channel1ForceStart(void)
{
   PLIB_DMA_StartTransferSet(DMA_ID_0, DMA_CHANNEL_1);
}

void SYS_DMA_Channel1Disable(void)
{
   PLIB_DMA_ChannelXDisable(DMA_ID_0, DMA_CHANNEL_1);
}
...
void SYS_DMA_Channel1SetCRC(SYS_DMA_CHANNEL_OPERATION_MODE_CRC crc)
{
    ...
    if(true == PLIB_DMA_ExistsCRCChannel(DMA_ID_0))
    {
        PLIB_DMA_CRCChannelSelect(DMA_ID_0, DMA_CHANNEL_1);  
    }
#endif
                                         ...
                                         uint8_t ignorePattern )
{
    ...
    if(true == PLIB_DMA_ExistsChannelXPatternLength(DMA_ID_0))
    {
        PLIB_DMA_ChannelXPatternLengthSet(DMA_ID_0,DMA_CHANNEL_1,length);
    }
#endif
    /* Set the pattern for the pattern match */  
    PLIB_DMA_ChannelXPatternDataSet(DMA_ID_0,DMA_CHANNEL_1,pattern);
...
if(SYS_DMA_CHANNEL_IGNORE_MATCH_ENABLE == ignore)
{
        ...
        {
            /* Enable the ignore byte and the pattern */    
            PLIB_DMA_ChannelXPatternIgnoreByteEnable(DMA_ID_0,DMA_CHANNEL_1); 
        }
    #endif  
    #if defined(PLIB_DMA_ExistsChannelXPatternIgnore)    
        if(true == PLIB_DMA_ExistsChannelXPatternIgnore(DMA_ID_0))
        {  
            PLIB_DMA_ChannelXPatternIgnoreSet(DMA_ID_0,DMA_CHANNEL_1,ignorePattern);
        }
    #endif
}
}
...
{          
	//check address error
    if (PLIB_DMA_ChannelXINTSourceFlagGet(DMA_ID_0, DMA_CHANNEL_1, DMA_INT_ADDRESS_ERROR))
    {
		PLIB_DMA_ChannelXINTSourceFlagClear(DMA_ID_0, DMA_CHANNEL_1, DMA_INT_ADDRESS_ERROR);
    }
	//check transfer abort 
    if (PLIB_DMA_ChannelXINTSourceFlagGet(DMA_ID_0, DMA_CHANNEL_1, DMA_INT_TRANSFER_ABORT))
    {
		PLIB_DMA_ChannelXINTSourceFlagClear(DMA_ID_0, DMA_CHANNEL_1, DMA_INT_TRANSFER_ABORT);
    }
...
// *****************************************************************************
// *****************************************************************************
// Section: DMA Channel 2 functions
// *****************************************************************************
// *****************************************************************************	
...
void SYS_DMA_Channel2TransferAdd(void)
{
   ...
   /* Set the source and destination addresses (addresses are converted from virtual to physical) */
   PLIB_DMA_ChannelXSourceStartAddressSet(DMA_ID_0, DMA_CHANNEL_2, (uint32_t)&ADCDATA2);
   PLIB_DMA_ChannelXDestinationStartAddressSet(DMA_ID_0, DMA_CHANNEL_2, (uint32_t)&adc_buf[2][0]);

   /* Set the source and destination sizes */
   PLIB_DMA_ChannelXSourceSizeSet(DMA_ID_0, DMA_CHANNEL_2, 4);
   PLIB_DMA_ChannelXDestinationSizeSet(DMA_ID_0, DMA_CHANNEL_2, 1024);

   /* Set the number of bytes per transfer */
   PLIB_DMA_ChannelXCellSizeSet(DMA_ID_0, DMA_CHANNEL_2, 4);
...
void SYS_DMA_Channel2Setup(SYS_DMA_CHANNEL_OP_MODE modeEnable)
{
    ...
    if(SYS_DMA_CHANNEL_OP_MODE_MATCH_ABORT & modeEnable)
    {
        PLIB_DMA_ChannelXTriggerEnable( DMA_ID_0,DMA_CHANNEL_2,DMA_CHANNEL_TRIGGER_PATTERN_MATCH_ABORT);
    }
    ...
    /* DMA transfer to start */
    PLIB_DMA_ChannelXTriggerEnable(DMA_ID_0, DMA_CHANNEL_2, DMA_CHANNEL_TRIGGER_TRANSFER_START);
    PLIB_DMA_ChannelXStartIRQSet(DMA_ID_0, DMA_CHANNEL_2, DMA_TRIGGER_ADC1_DATA2);
}
...
bool SYS_DMA_Channel2IsBusy(void)
{
    ...
    if(true == PLIB_DMA_ExistsChannelXBusy(DMA_ID_0))
    {
        if(true == PLIB_DMA_ChannelXBusyIsBusy( DMA_ID_0,DMA_CHANNEL_2))
        {
            isBusy = true;
        }
    }
...
{
   PLIB_DMA_AbortTransferSet(DMA_ID_0, DMA_CHANNEL_2);
}

void SYS_DMA_Channel2ForceStart(void)
{
   PLIB_DMA_StartTransferSet(DMA_ID_0, DMA_CHANNEL_2);
}
...
void SYS_DMA_Channel2SetCRC(SYS_DMA_CHANNEL_OPERATION_MODE_CRC crc)
{
    ...
    if(true == PLIB_DMA_ExistsCRCChannel(DMA_ID_0))
    {
        PLIB_DMA_CRCChannelSelect(DMA_ID_0, DMA_CHANNEL_2);  
    }
#endif
                                         ...
                                         uint8_t ignorePattern )
{
    ...
    if(true == PLIB_DMA_ExistsChannelXPatternLength(DMA_ID_0))
    {
        PLIB_DMA_ChannelXPatternLengthSet(DMA_ID_0,DMA_CHANNEL_2,length);
    }
#endif
    /* Set the pattern for the pattern match */  
    PLIB_DMA_ChannelXPatternDataSet(DMA_ID_0,DMA_CHANNEL_2,pattern);
...
if(SYS_DMA_CHANNEL_IGNORE_MATCH_ENABLE == ignore)
{
        ...
        {
            /* Enable the ignore byte and the pattern */    
            PLIB_DMA_ChannelXPatternIgnoreByteEnable(DMA_ID_0,DMA_CHANNEL_2); 
        }
    #endif  
    #if defined(PLIB_DMA_ExistsChannelXPatternIgnore)    
        if(true == PLIB_DMA_ExistsChannelXPatternIgnore(DMA_ID_0))
        {  
            PLIB_DMA_ChannelXPatternIgnoreSet(DMA_ID_0,DMA_CHANNEL_2,ignorePattern);
        }
    #endif
}
}
...
{          
	//check address error
    if (PLIB_DMA_ChannelXINTSourceFlagGet(DMA_ID_0, DMA_CHANNEL_2, DMA_INT_ADDRESS_ERROR))
    {
		PLIB_DMA_ChannelXINTSourceFlagClear(DMA_ID_0, DMA_CHANNEL_2, DMA_INT_ADDRESS_ERROR);
    }
	//check transfer abort 
    if (PLIB_DMA_ChannelXINTSourceFlagGet(DMA_ID_0, DMA_CHANNEL_2, DMA_INT_TRANSFER_ABORT))
    {
		PLIB_DMA_ChannelXINTSourceFlagClear(DMA_ID_0, DMA_CHANNEL_2, DMA_INT_TRANSFER_ABORT);
    }

...
void SYS_DMA_Channel0TransferAdd(void)
{
   ...
   PLIB_DMA_ChannelXSourceStartAddressSet(DMA_ID_0, DMA_CHANNEL_0, (uint32_t)&ADCDATA2);
...
void SYS_DMA_Channel0Setup(SYS_DMA_CHANNEL_OP_MODE modeEnable)
{
    ...
    PLIB_DMA_ChannelXStartIRQSet(DMA_ID_0, DMA_CHANNEL_0, DMA_TRIGGER_ADC_DATA2);
}
...
void SYS_DMA_Channel1TransferAdd(void)
{
   ...
   /* Set the source and destination addresses (addresses are converted from virtual to physical) */
   PLIB_DMA_ChannelXSourceStartAddressSet(DMA_ID_0, DMA_CHANNEL_1, (uint32_t)&ADCDATA3);
...
void SYS_DMA_Channel1Setup(SYS_DMA_CHANNEL_OP_MODE modeEnable)
{
    ...
    PLIB_DMA_ChannelXStartIRQSet(DMA_ID_0, DMA_CHANNEL_1, DMA_TRIGGER_ADC_DATA3);
}
...
void SYS_DMA_Channel2TransferAdd(void)
{
   ...
   /* Set the source and destination addresses (addresses are converted from virtual to physical) */
   PLIB_DMA_ChannelXSourceStartAddressSet(DMA_ID_0, DMA_CHANNEL_2, (uint32_t)&ADCDATA4);
...
void SYS_DMA_Channel2Setup(SYS_DMA_CHANNEL_OP_MODE modeEnable)
{
    ...
    PLIB_DMA_ChannelXStartIRQSet(DMA_ID_0, DMA_CHANNEL_2, DMA_TRIGGER_ADC_DATA4);
}

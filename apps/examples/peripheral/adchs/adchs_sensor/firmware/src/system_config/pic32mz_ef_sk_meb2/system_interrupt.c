...
void __ISR(_ADC_VECTOR, ipl3AUTO) _IntHandlerDrvAdc(void)
{
    ...
    {
        appData.xAxis = DRV_ADC_SamplesRead(6);
    }
    if(true == DRV_ADC_SamplesAvailable(7))
    {
        appData.yAxis = DRV_ADC_SamplesRead(7);
    }
    if(true == DRV_ADC_SamplesAvailable(8))
    {
        appData.zAxis = DRV_ADC_SamplesRead(8);
    }
    if(true == DRV_ADC_SamplesAvailable(23))
    {
        appData.tempSensor = DRV_ADC_SamplesRead(23);
    }    

...
/* Function:
  ...
  Summary:
    Read external flash using DMA mode.
    <p><b>Implementation:</b> Static</p>

  Description:
	This routine when called will issue commands to read external flash using DMA mode.
  ...
  Example:
    <code>
    DRV_SQI_DMA_Read(FLASH_ADDRESS, FLASH_READ_COUNT, readBuffer);
    </code>

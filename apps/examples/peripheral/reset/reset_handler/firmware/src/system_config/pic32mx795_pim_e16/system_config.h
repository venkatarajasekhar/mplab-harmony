...
#define LED_WDT      BSP_LED_10
#define LED_POR      BSP_LED_5
#define LED_MCLR     BSP_LED_9
#define SWITCH_RESET_REASON_CLEAR     BSP_SWITCH_6
#define SWITCH_ENABLE_WDT             BSP_SWITCH_4

...
#define SYS_PORT_CNPUE          0x8000
#define SYS_PORT_CNEN           0x8000
...
#define APP_LED_BLINK_DELAY         10 // milliseconds
#define APP_CN_PORT_CHANNEL         PORT_CHANNEL_D
#define APP_CN_PORT_BIT             PORTS_BIT_POS_6
#define APP_CN_PORT_INTERRUPT       INT_SOURCE_CHANGE_NOTICE

...
typedef enum
{
    ...
    HGC_SCREEN_STATE_SETUP_SCREEN_Untitled,
    HGC_SCREEN_STATE_PRE_DRAW_GOL_SCREEN_Untitled,
    HGC_SCREEN_STATE_DRAW_GOL_SCREEN_Untitled,
    HGC_SCREEN_STATE_POST_DRAW_GOL_SCREEN_Untitled,
    HGC_SCREEN_STATE_PRE_DRAW_PRIMITIVE_SCREEN_Untitled,
    HGC_SCREEN_STATE_DRAW_PRIMITIVE_SCREEN_Untitled,
    HGC_SCREEN_STATE_POST_DRAW_PRIMITIVE_SCREEN_Untitled,
    HGC_SCREEN_STATE_DISPLAY_SCREEN_Untitled,

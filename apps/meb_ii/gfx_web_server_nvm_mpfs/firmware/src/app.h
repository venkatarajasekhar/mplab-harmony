...
typedef enum
{
    /* The app checks GFX status */
    APP_STATE_GFX_WAIT = 0,
...
*********************************************************************************************************
*/
#define  SYSTEM_HIGHPRIORITY_RTOSTASK_PRIO              7u
#define  SYSTEM_RTOSTASK_PRIO                           2u
...
*********************************************************************************************************
*/
#define  APPLICATION_RTOSTASK_SIZE                      1024u
#define  SYSTEM_RTOSTASK_SIZE                           2048u

void SYS_RTOS_TASK_Init(void);
bool DRV_WIFI_RTOS_TaskInit(void);
void DRV_WIFI_ISR_Sem_unlock(void);

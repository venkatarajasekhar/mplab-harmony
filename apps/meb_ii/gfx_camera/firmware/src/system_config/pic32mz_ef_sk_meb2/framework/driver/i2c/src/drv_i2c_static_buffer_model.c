...
{
    /* Initialize I2C0 */
    PLIB_I2C_BaudRateSet(I2C_ID_3, SYS_CLK_PeripheralFrequencyGet(CLK_BUS_PERIPHERAL_2), 400000);
...
{ 
    ...
    if (i2cBufferData != NULL)
    {
        ...
        if (i2cBufferData->i2cMode == DRV_I2C_MODE_MASTER)
        {
            ...
            if ( ((!(PLIB_I2C_StartWasDetected(I2C_ID_3))) && (!(PLIB_I2C_StopWasDetected(I2C_ID_3)))) || (PLIB_I2C_StopWasDetected(I2C_ID_3)) )
            {
                if ( (PLIB_I2C_BusIsIdle(I2C_ID_3)) && (!(PLIB_INT_SourceFlagGet(INT_ID_0, INT_SOURCE_I2C_3_MASTER))) )
                {
                        i2c0State = DRV_I2C_TASK_SEND_DEVICE_ADDRESS;
    ...
    switch (i2c0State)
    {
        case DRV_I2C_TASK_SEND_DEVICE_ADDRESS:
        {
            if (i2c0Obj.i2cMode == DRV_I2C_MODE_MASTER)
            {
                ...
                if (PLIB_I2C_StartWasDetected(I2C_ID_3))
                {
                    if ( (lBufferObj0->i2coperation == DRV_I2C_OP_WRITE) || (lBufferObj0->i2coperation == DRV_I2C_OP_WRITE_READ) )
                    {
                        ...
                        PLIB_I2C_TransmitterByteSend( I2C_ID_3, lBufferObj0->slaveaddresshighbyte );
                    }
                    else
                    {
                        lBufferObj0->bufferstatus    = DRV_I2C_BUFFER_SLAVE_READ_REQUESTED;
                        i2c0State = DRV_I2C_TASK_SET_RCEN_ONLY;
                        PLIB_I2C_TransmitterByteSend(I2C_ID_3, lBufferObj0->slaveaddresshighbyte | DRV_I2C_OP_READ );
                    }
                }
            }
            else if (i2c0Obj.i2cMode == DRV_I2C_MODE_SLAVE)
            {
                ...
                if ( (!PLIB_I2C_SlaveReadIsRequested(I2C_ID_3)) && (PLIB_I2C_SlaveAddressIsDetected(I2C_ID_3)) )
                {
                    ...
                    PLIB_I2C_SlaveClockRelease (I2C_ID_3);
                }
                /*  Slave is sending data back to the Master    */
                else if ( (PLIB_I2C_SlaveReadIsRequested(I2C_ID_3)) && (PLIB_I2C_SlaveAddressIsDetected(I2C_ID_3)) )
                {

                    PLIB_I2C_ReceivedByteGet (I2C_ID_3);
                    PLIB_I2C_SlaveClockHold (I2C_ID_3);
                    ...
                    // transmit first byte
                    PLIB_I2C_TransmitterByteSend(I2C_ID_3, *lBufferObj0->txBuffer++);
                    lBufferObj0->transfersize++;
                    PLIB_I2C_SlaveClockRelease (I2C_ID_3);
                }
                else if ( (!PLIB_I2C_SlaveReadIsRequested(I2C_ID_3)) && PLIB_I2C_SlaveDataIsDetected(I2C_ID_3))
                {
                    ...
                    {
                        *lBufferObj0->rxBuffer++ = PLIB_I2C_ReceivedByteGet(I2C_ID_3);
                        lBufferObj0->transfersize++;
                ...
                else if (PLIB_I2C_SlaveReadIsRequested(I2C_ID_3) && PLIB_I2C_SlaveDataIsDetected(I2C_ID_3))
                {
                    ...
                    if ( PLIB_I2C_TransmitterByteWasAcknowledged(I2C_ID_3) )
                    {
                        ...
                        {
                            lBufferObj0->bufferstatus = DRV_I2C_BUFFER_EVENT_ERROR;
                            PLIB_I2C_TransmitterByteSend(I2C_ID_3, 0);
                            if ( i2c0ClientObj.callback != NULL )
                            {
                                /* Give an indication to the higher layer upon when error happens */
                                i2c0ClientObj.callback(DRV_I2C_BUFFER_EVENT_ERROR, 
                    ...
                    else if ( !PLIB_I2C_TransmitterByteWasAcknowledged(I2C_ID_3) )
                    {
                        PLIB_I2C_SlaveClockRelease (I2C_ID_3);
        ...
        case DRV_I2C_SEND_DEVICE_ADDRESS_BYTE_2:
        {
            ...
            {
                PLIB_I2C_TransmitterByteSend(I2C_ID_3,lBufferObj0->slaveaddresslowbyte>>1) ;
                i2c0State = DRV_I2C_TASK_SET_RCEN_ONLY;
            }
            else
            {                         
        ...
        case DRV_I2C_SEND_RANDOM_READ_DEVICE_ADDRESS:
        {
            ...
            PLIB_I2C_TransmitterByteSend( I2C_ID_3,tempDeviceAddress );
            i2c0State = DRV_I2C_TASK_SET_RCEN_ONLY;
            break;
        }
        ...
        case    DRV_I2C_TASK_PROCESS_WRITE_ONLY:
        {
            if (lBufferObj0->transfersize)
            {
                if ( PLIB_I2C_TransmitterByteHasCompleted (I2C_ID_3) )
                {
                    if ( PLIB_I2C_TransmitterByteWasAcknowledged (I2C_ID_3) ||
        ...
        case    DRV_I2C_BUS_SILENT:
        {
            ...
            */
            ...
            if ( (PLIB_I2C_TransmitterByteWasAcknowledged (I2C_ID_3)) ||
                    ( PLIB_I2C_TransmitterByteHasCompleted (I2C_ID_3)  &&
                        (!PLIB_I2C_TransmitterByteWasAcknowledged (I2C_ID_3)) ) )
            {
        ...
        case DRV_I2C_TASK_SET_RCEN_ONLY:
		{
            if ( PLIB_I2C_TransmitterByteHasCompleted(I2C_ID_3) )
            {
                if ( PLIB_I2C_TransmitterByteWasAcknowledged(I2C_ID_3) )
                {
                    ...
                    if (PLIB_I2C_ReceiverByteAcknowledgeHasCompleted(I2C_ID_3))
                    {

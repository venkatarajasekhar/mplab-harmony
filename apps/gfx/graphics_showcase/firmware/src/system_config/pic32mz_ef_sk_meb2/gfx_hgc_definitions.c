...
static const GFX_XCHAR buttonStr_27[] = { 0x0 }; //  
...
static const GFX_XCHAR staticTextStr_15[] = { 0x30, 0x0 }; // ?
static const GFX_XCHAR staticTextStr_16[] = { 0x29, 0x0 }; // )
...
static const GFX_XCHAR staticTextStr_19[] = { 0x24, 0x2c, 0x2e, 0x43, 0x44, 0x29, 0x43, 0x0 }; // ???????
static const GFX_XCHAR staticTextStr_20[] = { 0x24, 0x2d, 0x2e, 0x42, 0x44, 0x2a, 0x42, 0x0 }; // ???????
...
static const GFX_XCHAR staticTextStr_22[] = { 0x41, 0x27, 0x3b, 0x39, 0x0 }; // ????
static const GFX_XCHAR staticTextStr_23[] = { 0x40, 0x25, 0x3d, 0x39, 0x0 }; // ????
...
static const GFX_XCHAR staticTextStr_25[] = { 0x31, 0x21, 0x20, 0x28, 0x0 }; // ????
static const GFX_XCHAR staticTextStr_26[] = { 0x43, 0x68, 0x69, 0x6e, 0x65, 0x73, 0x65, 0x20, 0x54, 0x72, 0x61, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x0 }; // Chinese Traditional
...
void GFX_HGC_InitializeSchemes( void )
{
    ...
    gfxScheme3->pFont =             (GFX_RESOURCE_HDR*)&SimHei18;
    ...
    switch (hgcObj.screenState)
    {
        ...
        case HGC_SCREEN_STATE_DISPLAY_SCREEN_Rockies:
            ...
            if (GFX_HGC_MsgWindows(objMsg, pObj, pMsg) == true)
                return true;
            break;
        case HGC_SCREEN_STATE_DISPLAY_SCREEN_Sherwood:
            if (GFX_HGC_MsgButtons(objMsg, pObj, pMsg) == true)
                return true;
            if (GFX_HGC_MsgDigitalMeters(objMsg, pObj, pMsg) == true)
                return true;
...
bool GFX_HGC_DrawCallback( void )
{
    switch (hgcObj.screenState)
    {
        ...
        case HGC_SCREEN_STATE_DISPLAY_SCREEN_Rockies:
            break;
        case HGC_SCREEN_STATE_SETUP_SCREEN_Sherwood:
            GFX_HGC_SetScreenState(HGC_SCREEN_STATE_PRE_DRAW_GOL_SCREEN_Sherwood);
            break;
        case HGC_SCREEN_STATE_PRE_DRAW_GOL_SCREEN_Sherwood:
            GFX_HGC_SetScreenState(HGC_SCREEN_STATE_DRAW_GOL_SCREEN_Sherwood);
            break;
        case HGC_SCREEN_STATE_DRAW_GOL_SCREEN_Sherwood:
            GFX_HGC_SetupScreen(Sherwood);
            GFX_HGC_DrawScreen_GOL(Sherwood);
            GFX_HGC_SetScreenState(HGC_SCREEN_STATE_POST_DRAW_GOL_SCREEN_Sherwood);
            break;
        case HGC_SCREEN_STATE_POST_DRAW_GOL_SCREEN_Sherwood:
            GFX_HGC_SetScreenState(HGC_SCREEN_STATE_PRE_DRAW_PRIMITIVE_SCREEN_Sherwood);
            break;
        case HGC_SCREEN_STATE_PRE_DRAW_PRIMITIVE_SCREEN_Sherwood:
            GFX_HGC_SetScreenState(HGC_SCREEN_STATE_DRAW_PRIMITIVE_SCREEN_Sherwood);
            break;
        case HGC_SCREEN_STATE_DRAW_PRIMITIVE_SCREEN_Sherwood:
            GFX_HGC_DrawScreen_Primitives(Sherwood);
            GFX_HGC_SetScreenState(HGC_SCREEN_STATE_POST_DRAW_PRIMITIVE_SCREEN_Sherwood);
            break;
        case HGC_SCREEN_STATE_POST_DRAW_PRIMITIVE_SCREEN_Sherwood:
            GFX_HGC_SetScreenState(HGC_SCREEN_STATE_DISPLAY_SCREEN_Sherwood);
            break;
        case HGC_SCREEN_STATE_DISPLAY_SCREEN_Sherwood:
            break;
...
bool GFX_HGC_ChangeScreen(uint8_t screenId)
{
    switch (screenId)
    {
        ...
        case Rockies:
            ...
            break;
        case Sherwood:
            GFX_HGC_SetScreenState(HGC_SCREEN_STATE_SETUP_SCREEN_Sherwood);
            break;
        case SnowLeopard:
...
bool GFX_HGC_DrawScreen_GOL(uint8_t screenId)
{
    switch (screenId)
    {
        case MainMenu:
            ...
            GFX_HGC_DrawItem(Picture22);
            GFX_HGC_DrawItem(Picture21);
...
bool GFX_HGC_DrawItem(int itemId)
{
    ...
    case TouchArea:
        ...
        break;
    case Picture21:
        hgcObj.pPicture21Obj = GFX_GOL_PictureControlCreate
                (
                 GFX_INDEX_0,
                 Picture21,      // picture ID
        ...
        break;
    case Picture22:
        hgcObj.pPicture22Obj = GFX_GOL_PictureControlCreate
                (
                 GFX_INDEX_0,
                 Picture22,      // picture ID
    ...
    case Picture4:
        hgcObj.pPicture4Obj = GFX_GOL_PictureControlCreate
                (
                 ...
                 (GFX_RESOURCE_HDR*)&MicrochipLogo_JPEG,    // bitmap
    ...
    case Picture3:
        hgcObj.pPicture3Obj = GFX_GOL_PictureControlCreate
                (
                 ...
                 (GFX_RESOURCE_HDR*)&ScienceWorldNight_JPEG,    // bitmap
    ...
    case Picture1:
        hgcObj.pPicture1Obj = GFX_GOL_PictureControlCreate
                (
                 ...
                 (GFX_RESOURCE_HDR*)&CoalHarbourDay_JPEG,    // bitmap
    ...
    case Picture2:
        hgcObj.pPicture2Obj = GFX_GOL_PictureControlCreate
                (
                 ...
                 (GFX_RESOURCE_HDR*)&EnglishBayFireworks_JPEG,    // bitmap
    ...
    case Picture6:
        hgcObj.pPicture6Obj = GFX_GOL_PictureControlCreate
                (
                 ...
                 (GFX_RESOURCE_HDR*)&AutumnGrass_JPEG,    // bitmap
    ...
    case Picture13:
        ...
        break;
    case Picture14:
        hgcObj.pPicture14Obj = GFX_GOL_PictureControlCreate
                (
                 GFX_INDEX_0,
                 Picture14,      // picture ID
                 ...
                 (GFX_RESOURCE_HDR*)&Sherwood_JPEG,    // bitmap
    ...
    case Picture5:
        hgcObj.pPicture5Obj = GFX_GOL_PictureControlCreate
                (
                 ...
                 (GFX_RESOURCE_HDR*)&NewHarmonyLogo_JPEG,    // bitmap

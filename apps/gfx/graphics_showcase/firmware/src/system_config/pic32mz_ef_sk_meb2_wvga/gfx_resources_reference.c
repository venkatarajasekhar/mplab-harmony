...
const GFX_RESOURCE_HDR splash =
{
    ...
    .resource.image.parameter2.rawSize = 768004,
 ...
 ***********************************/
#if defined (GFX_CONFIG_IMAGE_PACKED_ENABLE) && (__XC16_VERSION__ >= 1011)
extern uint8_gfx_image_prog __sherwood[] __attribute__((section("grc_images")));
#else
extern uint8_gfx_image_prog __sherwood[] __attribute__((section("grc_images"), aligned(2)));
#endif
...
const GFX_RESOURCE_HDR sherwood =
{
    .type = (GFX_RESOURCE_MEMORY_FLASH | GFX_RESOURCE_TYPE_MCHP_MBITMAP | GFX_RESOURCE_COMP_NONE),
    .ID = 0,
    .resource.image.location.progByteAddress = (uint8_gfx_image_prog *) __sherwood,
    .resource.image.width = 800,
    .resource.image.height = 480,
    .resource.image.parameter1.compressedSize = 0,
    .resource.image.parameter2.rawSize = 768004,
 ...
 ***********************************/
#if defined (GFX_CONFIG_IMAGE_PACKED_ENABLE) && (__XC16_VERSION__ >= 1011)
extern uint8_gfx_image_prog __harmony_logo_small[] __attribute__((section("grc_images")));
#else
extern uint8_gfx_image_prog __harmony_logo_small[] __attribute__((section("grc_images"), aligned(2)));
#endif

const GFX_RESOURCE_HDR harmony_logo_small =
{
    .type = (GFX_RESOURCE_MEMORY_FLASH | GFX_RESOURCE_TYPE_MCHP_MBITMAP | GFX_RESOURCE_COMP_NONE),
    .ID = 0,
    .resource.image.location.progByteAddress = (uint8_gfx_image_prog *) __harmony_logo_small,
    .resource.image.width = 450,
    .resource.image.height = 106,
    .resource.image.parameter1.compressedSize = 0,
    .resource.image.parameter2.rawSize = 95404,
    .resource.image.colorDepth = 16,
    .resource.image.type = 0x00,
    .resource.image.paletteID = 0x0000
};

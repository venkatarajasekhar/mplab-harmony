...
typedef struct{
    APP_MENU3D_STATES states_3dmenu;
    uint8_t angle_index;
    uint8_t angle_max_index;
    uint8_t angle_increment;
    SYS_TMR_HANDLE sysTmrHandle_3D;    
    uint32_t rotation_speed;
    uint8_t sliderTimerValue;
    uint8_t speedMax;
    GFX_XCHAR speedstring[3];
}APP_3DMENU_DATA;


typedef struct{
    APP_MENUFLASH_STATES states_flashmenu;
    uint8_t angle_index;
    uint8_t angle_max_index;
    uint8_t angle_increment;
    SYS_TMR_HANDLE sysTmrHandle_flash;    
...
typedef struct{
    APP_THERMMENU_STATES thermmenu_state;
    
    SYS_TMR_HANDLE sysTmrHandle_fan;
    
    uint32_t fan_timedelay;
    
    //SYS_TMR_HANDLE sysTmrHandle_thermometer;
    
    //uint32_t temperature_timedelay;
    
    bool fan_on;
    
    bool fan_off_pressed;
    ...
    GFX_XCHAR tempstring[3];
    
    bool tempString_update;

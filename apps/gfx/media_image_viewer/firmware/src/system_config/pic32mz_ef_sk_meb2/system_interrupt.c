...
void __ISR(_TIMER_9_VECTOR, ipl4AUTO) _IntHandlerDrvI2CMasterInstance0(void)
{
 ...
 void __ISR(_DMA0_VECTOR + DMA_CHANNEL_5, ipl7AUTO) _IntHandlerLCCRefresh(void)
{
    SYS_INT_SourceStatusClear(INT_SOURCE_DMA_0 + DMA_CHANNEL_5);

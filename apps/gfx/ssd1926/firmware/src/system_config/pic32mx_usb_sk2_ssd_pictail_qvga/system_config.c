/*******************************************************************************
 SSD1926 Driver Demo Configuration file.
  ...
  Summary:
    Top-level configuration file for the SSD1926 Driver demo application.

  Description:
    This file contains the SSD1926 Driver specific data that

...
{
    STATE_INIT = 0,
    STATE_DRAW_GOL_SCREEN_Untitled,
    STATE_DRAW_PRIMITIVE_SCREEN_Untitled,
    STATE_DISPLAY_SCREEN_Untitled,
...
#define GFX_SCHEME_EMBOSS_DARK_COLOR_RED_0      0x4
#define GFX_SCHEME_EMBOSS_DARK_COLOR_GREEN_0    0x4
#define GFX_SCHEME_EMBOSS_DARK_COLOR_BLUE_0     0x4

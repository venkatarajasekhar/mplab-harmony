 ...
 * User Defines
 *****************************************************************************/
    #define SSD_SYS_CLOCK   (uint32_t) (4000000)   // SSD1926 crystal frequncy
    #define SSD_SD_CLK_INIT (uint32_t) (400000)
 ...
 * Flags
 *****************************************************************************/
    #define SSD_SD_CLK_CTRL_ON      (uint32_t) 0x80000000
    #define SSD_SD_CLK_ENABLE       (uint32_t) 0x00000004
    #define SSD_SD_INT_CLK_STABLE   (uint32_t) 0x00000002
    #define SSD_SD_INT_CLK_ENABLE   (uint32_t) 0x00000001
...
#endif //  _SSD_SD_CARD_HEADER_FILE

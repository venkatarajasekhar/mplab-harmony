...
// JPEG FIFO Size and Location
    #define SSD_JPEG_FIFO_BLK_SIZE      (uint32_t) (1024 << 2)
    #define SSD_JPEG_FIFO_BLK_NUMBER    (uint32_t) 16
    #define SSD_JPEG_FIFO_SIZE          SSD_JPEG_FIFO_BLK_SIZE * SSD_JPEG_FIFO_BLK_NUMBER
    #define SSD_JPEG_FIFO_START_ADDR    (uint32_t) (0x30000)

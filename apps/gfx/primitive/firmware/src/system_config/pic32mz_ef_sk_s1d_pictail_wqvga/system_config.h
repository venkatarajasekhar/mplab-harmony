...
#define SYS_PORT_B_TRIS         0xE7CF
#define SYS_PORT_B_LAT          0x0000
#define SYS_PORT_B_ODC          0x0000
#define SYS_PORT_B_CNPU         0x6000
...
#define BSP_ADC_TOUCH_YPLUS_PIN PORTS_BIT_POS_2
#define BSP_ADC_TOUCH_YPLUS_PIN_MASK (0x1 << 2)
...
#define BSP_ADC_TOUCH_YMINUS_PORT PORT_CHANNEL_H
#define BSP_ADC_TOUCH_YMINUS_PIN PORTS_BIT_POS_7
#define BSP_ADC_TOUCH_YMINUS_PIN_MASK (0x1 << 7)

/*** Functions for BSP_ADC_TOUCH_XMINUS pin ***/
#define BSP_ADC_TOUCH_XMINUS_PORT PORT_CHANNEL_D
#define BSP_ADC_TOUCH_XMINUS_PIN PORTS_BIT_POS_14
#define BSP_ADC_TOUCH_XMINUS_PIN_MASK (0x1 << 14)

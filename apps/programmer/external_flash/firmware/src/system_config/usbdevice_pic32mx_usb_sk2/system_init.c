...
// </editor-fold>
// <editor-fold defaultstate="collapsed" desc="DRV_SST25VF016B Initialization Data">
// *****************************************************************************
/* SST25VF016B Driver Initialization Data
*/

const DRV_SST25VF016B_INIT drvSst25vf016b0InitData =
{
    .moduleInit = {DRV_SST25VF016B_POWER_STATE_IDX0},
    .spiDriverModuleIndex = DRV_SST25VF016B_SPI_DRIVER_INSTANCE_IDX0, 
    .chipSelectPortChannel = DRV_SST25VF016B_CHIP_SELECT_PORT_CHANNEL_IDX0,
    .chipSelectBitPosition = DRV_SST25VF016B_CHIP_SELECT_PORT_BIT_POS_IDX0,
    .queueSize = DRV_SST25VF016B_QUEUE_SIZE_IDX0,
};
...
void SYS_Initialize ( void* data )
{
    ...
    sysObj.drvSst25vf016b0 = DRV_SST25VF016B_Initialize(DRV_SST25VF016B_INDEX_0, (SYS_MODULE_INIT *)&drvSst25vf016b0InitData);

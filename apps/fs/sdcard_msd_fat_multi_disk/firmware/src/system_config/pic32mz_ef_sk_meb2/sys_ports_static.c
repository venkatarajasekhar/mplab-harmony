...
void SYS_PORTS_Initialize(void)
{
    ...
    PLIB_PORTS_DirectionInputSet( PORTS_ID_0, PORT_CHANNEL_H,  SYS_PORT_H_TRIS);
    PLIB_PORTS_OpenDrainEnable(PORTS_ID_0, PORT_CHANNEL_H, SYS_PORT_H_ODC);
    PLIB_PORTS_ChannelModeSelect(PORTS_ID_0, PORT_CHANNEL_H, SYS_PORT_H_ANSEL, PORTS_PIN_MODE_ANALOG);
    ...
    PLIB_PORTS_DirectionInputSet( PORTS_ID_0, PORT_CHANNEL_J,  SYS_PORT_J_TRIS);
    PLIB_PORTS_OpenDrainEnable(PORTS_ID_0, PORT_CHANNEL_J, SYS_PORT_J_ODC);
    PLIB_PORTS_ChannelModeSelect(PORTS_ID_0, PORT_CHANNEL_J, SYS_PORT_J_ANSEL, PORTS_PIN_MODE_ANALOG);
    ...
    PLIB_PORTS_DirectionInputSet( PORTS_ID_0, PORT_CHANNEL_K,  SYS_PORT_K_TRIS);
    PLIB_PORTS_OpenDrainEnable(PORTS_ID_0, PORT_CHANNEL_K, SYS_PORT_K_ODC);
    PLIB_PORTS_ChannelModeSelect(PORTS_ID_0, PORT_CHANNEL_K, SYS_PORT_K_ANSEL, PORTS_PIN_MODE_ANALOG);

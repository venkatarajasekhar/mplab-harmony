...
typedef enum
{
    ...
    /* Open root directory from NVM drive */
    APP_OPEN_DIRECTORY,

    /* Search directory */
    APP_SEARCH_DIRECTORY,
    ...
    /* Write character data on SD Card */
    APP_WRITE_CHAR_TO_FILE_ON_SDCARD,

    /* Write string data on SD Card */
    APP_WRITE_STRING_TO_FILE_ON_SDCARD,

...
void TCPIP_HTTP_Print_name(HTTP_CONN_HANDLE connHandle)
{
    ...
    if (s_scanResultIsValid)
    {
        ...
        else
        {
            ...
            ssidLongString[32] = 0;
            TCPIP_TCP_StringPut(sktHTTP, ssidLongString);
        }
    }
    else
    {
...
void TCPIP_HTTP_Print_prevSSID(HTTP_CONN_HANDLE connHandle)
{
    ...
    TCPIP_TCP_StringPut(sktHTTP, (uint8_t *)g_redirectionConfig.prevSSID);
}
...
void TCPIP_HTTP_Print_nextSSID(HTTP_CONN_HANDLE connHandle)
{
    ...
    TCPIP_TCP_StringPut(sktHTTP, (uint8_t *)g_redirectionConfig.ssid);
}

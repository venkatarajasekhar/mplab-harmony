...
function userSelectNetwork() {
    ...
    if (otherNetworkExpanded)
    {
        ...
        secSel.options[2] = new Option('WPA-PSK/WPA2-PSK Auto', '5');
...
function infraSel()
{
    if (document.getElementById('sec1').options.length == 2) {
        document.getElementById('sec1').options[2] = new Option('WPA-PSK/WPA2-PSK Auto', '5');
    }
}
...
function displayScanResults()
{
    ...
    document.getElementById("rescan").value = textLabel;
    //alert("This is scan results before starting up in Soft AP ... ");

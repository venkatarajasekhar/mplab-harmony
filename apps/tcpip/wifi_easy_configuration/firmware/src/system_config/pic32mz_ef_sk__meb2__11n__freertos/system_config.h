...
#define SYS_PORT_B_ANSEL        0x8FC1
...
#define WF_HIBERNATE_PORT_CHANNEL PORT_CHANNEL_B
...
#define WF_INT_BIT_POS      12

#define MRF_INT_SOURCE INT_SOURCE_EXTERNAL_2
#define MRF_INT_VECTOR INT_VECTOR_INT2

            ...
            */
            ...
            if(TCPIP_SNMPV3_TrapTypeGet())
            {
                for(targetIndex=userIndex;targetIndex<TCPIP_SNMPV3_USM_MAX_USER;targetIndex++)
                {
                    ...
                    analogPotVal.byte = BSP_SwitchStateGet(APP_SWITCH_1);
...
*/
    ...
    {
        if(BSP_SwitchStateGet(APP_SWITCH_3) == 0u)
        {
...
#ifdef __PIC32MZ__
   uitoa((uint16_t) AD1DATA0, AN0String);
#else
   uitoa((uint16_t) ADC1BUF0, AN0String);
    ...
    switch(var)
    {
        ...
        case PUSH_BUTTON:
            ...
            val->byte = BSP_SwitchStateGet(APP_SWITCH_1);
            return true;

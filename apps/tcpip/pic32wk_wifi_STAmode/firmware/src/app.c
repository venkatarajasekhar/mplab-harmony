    ...
    switch ( appData.state )
    {
		...
		case APP_TCPIP_WAIT_FOR_TCPIP_INIT:
        {
            ...
            else if(tcpipStat == SYS_STATUS_READY)
            {
                ...
                appData.state = APP_TCPIP_WAITING_FOR_COMMAND; //APP_WIFI_CONNECT;
        ...
        case APP_TCPIP_WAITING_FOR_COMMAND:
        {
            ...
            TCPIP_NET_HANDLE    netH;
            IPV4_ADDR           ipAddr;
            static IPV4_ADDR    dwLastIP[2] = { {-1}, {-1} }; // array size depends on net interface number

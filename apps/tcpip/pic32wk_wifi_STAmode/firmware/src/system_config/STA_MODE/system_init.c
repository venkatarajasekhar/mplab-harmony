...
void changeMicroInterruptToMips32(void){
    __builtin_mtc0(16,3,(__builtin_mfc0(16,3) & 0xFFFEFFFF)); 
}
...
void SYS_Initialize ( void* data )
{
    ...
    /*UART Console issue fixed: 
     * condition: while loading Image from IPF to SRAM
     */

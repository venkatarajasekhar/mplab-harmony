...
ClassB_Test_Flags testFlag;
 ...
 CLASSBRESULT ClassBDemo(void){
    ...
    testFlag.clock_TestResult=CLASSB_ClockTest(SYSTEM_CLOCK, CLOCK_TEST_REFERENCE_FREQ, 1000, 10);
    ...
    testFlag.clockLine_TestResult=CLASSB_ClockLineFreqTest(SYSTEM_CLOCK, 50, 10);

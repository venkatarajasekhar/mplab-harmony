...
typedef struct
{
    USB_DEVICE_AUDIO_V2_TRANSFER_HANDLE readTransferHandle[APP_USB_AUDIO_BUFFER_QUEUE_MAX_COUNT];
    volatile bool dataAvailable[APP_USB_AUDIO_BUFFER_QUEUE_MAX_COUNT];
    uint8_t __attribute__((coherent)) __attribute__((aligned(16))) rxBuffer[APP_USB_AUDIO_BUFFER_QUEUE_MAX_COUNT][APP_NO_OF_SAMPLES_IN_A_USB_FRAME];        

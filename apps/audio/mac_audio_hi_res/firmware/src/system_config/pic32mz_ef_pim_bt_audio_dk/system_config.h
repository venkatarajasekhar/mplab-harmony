...
#define SYS_CLK_BUS_REFERENCE_1             24581959ul
...
#define SYS_PORT_D_ANSEL        0x65D1
...
#define SYS_PORT_F_ANSEL        0xFFDB
...
#define SYS_PORT_G_ANSEL        0x7FFF
...
#define SYS_PORT_H_ANSEL        0xAFF8
...
#define SYS_PORT_H_CNEN         0x0007

#define SYS_PORT_J_ANSEL        0x9FFF
...
#define SYS_PORT_J_CNEN         0x4000

#define SYS_PORT_K_ANSEL        0xFFCE
...
#define DRV_I2S_BAUD_RATE                       192000
...
#define DRV_AK4384_INPUT_REFCLOCK    	                	7
#define DRV_AK4384_AUDIO_SAMPLING_RATE                      192000
#define DRV_AK4384_MCLK_SAMPLE_FREQ_MULTPLIER               (SYS_CLK_BUS_REFERENCE_1/DRV_AK4384_AUDIO_SAMPLING_RATE)
#define DRV_AK4384_BCLK_BIT_CLK_DIVISOR	                	2
...
#define USB_DEVICE_AUDIO_V2_INSTANCES_NUMBER  1
...
#define USB_DEVICE_AUDIO_V2_QUEUE_DEPTH_COMBINED     66


/* No of Audio streaming interfaces */
#define USB_DEVICE_AUDIO_V2_MAX_STREAMING_INTERFACES   1

/* No of alternate settings */
#define USB_DEVICE_AUDIO_V2_MAX_ALTERNATE_SETTING      2
...
#define BSP_AK4201_AMPLIFIER_PDNToggle() PLIB_PORTS_PinToggle(PORTS_ID_0, PORT_CHANNEL_D, PORTS_BIT_POS_5)
#define BSP_AK4201_AMPLIFIER_PDNOn() PLIB_PORTS_PinSet(PORTS_ID_0, PORT_CHANNEL_D, PORTS_BIT_POS_5)
#define BSP_AK4201_AMPLIFIER_PDNOff() PLIB_PORTS_PinClear(PORTS_ID_0, PORT_CHANNEL_D, PORTS_BIT_POS_5)
#define BSP_AK4201_AMPLIFIER_PDNStateGet() PLIB_PORTS_PinGetLatched(PORTS_ID_0, PORT_CHANNEL_D, PORTS_BIT_POS_5)
#define BSP_AK4201_AMPLIFIER_PDNStateSet(Value) PLIB_PORTS_PinWrite(PORTS_ID_0, PORT_CHANNEL_D, PORTS_BIT_POS_5, Value)

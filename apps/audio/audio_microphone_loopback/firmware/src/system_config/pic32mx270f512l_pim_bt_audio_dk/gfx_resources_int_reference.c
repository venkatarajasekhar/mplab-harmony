...
extern uint8_gfx_image_prog __MCHP_LOGO1[] __attribute__((section("grc_images")));
#else
extern uint8_gfx_image_prog __MCHP_LOGO1[] __attribute__((section("grc_images"), aligned(2)));
#endif

const GFX_RESOURCE_HDR MCHP_LOGO1 =
{
    .type = (GFX_RESOURCE_MEMORY_FLASH | GFX_RESOURCE_TYPE_MCHP_MBITMAP | GFX_RESOURCE_COMP_NONE),
    .ID = 0,
    .resource.image.location.progByteAddress = (uint8_gfx_image_prog *) __MCHP_LOGO1,

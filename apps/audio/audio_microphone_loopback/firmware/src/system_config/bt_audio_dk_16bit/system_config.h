...
#define SYS_PORT_D_ANSEL        0x0002
...
/* KEEP: These defines for Pin G15 added manually because pin is incorrectly marked as unavailable in
*  MHC 2.0 pin settings and pin diagram */

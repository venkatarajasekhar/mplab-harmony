...
bool GFX_HGC_DrawItem(int itemId)
{
    switch(itemId)
    {
		...
		case Text1:
		{
			GFX_XCHAR Text1_text[] = { 0x50, 0x69, 0x63, 0x33, 0x32, 0x4d, 0x58, 0x32, 0x37, 0x30, 0x46, 0x35, 0x31, 0x32, 0x4c, 0x20, 0x20, 0x20, 0x56, 0x32, 0x2e, 0x30, 0x62, 0x0 };
		...
		case CodecType:
		{
			GFX_XCHAR CodecType_text[] = { 0x43, 0x6f, 0x64, 0x65, 0x63, 0x3a, 0x20, 0x41, 0x4b, 0x34, 0x33, 0x38, 0x34, 0x0 };

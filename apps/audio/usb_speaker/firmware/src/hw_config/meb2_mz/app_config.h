...
#define APP_LED4_ON()                                   BSP_LED_6On()
#define APP_LED4_OFF()                                  BSP_LED_6Off()
#define APP_LED4_TOGGLE()                               BSP_LED_6Toggle()

#define APP_LED5_ON()                                   BSP_LED_7On()
#define APP_LED5_OFF()                                  BSP_LED_7Off()
#define APP_LED5_TOGGLE()                               BSP_LED_7Toggle()

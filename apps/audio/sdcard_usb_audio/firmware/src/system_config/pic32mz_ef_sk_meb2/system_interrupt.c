...
void __ISR(_I2C2_MASTER_VECTOR, ipl1AUTO) _IntHandlerDrvI2CMasterInstance0(void)
{
...
void __ISR(_I2C1_MASTER_VECTOR, ipl4AUTO) _IntHandlerDrvI2CMasterInstance1(void)
{
    DRV_I2C_Tasks(sysObj.drvI2C1);
}
      
    
void __ISR(_I2C1_BUS_VECTOR, ipl4AUTO) _IntHandlerDrvI2CErrorInstance1(void)
{

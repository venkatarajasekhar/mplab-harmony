...
const uint8_t fullSpeedConfigurationDescriptor[]=
{
    ...
    110,0,                //(110 Bytes)Size of the Config descriptor.e
 ...
 *******************************************/
    ...
    sd002 =
    {
        sizeof(sd002),
        USB_DESCRIPTOR_STRING,
		{'H','a','r','m','o','n','y',' ','U','S','B',' ','S','p','e','a','k','e','r'}
    }; 
...
void SYS_Initialize ( void* data )
{
    ...
    SYS_INT_VectorPrioritySet(INT_VECTOR_I2C1_MASTER, INT_PRIORITY_LEVEL4);
    SYS_INT_VectorSubprioritySet(INT_VECTOR_I2C1_MASTER, INT_SUBPRIORITY_LEVEL0);
    SYS_INT_VectorPrioritySet(INT_VECTOR_I2C1_BUS, INT_PRIORITY_LEVEL4);

...
#define DRV_AK4642_BCLK_BIT_CLK_DIVISOR                     8
...
#define DRV_I2S_RX_DMA_CHANNEL_IDX0				DMA_CHANNEL_1
...
/*** Functions for BSP_SWITH_1 pin ***/
#define BSP_SWITH_1StateGet() PLIB_PORTS_PinGet(PORTS_ID_0, PORT_CHANNEL_A, PORTS_BIT_POS_0)

/*** Functions for BSP_SWITH_3 pin ***/
#define BSP_SWITH_3StateGet() PLIB_PORTS_PinGet(PORTS_ID_0, PORT_CHANNEL_A, PORTS_BIT_POS_10)

/*** Functions for BSP_SWITH_2 pin ***/
#define BSP_SWITH_2StateGet() PLIB_PORTS_PinGet(PORTS_ID_0, PORT_CHANNEL_A, PORTS_BIT_POS_1)

/*** Functions for BSP_SWITH_4 pin ***/
#define BSP_SWITH_4StateGet() PLIB_PORTS_PinGet(PORTS_ID_0, PORT_CHANNEL_B, PORTS_BIT_POS_12)

/*** Functions for BSP_SWITH_5 pin ***/
#define BSP_SWITH_5StateGet() PLIB_PORTS_PinGet(PORTS_ID_0, PORT_CHANNEL_B, PORTS_BIT_POS_13)

/*** Functions for BSP_SWITH_6 pin ***/
#define BSP_SWITH_6StateGet() PLIB_PORTS_PinGet(PORTS_ID_0, PORT_CHANNEL_B, PORTS_BIT_POS_14)

...
#define DRV_AK7755_CLIENTS_NUMBER							1
#define DRV_AK7755_INSTANCES_NUMBER							1
#define DRV_AK7755_INPUT_REFCLOCK    	                	6
#define DRV_AK7755_AUDIO_SAMPLING_RATE						48000
#define DRV_AK7755_MCLK_SAMPLE_FREQ_MULTPLIER	            (SYS_CLK_BUS_REFERENCE_1/DRV_AK7755_AUDIO_SAMPLING_RATE)
#define DRV_AK7755_BCLK_BIT_CLK_DIVISOR	                	4
#define DRV_AK7755_ENABLE_MICROPHONE						0

#define DRV_AK7755_I2S_DRIVER_MODULE_INDEX_IDX0				DRV_I2S_INDEX_0
#define DRV_AK7755_I2C_DRIVER_MODULE_INDEX_IDX0				DRV_I2C_INDEX_0
#define DRV_AK7755_VOLUME									150
...
/*** Functions for BSP_AK7755_PDN pin ***/
#define BSP_AK7755_PDNToggle() PLIB_PORTS_PinToggle(PORTS_ID_0, PORT_CHANNEL_G, PORTS_BIT_POS_15)
#define BSP_AK7755_PDNOn() PLIB_PORTS_PinSet(PORTS_ID_0, PORT_CHANNEL_G, PORTS_BIT_POS_15)
#define BSP_AK7755_PDNOff() PLIB_PORTS_PinClear(PORTS_ID_0, PORT_CHANNEL_G, PORTS_BIT_POS_15)
#define BSP_AK7755_PDNStateGet() PLIB_PORTS_PinGetLatched(PORTS_ID_0, PORT_CHANNEL_G, PORTS_BIT_POS_15)
#define BSP_AK7755_PDNStateSet(Value) PLIB_PORTS_PinWrite(PORTS_ID_0, PORT_CHANNEL_G, PORTS_BIT_POS_15, Value)

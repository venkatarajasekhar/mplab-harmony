/*******************************************************************************
 Universal Audio Decoders Demo
  ...
  Summary:
    This file is an abstraction layer of speex library.
...
#include "decoder/include/speex/speex.h"
...
/*******************************************************************************
  ...
  Description:
    The function internally calls SPEEX codec decoder initialization function,
...
/*******************************************************************************
  ...
  Summary:
    This function is called once to decode one packet.
...
/*******************************************************************************
  ...
  Summary:
    This function reads one packet of Ogg-Speex audio.
...
/*******************************************************************************
  ...
  Summary:
    This function free the memory that SPEEX decoder allocated.

  Description:
    This function is called when SPEEX decoder ends.
...
/*******************************************************************************
  ...
  Summary:
    This function indicates if the SPEEX decoder is enabled.
  ...
  Returns:
    ...
    - true		- indicates that SPEEX decoder is enabled.
    - false     - indicates that SPEEX decoder is disabled.
...
/*******************************************************************************
  ...
  Precondition:
    This function can only be called after SPEEX_Initialize() function.
	
  Parameters:
    None

  Returns:
    This function returns sampling rate.
...
/*******************************************************************************
  ...
  Returns:
    This function returns bit rate.

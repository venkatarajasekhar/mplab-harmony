...
//
//*****************************************************************************/
Fract32 frswwMult(Fract16 argAQ1d15, Fract32 argBQ1d31)
{
  Fract16   upper16;     /* upper 16 bit half of 32 bit number */
  Fract16   lower16;     /* lower 16 bit half of 32 bit number */
  Fract32   prodQ1d31;   /* Product of input arguments */

  /* Extract the upper 16 bits of the 32 bit argument */
  upper16     = FrwsExtractH(argBQ1d31);

...
//******************************************************************************
// APP_PeriodicTimer_Task - State machine 
//
// NOTE: Not used.
//
//******************************************************************************
...
void APP_Tasks(void )
{
    ...
    switch (appData.state)
    {
        ...
        case APP_STATE_CODEC_ADD_BUFFER:
        {
            ...
            {
                /* Queuing Done. Transmission has begun. ON the LEDs */
                APP_LED1_ON();
                APP_LED2_ON();
                APP_LED3_ON();
                APP_LED4_ON();
...
#if 0        
        //TODO: The button task should run here--not above. CAL

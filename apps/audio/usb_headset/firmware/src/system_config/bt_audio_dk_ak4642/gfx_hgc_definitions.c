...
bool GFX_HGC_DrawItem(int itemId)
{
    switch(itemId)
    {
		...
		case Frequency:
		{
			GFX_XCHAR Frequency_text[] = { 0x53, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x20, 0x46, 0x72, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x79, 0x20, 0x3a, 0x20, 0x31, 0x36, 0x20, 0x4b, 0x48, 0x7a, 0x0 };

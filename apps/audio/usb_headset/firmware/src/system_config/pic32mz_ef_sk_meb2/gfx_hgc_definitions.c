...
bool GFX_HGC_DrawItem(int itemId)
{
    switch(itemId)
    {
		...
		case Text1:
		{
			GFX_XCHAR Text1_text[] = { 0x50, 0x49, 0x43, 0x33, 0x32, 0x20, 0x4d, 0x5a, 0x20, 0x45, 0x46, 0x20, 0x77, 0x2f, 0x46, 0x50, 0x55, 0x20, 0x53, 0x4b, 0x20, 0x2b, 0x20, 0x4d, 0x45, 0x42, 0x32, 0x0 };
		...
		case Text2:
		{
			GFX_XCHAR Text2_text[] = { 0x55, 0x53, 0x42, 0x20, 0x3a, 0x20, 0x76, 0x31, 0x2e, 0x31, 0x0 };
		...
		case Version:
		{
			GFX_XCHAR Version_text[] = { 0x43, 0x6f, 0x64, 0x65, 0x63, 0x20, 0x3a, 0x20, 0x41, 0x4b, 0x34, 0x39, 0x35, 0x33, 0x0 };
		...
		case Frequency:
		{
			GFX_XCHAR Frequency_text[] = { 0x53, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x20, 0x46, 0x72, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x79, 0x20, 0x3a, 0x20, 0x31, 0x36, 0x2f, 0x33, 0x32, 0x2f, 0x34, 0x38, 0x20, 0x4b, 0x48, 0x7a, 0x0 };
		...
		case DemoName:
		{
			GFX_XCHAR DemoName_text[] = { 0x48, 0x61, 0x72, 0x6d, 0x6f, 0x6e, 0x79, 0x20, 0x55, 0x53, 0x42, 0x20, 0x48, 0x65, 0x61, 0x64, 0x73, 0x65, 0x74, 0x0 };
			
			GFX_ColorSet(GFX_INDEX_0, GFX_RGBConvert(0xFC, 0xFC, 0xFC)); // set color
			GFX_FontSet(GFX_INDEX_0, (GFX_RESOURCE_HDR*)&Arial20pt); // set font
			GFX_TextStringDraw(GFX_INDEX_0,
			                   35, // draw point x
						       42, // draw point y

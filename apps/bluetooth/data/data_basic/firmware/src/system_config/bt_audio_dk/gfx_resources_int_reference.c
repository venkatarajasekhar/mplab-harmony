 ...
 ***********************************/
#if defined (GFX_CONFIG_IMAGE_PACKED_ENABLE) && (__XC16_VERSION__ >= 1011)
extern uint8_gfx_image_prog __CONNECTED[] __attribute__((section("grc_images")));
#else
extern uint8_gfx_image_prog __CONNECTED[] __attribute__((section("grc_images"), aligned(2)));
#endif

const GFX_RESOURCE_HDR CONNECTED =
{
    .type = (GFX_RESOURCE_MEMORY_FLASH | GFX_RESOURCE_TYPE_MCHP_MBITMAP | GFX_RESOURCE_COMP_NONE),
    .ID = 0,
    .resource.image.location.progByteAddress = (uint8_gfx_image_prog *) __CONNECTED,
 ...
 ***********************************/
#if defined (GFX_CONFIG_IMAGE_PACKED_ENABLE) && (__XC16_VERSION__ >= 1011)
extern uint8_gfx_image_prog __NO_PAIR_NO_CONNECTION[] __attribute__((section("grc_images")));
#else
extern uint8_gfx_image_prog __NO_PAIR_NO_CONNECTION[] __attribute__((section("grc_images"), aligned(2)));
#endif

const GFX_RESOURCE_HDR NO_PAIR_NO_CONNECTION =
{
    .type = (GFX_RESOURCE_MEMORY_FLASH | GFX_RESOURCE_TYPE_MCHP_MBITMAP | GFX_RESOURCE_COMP_NONE),
    .ID = 0,
    .resource.image.location.progByteAddress = (uint8_gfx_image_prog *) __NO_PAIR_NO_CONNECTION,
    .resource.image.width = 30,
    .resource.image.height = 30,
    .resource.image.parameter1.compressedSize = 0,
    .resource.image.parameter2.rawSize = 1804,
 ...
 ***********************************/
#if defined (GFX_CONFIG_IMAGE_PACKED_ENABLE) && (__XC16_VERSION__ >= 1011)
extern uint8_gfx_image_prog __PAIRED[] __attribute__((section("grc_images")));
#else
extern uint8_gfx_image_prog __PAIRED[] __attribute__((section("grc_images"), aligned(2)));
#endif

const GFX_RESOURCE_HDR PAIRED =
{
    .type = (GFX_RESOURCE_MEMORY_FLASH | GFX_RESOURCE_TYPE_MCHP_MBITMAP | GFX_RESOURCE_COMP_NONE),
    .ID = 0,
    .resource.image.location.progByteAddress = (uint8_gfx_image_prog *) __PAIRED,
    .resource.image.width = 30,
    .resource.image.height = 30,
    .resource.image.parameter1.compressedSize = 0,
    .resource.image.parameter2.rawSize = 1804,
 ...
 * TTF Font File Structure
 * Label: Arial20pt
 * Description:  Height: 24 pixels, 1 bit per pixel, Range: ' ' to 'ÿ'
 ***********************************/
#if defined(GFX_CONFIG_FONT_PROG_SPACE_ENABLE) && (__XC16_VERSION__ >= 1011)
#ifndef GFX_CONFIG_FONT_PACKED_ENABLE

...
#ifndef _PORTS_P32MX470F512H_H
#define _PORTS_P32MX470F512H_H
...
#include "../templates/ports_RemapInput_grouped2.h"
...
{
     PORTS_RemapInput_grouped2(index, inputFunction, remapInputPin);
}

PLIB_INLINE_API bool PLIB_PORTS_ExistsRemapInput(PORTS_MODULE_ID index)
{
     return PORTS_ExistsRemapInput_grouped2(index);
}

...
#define SYS_PORT_C_ANSEL        0xFFEF
...
#define SYS_PORT_D_ANSEL        0x5008
#define SYS_PORT_D_TRIS         0x5FF8
...
#define SYS_PORT_E_ANSEL        0xFFF7
...
#define SYS_PORT_F_ANSEL        0xFFC7
...
#define BSP_TXRX_CTRLToggle() PLIB_PORTS_PinToggle(PORTS_ID_0, PORT_CHANNEL_D, PORTS_BIT_POS_15)
#define BSP_TXRX_CTRLOn() PLIB_PORTS_PinSet(PORTS_ID_0, PORT_CHANNEL_D, PORTS_BIT_POS_15)
#define BSP_TXRX_CTRLOff() PLIB_PORTS_PinClear(PORTS_ID_0, PORT_CHANNEL_D, PORTS_BIT_POS_15)
#define BSP_TXRX_CTRLStateGet() PLIB_PORTS_PinGetLatched(PORTS_ID_0, PORT_CHANNEL_D, PORTS_BIT_POS_15)
#define BSP_TXRX_CTRLStateSet(Value) PLIB_PORTS_PinWrite(PORTS_ID_0, PORT_CHANNEL_D, PORTS_BIT_POS_15, Value)

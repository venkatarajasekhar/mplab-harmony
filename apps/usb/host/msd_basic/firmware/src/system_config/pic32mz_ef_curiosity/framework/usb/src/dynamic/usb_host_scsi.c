...
uint8_t gUSBSCSIBuffer[USB_HOST_MSD_LUN_NUMBERS][256] __attribute__((coherent)) __attribute__((aligned(16)));
...
void _USB_HOST_SCSI_TimerCallback(uint32_t context, uint32_t currtick)
{

...
/* Media Page Buffer
  ...
  Remarks:
    None
*/
uint8_t __attribute__((coherent, aligned(16))) gSYSFSMediaBlockBuffer[SYS_FS_MEDIA_MANAGER_BUFFER_SIZE] = {0};
...
uint8_t gSYSFSMediaBuffer[SYS_FS_MEDIA_MAX_BLOCK_SIZE] __attribute__((coherent, aligned(16)));

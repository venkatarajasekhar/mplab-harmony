 ...
 ***********************************************/
uint8_t gUSBHostMSDCBW[USB_HOST_MSD_INSTANCES_NUMBER][32] __attribute__((coherent)) __attribute__((aligned(16)));
uint8_t gUSBHostMSDCSW[USB_HOST_MSD_INSTANCES_NUMBER][16] __attribute__((coherent)) __attribute__((aligned(16)));

...
*********************************************************************************************************
*/
#define  USB_ATTACH_TASK_SIZE                           1024u
#define  USB_CDC_TASK_SIZE                              1024
#define  USB_MSD_TASK_SIZE                              1024
#define  SYSTEM_TASKS_SIZE                              1024u
...
#define  APP_USB_MSD_TASK_PRIO                          5u
#define  APP_USB_CDC_TASK_PRIO                          3u
#define  APP_USB_HOST_OPEN_PRIO                         4u
#define  SYSTEM_TASKS_PRIO                              1u
/*******************************************************
...
typedef struct
{
    ...
    SemaphoreHandle_t xSemaphoreBlockUsbCDCAttach;
    SemaphoreHandle_t xSemaphoreCDCReadComplete;
...
typedef struct
{
 /* The application's current state */
    ...
    SemaphoreHandle_t xSemaphoreBlockUsbMSDAttach;
...
typedef struct
{
   ...
   APP_STATES  state;
     ...
     /* Task Handle to APP_CDCRead Task */
    TaskHandle_t taskHandleCDC;

    /* Task Handle to APP_CDCWrite Task */
    TaskHandle_t taskHandleMSD;

...
void __ISR(_TIMER_1_VECTOR, ipl2SOFT) IntHandlerDrvTmrInstance0(void)
{
   /* Call ThreadX context save.  */
   _tx_thread_context_save();
...
void __ISR(_DMA0_VECTOR, ipl2SOFT) _IntHandlerSysDmaCh0(void)
{          
   /* Call ThreadX context save.  */
   _tx_thread_context_save();
...
void __ISR(_DMA0_VECTOR + DMA_CHANNEL_1, ipl2SOFT) _IntHandlerLCCRefresh(void)
{
   /* Call ThreadX context save.  */
   _tx_thread_context_save();

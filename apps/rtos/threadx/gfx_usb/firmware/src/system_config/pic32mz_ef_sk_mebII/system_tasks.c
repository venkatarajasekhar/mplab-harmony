...
TX_THREAD  _APP1_Tasks_TCB;
TX_THREAD  _APP2_Tasks_TCB;
 

static void _SYS_Tasks( ULONG thread_input );

static void _APP_Tasks(ULONG thread_input);
static void _APP1_Tasks(ULONG thread_input);
static void _APP2_Tasks(ULONG thread_input);
...
#define SYS_BYTE_POOL_SIZE   13824
...
void tx_application_define(void* first_unused_memory)
{
    ...
    tx_thread_create(&_SYS_Tasks_TCB,"Sys Tasks",_SYS_Tasks,0,
        _sys_tx_thread_stk_ptr,4096,6, 6,
    ...
    tx_thread_create(&_APP_Tasks_TCB,"APP Tasks",_APP_Tasks,0,
        _sys_tx_thread_stk_ptr,1024,7, 7,
        TX_NO_TIME_SLICE,TX_AUTO_START);
    /* Allocate the stack for system and application threads */
    tx_byte_allocate(&_sys_byte_pool_0, (VOID **) &_sys_tx_thread_stk_ptr, 
        4096,TX_NO_WAIT);
    ...
    /* create the RTOS thread*/
    tx_thread_create(&_APP1_Tasks_TCB,"APP1 Tasks",_APP1_Tasks,0,
        _sys_tx_thread_stk_ptr,4096,5, 5,
        TX_NO_TIME_SLICE,TX_AUTO_START);
    /* Allocate the stack for system and application threads */
    tx_byte_allocate(&_sys_byte_pool_0, (VOID **) &_sys_tx_thread_stk_ptr, 
        4096,TX_NO_WAIT);
    ...
    /* create the RTOS thread*/
    tx_thread_create(&_APP2_Tasks_TCB,"APP2 Tasks",_APP2_Tasks,0,
        _sys_tx_thread_stk_ptr,4096,7, 7,
        TX_NO_TIME_SLICE,TX_AUTO_START);
}
// *****************************************************************************
// *****************************************************************************
...
/*******************************************************************************
  Function:
    void _APP1_Tasks ( ULONG thread_input )
...
/*******************************************************************************
  Function:
    void _APP2_Tasks ( ULONG thread_input )

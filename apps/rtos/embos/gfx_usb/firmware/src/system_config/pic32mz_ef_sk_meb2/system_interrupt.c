...
void __attribute__( (interrupt(ipl4AUTO), vector(_TIMER_2_VECTOR))) IntHandlerDrvTmrInstance0_ISR( void );
...
void __attribute__( (interrupt(ipl1AUTO), vector(_DMA0_VECTOR))) IntHandlerSysDmaInstance0_ISR( void );
...
void __attribute__( (interrupt(ipl3AUTO), vector(_DMA0_VECTOR + DMA_CHANNEL_1))) IntHandlerLCCRefresh_ISR( void );
...
void __attribute__( (interrupt(ipl3AUTO), vector(_USB_VECTOR))) IntHandlerUSBInstance0_ISR( void );

...
OS_TASK  _APP2_Tasks_TCB;
uint32_t _APP2_TasksStk[1024];
...
void SYS_Tasks ( void )
{
    ...
    /*use macro for creating tasks, user defines which task create func is used in RTOS.h*/
    OS_CREATETASK(&_APP1_Tasks_TCB, "APP1 Tasks",_APP1_Tasks,1, _APP1_TasksStk);
    /*use macro for creating tasks, user defines which task create func is used in RTOS.h*/
    OS_CREATETASK(&_APP2_Tasks_TCB, "APP2 Tasks",_APP2_Tasks,1, _APP2_TasksStk);
    /**************
     * Start RTOS * 
     **************/
    OS_Start();

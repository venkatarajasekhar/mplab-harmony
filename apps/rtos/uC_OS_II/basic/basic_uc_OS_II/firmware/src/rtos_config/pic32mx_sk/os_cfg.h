...
#define OS_TASK_IDLE_STK_SIZE           128u   	/* specifies the size of the ?C/OS-II idle-task stack */
#define OS_TASK_STAT_STK_SIZE		512u   	/* specifies the size of the ?C/OS-II statistic-task stack */

...
Most fonts used are included with the distribution, except for FireFlySung. 
These font files are big, and you need to download them from websites below in order to regenerate Graphics Resource Converter resources.

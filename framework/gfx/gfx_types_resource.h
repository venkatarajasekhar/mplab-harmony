...
typedef enum
{
    ...
    GFX_RESOURCE_TYPE_BMP     
            /*DOM-IGNORE-BEGIN*/  = 0x0500 /*DOM-IGNORE-END*/,  
    GFX_RESOURCE_TYPE_GIF     
            /*DOM-IGNORE-BEGIN*/  = 0x0600 /*DOM-IGNORE-END*/,  
    ...
    GFX_RESOURCE_BMP_FLASH_NONE         = (GFX_RESOURCE_TYPE_BMP | GFX_RESOURCE_MEMORY_FLASH | GFX_RESOURCE_COMP_NONE),
    // BMP image type, located in external memory no compression.
    GFX_RESOURCE_BMP_EXTERNAL_NONE      = (GFX_RESOURCE_TYPE_BMP | GFX_RESOURCE_MEMORY_EXTERNAL | GFX_RESOURCE_COMP_NONE),
    ...
    GFX_RESOURCE_BMP_EDS_EPMP_NONE      = (GFX_RESOURCE_TYPE_BMP | GFX_RESOURCE_MEMORY_EDS_EPMP | GFX_RESOURCE_COMP_NONE),

    // GIF image type, located in flash and no compression.
    GFX_RESOURCE_GIF_FLASH_NONE         = (GFX_RESOURCE_TYPE_GIF | GFX_RESOURCE_MEMORY_FLASH | GFX_RESOURCE_COMP_NONE),
    // GIF image type, located in external memory no compression.
    GFX_RESOURCE_GIF_EXTERNAL_NONE      = (GFX_RESOURCE_TYPE_GIF | GFX_RESOURCE_MEMORY_EXTERNAL | GFX_RESOURCE_COMP_NONE),
    ...
    GFX_RESOURCE_GIF_EDS_EPMP_NONE      = (GFX_RESOURCE_TYPE_GIF | GFX_RESOURCE_MEMORY_EDS_EPMP | GFX_RESOURCE_COMP_NONE),

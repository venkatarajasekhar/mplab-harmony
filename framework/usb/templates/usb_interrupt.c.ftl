...
void __ISR(${CONFIG_DRV_USB_ISR_VECTOR_IDX0}, ipl${CONFIG_DRV_USB_INT_PRIO_NUM_IDX0}SOFT) _IntHandlerUSBInstance0(void)
				<#else>
...
<#if CONFIG_3RDPARTY_RTOS_USED == "embOS">
    OS_LeaveNestableInterrupt();
		...
		<#if CONFIG_PIC32MZ == true>
			<#if CONFIG_USE_3RDPARTY_RTOS>
				<#if CONFIG_3RDPARTY_RTOS_USED == "ThreadX">
void __ISR ( ${CONFIG_DRV_USBDMA_ISR_VECTOR_IDX0},ipl${CONFIG_DRV_USBDMA_INT_PRIO_NUM_IDX0}SOFT) _IntHandlerUSBInstance0_USBDMA ( void )
				<#else>
    <#if CONFIG_3RDPARTY_RTOS_USED == "embOS">
...
void __ISR( _USB_VECTOR , IPL4SOFT)_IntHandler_USB_stub ( void )
</#if>
<#else>
<#if CONFIG_3RDPARTY_RTOS_USED == "embOS">
<#if CONFIG_PIC32MX == true>
...
<#if ((CONFIG_PIC32MX == true) || (CONFIG_PIC32WK == true)) >
    DRV_USBFS_Tasks_ISR(sysObj.drvUSBObject);
</#if>	
<#if CONFIG_USE_3RDPARTY_RTOS>
<#if CONFIG_3RDPARTY_RTOS_USED == "ThreadX">
...
void __ISR( ${CONFIG_DRV_USB_BETA_SW_HOST_ISR_VECTOR_IDX0} , ipl${CONFIG_DRV_USB_BETA_SW_HOST_INT_PRIO_NUM_IDX0}AUTO) _IntHandler_USB_stub ( void )
{

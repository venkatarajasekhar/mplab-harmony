...
#define USB_HOST_INSTANCES_NUMBER  ${CONFIG_USB_BETA_SW_HOST_INSTANCES_NUMBER}

/* Provides Host pipes number */
#define DRV_USB_HOST_PIPES_NUMBER    ${CONFIG_DRV_USB_BETA_SW_HOST_PIPES_NUMBER}


/* NAK Limit for Control transfer data stage and Status Stage */
#define DRV_USB_HOST_NAK_LIMIT		${CONFIG_DRV_USB_BETA_SW_HOST_NAK_LIMIT}
...
/* Target peripheral list entries */
#define  USB_HOST_TPL_ENTRIES                ${CONFIG_USB_BETA_SW_HOST_TPL_ENTRIES} 

/* Total number of drivers in this application */
#define USB_HOST_MAX_DRIVER_SUPPORTED        ${CONFIG_USB_BETA_SW_HOST_MAX_DRIVER_SUPPORTED}    

/* Total number of devices to be supported */
#define USB_HOST_MAX_DEVICES_NUMBER         ${CONFIG_USB_BETA_SW_HOST_MAX_DEVICES_NUMBER}

/* Maximum number of configurations supported per device */
#define USB_HOST_MAX_CONFIGURATION          ${CONFIG_USB_BETA_SW_HOST_MAX_CONFIGURATION}      

/* Maximum number of interfaces supported per device */
#define USB_HOST_MAX_INTERFACES             ${CONFIG_USB_BETA_SW_HOST_MAX_INTERFACES}

/* Number of Host Layer Clients */
#define USB_HOST_CLIENTS_NUMBER             ${CONFIG_USB_BETA_SW_HOST_CLIENTS_NUMBER}   

<#if CONFIG_USB_BETA_SW_HOST_USE_MSD == true>
/* Number of MSD Function driver instances in the application */
#define USB_HOST_MSD_INSTANCES_NUMBER         ${CONFIG_USB_BETA_SW_HOST_MSD_NUMBER_OF_INSTANCES}
/* Number of Logical Units */
#define USB_HOST_SCSI_INSTANCES_NUMBER          ${CONFIG_USB_BETA_SW_HOST_MSD_NUMBER_OF_INSTANCES}
...
/* Number of MSD Function driver instances in the application */
#define USB_HOST_CDC_INSTANCES_NUMBER         ${CONFIG_USB_BETA_SW_HOST_CDC_NUMBER_OF_INSTANCES}
</#if>

<#if CONFIG_USB_BETA_SW_HOST_USE_HID == true>
/* Number of HID Client driver instances in the application */
#define USB_HOST_HID_INSTANCES_NUMBER         ${CONFIG_USB_BETA_SW_HOST_HID_NUMBER_OF_INSTANCES}

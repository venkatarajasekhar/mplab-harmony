...
static SCSI_SENSE_DATA gUSBDeviceMSDSenseData[USB_DEVICE_MSD_LUNS_NUMBER] __attribute__((coherent, aligned(16)));
...
void _USB_DEVICE_MSD_Deinitialization ( SYS_MODULE_INDEX iMSD )
{
    ...
    mediaFunctions = &msdInstance->mediaData[0].mediaFunctions;

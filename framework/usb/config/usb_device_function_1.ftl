       ...
       config USB_DEVICE_FUNCTION_1_MSD_NUM_LUN_IDX${INSTANCE}
       bool
       depends on USB_DEVICE_FUNCTION_1_DEVICE_CLASS_MSD_IDX${INSTANCE}
       default n if USB_DEVICE_FUNCTION_1_DEVICE_CLASS_MSD_IDX${INSTANCE} = 0
       default y

       config USB_DEVICE_FUNCTION_1_LUN_IDX${INSTANCE}
       depends on DRV_USB_DEVICE_SUPPORT && USB_DEVICE_FUNCTION_1_MSD_NUM_LUN_IDX${INSTANCE}
       bool "LUN 0"
       default y
       ---help---
       IDH_HTML_USB_DEVICE_MSD_INIT
       ...
       ifblock USB_DEVICE_FUNCTION_1_LUN_IDX${INSTANCE}

       config  USB_DEVICE_FUNCTION_1_MSD_LUN_MEDIA${INSTANCE}
       string "Media Type"
       depends on DRV_USB_DEVICE_SUPPORT && USB_DEVICE_FUNCTION_1_MSD_NUM_LUN_IDX${INSTANCE}
       ...
       config USB_DEVICE_FUNCTION_1_MSD_LUN_MEDIA_NVM${INSTANCE}
       bool
       depends on DRV_USB_DEVICE_SUPPORT && USB_DEVICE_FUNCTION_1_MSD_NUM_LUN_IDX${INSTANCE}
       select DRV_NVM_NEEDED
       set USB_DEVICE_PRODUCT_ID_SELECT_IDX${INSTANCE} to "msd_basic_demo" if USB_DEVICE_FUNCTION_1_MSD_LUN_MEDIA_NVM${INSTANCE}
       default y if USB_DEVICE_FUNCTION_1_MSD_LUN_MEDIA${INSTANCE} = "NVM"
       default n
       ---help---
       IDH_HTML_USB_DEVICE_MSD_INIT
       ---endhelp---

       config USB_DEVICE_FUNCTION_1_MSD_LUN_MEDIA_SPIFLASH${INSTANCE}
       bool
       depends on DRV_USB_DEVICE_SUPPORT && USB_DEVICE_FUNCTION_1_MSD_NUM_LUN_IDX${INSTANCE}
       select USE_DRV_SST25_NEEDED
       set USB_DEVICE_PRODUCT_ID_SELECT_IDX${INSTANCE} to "msd_spiflash_demo" if USB_DEVICE_FUNCTION_1_MSD_LUN_MEDIA_SPIFLASH${INSTANCE}
       default y if USB_DEVICE_FUNCTION_1_MSD_LUN_MEDIA${INSTANCE} = "SPI_FLASH"
       default n
       ---help---
       IDH_HTML_USB_DEVICE_MSD_INIT
       ---endhelp---

       config USB_DEVICE_FUNCTION_1_MSD_LUN_MEDIA_SDCARD${INSTANCE}
       bool
       depends on DRV_USB_DEVICE_SUPPORT && USB_DEVICE_FUNCTION_1_MSD_NUM_LUN_IDX${INSTANCE}
       select DRV_SDCARD_NEEDED
       set USB_DEVICE_PRODUCT_ID_SELECT_IDX${INSTANCE} to "msd_basic_sdcard_demo" if USB_DEVICE_FUNCTION_1_MSD_LUN_MEDIA_SDCARD${INSTANCE}
       default y if USB_DEVICE_FUNCTION_1_MSD_LUN_MEDIA${INSTANCE} = "SDCARD"
       default n
       ---help---
       IDH_HTML_USB_DEVICE_MSD_INIT
       ---endhelp---

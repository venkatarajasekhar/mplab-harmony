	   ...
	   depends on USE_USB_STACK
       depends on DRV_USB_DEVICE_SUPPORT
       depends on USB_DEVICE_FUNCTION_2_DEVICE_CLASS_IDX${INSTANCE} = "VENDOR" || USB_DEVICE_FUNCTION_2_DEVICE_CLASS_IDX${INSTANCE} = "AUDIO" || USB_DEVICE_FUNCTION_2_DEVICE_CLASS_IDX${INSTANCE} = "AUDIO_2_0"
       ...
       string
	   depends on USE_USB_STACK
       depends on DRV_USB_DEVICE_SUPPORT && (PIC32MX || PIC32WK)
       ...
       config USB_DEVICE_FUNCTION_2_CDC_INT_ENDPOINT_NUMBER_IDX${INSTANCE}
       int "Interrupt Endpoint Number"
       range 1 15 if (PIC32MX || PIC32WK)
       range 1 7  if PIC32MZ
       depends on USE_USB_STACK
       depends on USB_DEVICE_FUNCTION_2_DEVICE_CLASS_CDC_IDX${INSTANCE}
       default 3 if USB_DEVICE_FUNCTION_1_DEVICE_CLASS_IDX${INSTANCE} = "CDC"
	   default 2 if USB_DEVICE_FUNCTION_1_DEVICE_CLASS_IDX${INSTANCE} = "MSD"
	   default 2 if USB_DEVICE_FUNCTION_1_DEVICE_CLASS_IDX${INSTANCE} = "HID"
	   default 2 if USB_DEVICE_FUNCTION_1_DEVICE_CLASS_IDX${INSTANCE} = "VENDOR"
	   default 2 if USB_DEVICE_FUNCTION_1_DEVICE_CLASS_IDX${INSTANCE} = "AUDIO"
	   default 2 if USB_DEVICE_FUNCTION_1_DEVICE_CLASS_IDX${INSTANCE} = "AUDIO_2_0"
	   ---help---
	   IDH_HTML_USB_DEVICE_CDC_INIT
	   ---endhelp---
       
       config USB_DEVICE_FUNCTION_2_CDC_BULK_ENDPOINT_NUMBER_IDX${INSTANCE}
       int "Bulk Endpoint Number"
       range 1 15 if (PIC32MX || PIC32WK)
       range 1 7  if PIC32MZ
       depends on USE_USB_STACK
       depends on USB_DEVICE_FUNCTION_2_DEVICE_CLASS_CDC_IDX${INSTANCE}
       default 4 if USB_DEVICE_FUNCTION_1_DEVICE_CLASS_IDX${INSTANCE} = "CDC"
	   default 3 if USB_DEVICE_FUNCTION_1_DEVICE_CLASS_IDX${INSTANCE} = "MSD"
	   default 3 if USB_DEVICE_FUNCTION_1_DEVICE_CLASS_IDX${INSTANCE} = "HID"
	   default 3 if USB_DEVICE_FUNCTION_1_DEVICE_CLASS_IDX${INSTANCE} = "VENDOR"
	   default 2 if USB_DEVICE_FUNCTION_1_DEVICE_CLASS_IDX${INSTANCE} = "AUDIO"
	   default 2 if USB_DEVICE_FUNCTION_1_DEVICE_CLASS_IDX${INSTANCE} = "AUDIO_2_0"
	   ---help---
	   IDH_HTML_USB_DEVICE_CDC_INIT
       ...
       config USB_DEVICE_FUNCTION_2_HID_DEVICE_TYPE_IDX${INSTANCE}
       string
       ...
       config USB_DEVICE_FUNCTION_2_HID_ENDPOINT_NUMBER_IDX${INSTANCE}
       int "Endpoint Number"
       range 1 15 if (PIC32MX || PIC32WK)
       range 1 7  if PIC32MZ
       depends on USE_USB_STACK
       ...
       config USB_DEVICE_FUNCTION_2_MSD_ENDPOINT_NUMBER_IDX${INSTANCE}
       int "Endpoint Number"
       range 1 15 if (PIC32MX || PIC32WK)
       range 1 7  if PIC32MZ
       depends on USE_USB_STACK
       ...
       config USB_DEVICE_FUNCTION_2_MSD_NUM_LUN_IDX${INSTANCE}
       bool
       depends on USB_DEVICE_FUNCTION_2_DEVICE_CLASS_MSD_IDX${INSTANCE}
       default n if USB_DEVICE_FUNCTION_2_DEVICE_CLASS_MSD_IDX${INSTANCE} = 0
       default y

       config USB_DEVICE_FUNCTION_2_LUN_IDX${INSTANCE}
       depends on DRV_USB_DEVICE_SUPPORT && USB_DEVICE_FUNCTION_2_MSD_NUM_LUN_IDX${INSTANCE}
       bool "LUN 0"
       default y
       ---help---
       IDH_HTML_USB_DEVICE_MSD_INIT
       ...
       ifblock USB_DEVICE_FUNCTION_2_LUN_IDX${INSTANCE}

       config  USB_DEVICE_FUNCTION_2_MSD_LUN_MEDIA${INSTANCE}
       string "Media Type"
       depends on DRV_USB_DEVICE_SUPPORT && USB_DEVICE_FUNCTION_2_MSD_NUM_LUN_IDX${INSTANCE}
       ...
       config USB_DEVICE_FUNCTION_2_MSD_LUN_MEDIA_NVM${INSTANCE}
       bool
       depends on DRV_USB_DEVICE_SUPPORT && USB_DEVICE_FUNCTION_2_MSD_NUM_LUN_IDX${INSTANCE}
       select DRV_NVM_NEEDED
       set USB_DEVICE_PRODUCT_ID_SELECT_IDX${INSTANCE} to "msd_basic_demo" if USB_DEVICE_FUNCTION_2_MSD_LUN_MEDIA_NVM${INSTANCE}
       default y if USB_DEVICE_FUNCTION_2_MSD_LUN_MEDIA${INSTANCE} = "NVM"
       default n
       ---help---
       IDH_HTML_USB_DEVICE_MSD_INIT
       ---endhelp---

       config USB_DEVICE_FUNCTION_2_MSD_LUN_MEDIA_SPIFLASH${INSTANCE}
       bool
       depends on DRV_USB_DEVICE_SUPPORT && USB_DEVICE_FUNCTION_2_MSD_NUM_LUN_IDX${INSTANCE}
       select USE_DRV_SST25_NEEDED
       set USB_DEVICE_PRODUCT_ID_SELECT_IDX${INSTANCE} to "msd_spiflash_demo" if USB_DEVICE_FUNCTION_2_MSD_LUN_MEDIA_SPIFLASH${INSTANCE}
       default y if USB_DEVICE_FUNCTION_2_MSD_LUN_MEDIA${INSTANCE} = "SPI_FLASH"
       default n
       ---help---
       IDH_HTML_USB_DEVICE_MSD_INIT
       ---endhelp---
       config USB_DEVICE_FUNCTION_2_MSD_LUN_MEDIA_SDCARD${INSTANCE}
       bool
       depends on DRV_USB_DEVICE_SUPPORT && USB_DEVICE_FUNCTION_2_MSD_NUM_LUN_IDX${INSTANCE}
       select DRV_SDCARD_NEEDED
       set USB_DEVICE_PRODUCT_ID_SELECT_IDX${INSTANCE} to "msd_basic_sdcard_demo" if USB_DEVICE_FUNCTION_2_MSD_LUN_MEDIA_SDCARD${INSTANCE}
       default y if USB_DEVICE_FUNCTION_2_MSD_LUN_MEDIA${INSTANCE} = "SDCARD"
       default n
       ---help---
       IDH_HTML_USB_DEVICE_MSD_INIT
       ---endhelp---
       ...
       IDH_HTML_USB_DEVICE_AUDIO_MAX_ALTERNATE_SETTING
        ...
        config USB_DEVICE_FUNCTION_2_VENDOR_ENDPOINT_NUMBER_IDX${INSTANCE}
        int "Endpoint Number"
        range 1 15 if (PIC32MX || PIC32WK)
        range 1 7  if PIC32MZ
        depends on USE_USB_STACK
        depends on USB_DEVICE_FUNCTION_2_DEVICE_CLASS_VENDOR_IDX${INSTANCE}
        default 3 if USB_DEVICE_FUNCTION_1_DEVICE_CLASS_IDX${INSTANCE} = "CDC"
		default 2 if USB_DEVICE_FUNCTION_1_DEVICE_CLASS_IDX${INSTANCE} = "MSD"
		default 2 if USB_DEVICE_FUNCTION_1_DEVICE_CLASS_IDX${INSTANCE} = "HID"
		default 2 if USB_DEVICE_FUNCTION_1_DEVICE_CLASS_IDX${INSTANCE} = "VENDOR"

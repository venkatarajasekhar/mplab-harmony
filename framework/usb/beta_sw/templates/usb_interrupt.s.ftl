...
<@RTOS_ISR VECTOR = CONFIG_INT_VECT_USB_1 NAME = USB_HANDLER/>
<#else>
<@RTOS_ISR VECTOR = CONFIG_INT_VECT_USB NAME = USB_HANDLER/>
<@RTOS_ISR VECTOR = CONFIG_INT_VECT_USB_DMA NAME = USB_HANDLER_DMA/>
</#if>
</#macro>

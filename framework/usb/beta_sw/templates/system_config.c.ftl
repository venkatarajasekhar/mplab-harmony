 ...
 ***********************************************/
uint8_t sectorBuffer[512] __attribute__((coherent)) __attribute__((aligned(16)));
 ...
 * Sector buffer needed by for the MSD LUN.
 ***********************************************/
uint8_t sectorBuffer${usbDeviceMSDIndex}[512] __attribute__((coherent)) __attribute__((aligned(16)));

...
ifblock USB_DEVICE_INST_IDX${INSTANCE}
 ...
 config USB_DEVICE_SPEED_HS_IDX${INSTANCE}
	...
	config USB_DEVICE_SPEED_FS_IDX${INSTANCE}
        string "Device Speed"
        depends on USE_USB_STACK && DRV_USB_DEVICE_SUPPORT && (PIC32MX || PIC32WK)
...
config USB_DEVICE_ENDPOINT_QUEUE_SIZE_WRITE_IDX${INSTANCE}
	...
	default "_USB_VECTOR"  if DRV_USB_INTERRUPT_VECTOR_IDX${INSTANCE} = "INT_VECTOR_USB1" && (PIC32MZ || PIC32WK)  

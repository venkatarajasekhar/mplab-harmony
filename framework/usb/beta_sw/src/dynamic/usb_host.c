...
)
{
	...
	#pragma message "Support for this version of the MPLAB Harmony USB Host Stack has been deprecated. Please migrate to the latest version of the MPLAB Harmony USB Host Stack" 

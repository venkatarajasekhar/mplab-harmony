...
#ifndef __RFCOMM_H  // Guards against multiple inclusion
#define __RFCOMM_H
...
#include "bluetooth/cdbt/rfcomm/rfcomm_cmd_queue.h"
...
/**
 * Summary: Initialize the RFCOMM layer.
 * \ingroup rfcomm
 *
 * Description:  This function initializes the RFCOMM layer of the stack. It must be called prior to any other
 ...
 * \ingroup rfcomm
 *
 * Description:  This function enables incoming connections on the specified RFCOMM session. Changes in
 * the session state are reported through a callback function.
 *
 * Parameters:  server_channel - A server channel on which the RFCOMM session will listen and accept incoming connections.
 ...
 * \ingroup rfcomm
 *
 * Description:  This function establishes an RFCOMM connection with a remote device and opens a data DLC.
 ...
 *
 * Parameters:  remote_addr - Address of the remote device.
 *   server_channel - A server channel of the remote RFCOMM server.
 *   callback - The callback function for reporting changes in DLC state opened by this call.
 *   param - An arbitrary data pointer that will be passed to the callback function specified by
 *              the \c callback parameter.
 *
 * Returns:
 ...
 * \ingroup rfcomm
 *
 * Description:  This function opens the specified DLC. Before calling this function the RFCOMM session
 ...
 *
 * Parameters:  dlc - The DLC to open.
 *   callback - The callback function for reporting changes in DLC state.
 *   param - An arbitrary data pointer that will be passed to the callback function specified by
 *              the \c callback parameter.
 *
 * Returns:
 ...
 * \ingroup rfcomm
 *
 * Description:  This function closes a DLC. If DLCI = 0, the parent RFCOMM session is also closed.
 *
 */
...
/**
 * Summary:  Allocate RFCOMM session.
 * \ingroup rfcomm
 *
 * Description:  This function allocates a new RFCOMM session.
 *
 * Parameters:  l2cap_mgr - The L2CAP manager on which the RFCOMM session is to be created.
 * 	  callback - The callback function that is called when session state changes.
 *     param - An arbitrary data pointer that will be passed to the callback function specified by
 *              the \c callback parameter.
 *
 * Returns:
 *           A pointer to the new RFCOMM session structure if the function succeeds.
 *           NULL otherwise.
 *
 */
...
/**
 * Summary:  Release RFCOMM session.
 * \ingroup rfcomm
 *
 * Description:  This function deallocates the specified RFCOMM session.
 ...
 *
 * Parameters:  session - The RFCOMM session to be deallocated.
 *
 */
...
/**
 * Summary:  Allocate DLC.
 * \ingroup rfcomm
 *
 * Description:  This function allocates a new DLC on the specified RFCOMM session.
 *
 * Parameters:  session - The RFCOMM session.
 * 			  dlci - DLCI of the new DLC.
 *
 * Returns:
 *           A pointer to the new DLC if the function succeeds.
 *           NULL otherwise.
 */
 ...
 * \ingroup rfcomm
 *
 * Description:  This function releases the specified DLC.
 *
 * Parameters:  dlc - The DLC to be released.
 *
 */
...
/**
 * Summary:  Send data over a DLC.
 * \ingroup rfcomm
 *
 * Description:  This function sends data over the specified DLC. Operation completion is reported
 ...
 * 		len -	Data length.
 * 		callback -	The callback function that is called when operation completes.
 *
 * Returns:
 *          TRUE if the function succeeds.
 *          FALSE otherwise. The callback function is not called in this case.
...
#include "bluetooth/cdbt/rfcomm/rfcomm_mgr.h"
#include "bluetooth/cdbt/rfcomm/rfcomm_mx.h"
#include "bluetooth/cdbt/rfcomm/rfcomm_private.h"

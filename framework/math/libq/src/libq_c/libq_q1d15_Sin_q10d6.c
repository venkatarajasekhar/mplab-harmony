...
q15 libq_q1d15_Sin_q10d6(q15 angleQ10d6)
{
  ...
  scaledAngleQ1d15 = libq_q15_ExtractH_q31(libq_q31_ShiftLeft_q31_i16(libq_q31_Mult2_q15(angleQ10d6,
  ...
  for (i = 1; i < sizeof(sinCoefQ1d15)/sizeof(sinCoefQ1d15[0]); i++)
  {
    ...
    sinQ1d15 = libq_q15_Add_q15_q15(sinCoefQ1d15[i],libq_q15_MultipyR2_q15(sinQ1d15,
                        scaledAngleQ1d15));
  }
  /* Perform the final multiplication; saves one iteration */
  sinQ1d15 = libq_q15_MultipyR2_q15(sinQ1d15,scaledAngleQ1d15);
...
//
//******************************************************************************
q31 libq_q20_d12_Sin_q20_d12(q31 x)
{

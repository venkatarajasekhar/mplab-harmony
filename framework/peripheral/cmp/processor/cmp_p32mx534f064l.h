...
#ifndef _CMP_P32MX534F064L_H
#define _CMP_P32MX534F064L_H
...
#include "../templates/cmp_CVREFRefVoltageRangeSelect_Default.h"
#include "../templates/cmp_CVREFBGRefVoltageRangeSelect_Default.h"
...
{
     return CMP_ExistsCVREFRefVoltageRangeSelect_Default(index);
}

PLIB_INLINE_API void PLIB_CMP_CVREF_ReferenceVoltageSelect(CMP_MODULE_ID index, CMP_CVREF_REFERENCE_SELECT reference)
{
     CMP_CVREF_ReferenceVoltageSelect_Default(index, reference);
}

PLIB_INLINE_API bool PLIB_CMP_ExistsCVREFBGRefVoltageRangeSelect(CMP_MODULE_ID index)
{
     return CMP_ExistsCVREFBGRefVoltageRangeSelect_Default(index);
}

PLIB_INLINE_API void PLIB_CMP_CVREF_BandGapReferenceSourceSelect(CMP_MODULE_ID index, CMP_CVREF_BANDGAP_SELECT select)
{
     CMP_CVREF_BandGapReferenceSourceSelect_Default(index, select);
}

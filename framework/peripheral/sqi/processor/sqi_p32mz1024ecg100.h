...
#ifndef _SQI_P32MZ1024ECG100_H
#define _SQI_P32MZ1024ECG100_H
...
#include "../templates/sqi_XIPSDRCommandDDRData_Unsupported.h"
#include "../templates/sqi_XIPDDRMode_Unsupported.h"
...
#include "../templates/sqi_ConBufferReset_Unsupported.h"
#include "../templates/sqi_RxBufferReset_Unsupported.h"
#include "../templates/sqi_TxBufferReset_Unsupported.h"
...
#include "../templates/sqi_StatusCheck_Unsupported.h"
#include "../templates/sqi_DDRMode_Unsupported.h"
...
#include "../templates/sqi_ConBufAvailable_Unsupported.h"
#include "../templates/sqi_CommandStatus_Unsupported.h"
...
PLIB_INLINE_API void PLIB_SQI_ReceiveLatchEnable(SQI_MODULE_ID index)
{
     SQI_ReceiveLatchEnable_Default(index);
}

PLIB_INLINE_API void PLIB_SQI_ReceiveLatchDisable(SQI_MODULE_ID index)
{
     SQI_ReceiveLatchDisable_Default(index);
}

PLIB_INLINE_API bool PLIB_SQI_ReceiveLatchGet(SQI_MODULE_ID index)
{
...
{
     SQI_TapDelaySet_Unsupported(index, sdrClkInDly, dataOutDly, clkOutDly);
}

PLIB_INLINE_API bool PLIB_SQI_ExistsTapDelay(SQI_MODULE_ID index)
{
     return SQI_ExistsTapDelay_Unsupported(index);
}
...
{
     SQI_XIPControlWord3Set_Unsupported(index, initStatCheck, initCmdCount, initCmdType, initCmd3, initCmd2, initCmd1);
}

PLIB_INLINE_API uint32_t _PLIB_UNSUPPORTED PLIB_SQI_XIPControlWord3Get(SQI_MODULE_ID index)
{
     return SQI_XIPControlWord3Get_Unsupported(index);
}

PLIB_INLINE_API bool PLIB_SQI_ExistsXIPControlWord3(SQI_MODULE_ID index)
{
     return SQI_ExistsXIPControlWord3_Unsupported(index);
}
...
{
     SQI_XIPControlWord4Set_Unsupported(index, initStatCheck, initCmdCount, initCmdType, initCmd3, initCmd2, initCmd1);
}

PLIB_INLINE_API uint32_t _PLIB_UNSUPPORTED PLIB_SQI_XIPControlWord4Get(SQI_MODULE_ID index)
{
     return SQI_XIPControlWord4Get_Unsupported(index);
}

PLIB_INLINE_API bool PLIB_SQI_ExistsXIPControlWord4(SQI_MODULE_ID index)
{
     return SQI_ExistsXIPControlWord4_Unsupported(index);
}

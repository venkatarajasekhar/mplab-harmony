...
#ifndef _OSC_P32MX275F256D_H
#define _OSC_P32MX275F256D_H
...
typedef enum {
    ...
    OSC_REF_BASECLOCK_SYSCLK = 0x08,
    OSC_REF_BASECLOCK_PBCLK = 0x07,
    OSC_REF_BASECLOCK_PRIMARY = 0x06,
    OSC_REF_BASECLOCK_FRC = 0x05,
    OSC_REF_BASECLOCK_LPRC = 0x04,
    OSC_REF_BASECLOCK_SOSC = 0x03,
    OSC_REF_BASECLOCK_USBCLK = 0x02,
    OSC_REF_BASECLOCK_SYSPLLOUT = 0x01,
    OSC_REF_BASECLOCK_EXT = 0x00
...
typedef enum {
    ...
    OSC_SYSPLL_OUT_DIV_16 = 0x07,
    OSC_SYSPLL_OUT_DIV_12 = 0x06,
    OSC_SYSPLL_OUT_DIV_8 = 0x05,
    OSC_SYSPLL_OUT_DIV_6 = 0x04,
...
typedef enum {
    ...
    OSC_UPLL_OUT_DIV_16 = 0x07,
    OSC_UPLL_OUT_DIV_12 = 0x06,
    OSC_UPLL_OUT_DIV_8 = 0x05,
    OSC_UPLL_OUT_DIV_6 = 0x04,
...
typedef enum {
    ...
    OSC_SYSPLL_IN_DIV_12 = 0x07,
    OSC_SYSPLL_IN_DIV_10 = 0x06,
...
typedef enum {
    ...
    OSC_UPLL_IN_DIV_12 = 0x07,
    OSC_UPLL_IN_DIV_10 = 0x06,
...
#include "../templates/osc_PBClockDivisor_PIC32MX_XLP.h"
#include "../templates/osc_PBClockReady_PIC32MX_XLP.h"
...
#include "../templates/osc_PLLMultiplier_PIC32MX_XLP.h"
#include "../templates/osc_UPLLMultiplier_PIC32MX_XLP.h"
#include "../templates/osc_BTPLLMultiplier_Unsupported.h"
#include "../templates/osc_PLLOutputDivisor_PIC32MX_XLP.h"
#include "../templates/osc_UPLLOutputDivisor_PIC32MX_XLP.h"
...
#include "../templates/osc_ReferenceOscBaseClock_PIC32MX_XLP.h"
#include "../templates/osc_ReferenceOscChange_PIC32MX_XLP.h"
#include "../templates/osc_ReferenceOscChangeActive_PIC32MX_XLP.h"
#include "../templates/osc_ReferenceOscStopInSleep_PIC32MX_XLP.h"
#include "../templates/osc_ReferenceOutputEnable_PIC32MX_XLP.h"
#include "../templates/osc_ReferenceOscStopInIdleEnable_PIC32MX_XLP.h"
#include "../templates/osc_ReferenceOscEnable_PIC32MX_XLP.h"
#include "../templates/osc_ReferenceOscDivisor_PIC32MX_XLP.h"
#include "../templates/osc_ReferenceOscTrim_PIC32MX_XLP.h"
#include "../templates/osc_PBClockOutputEnable_PIC32MX_XLP.h"
#include "../templates/osc_PLLInputDivisor_Default.h"
#include "../templates/osc_UPLLInputDivisor_PIC32MX_XLP.h"
...
{
     return OSC_ExistsPBClockDivisor_PIC32MX_XLP(index);
}
...
{
     return OSC_PBClockDivisorGet_PIC32MX_XLP(index, peripheralBusNumber);
}
...
{
     OSC_PBClockDivisorSet_PIC32MX_XLP(index, peripheralBusNumber, peripheralBusClkDiv);
}

PLIB_INLINE_API bool PLIB_OSC_ExistsPBClockReady(OSC_MODULE_ID index)
{
     return OSC_ExistsPBClockReady_PIC32MX_XLP(index);
}

PLIB_INLINE_API bool PLIB_OSC_PBClockDivisorIsReady(OSC_MODULE_ID index, OSC_PERIPHERAL_BUS peripheralBusNumber)
{
     return OSC_PBClockDivisorIsReady_PIC32MX_XLP(index, peripheralBusNumber);
}
...
{
     return OSC_ExistsReferenceOscBaseClock_PIC32MX_XLP(index);
}
...
{
     OSC_ReferenceOscDivisorValueSet_PIC32MX_XLP(index, referenceOsc, refOscDivValue);
}

PLIB_INLINE_API bool PLIB_OSC_ExistsReferenceOscTrim(OSC_MODULE_ID index)
{
     return OSC_ExistsReferenceOscTrim_PIC32MX_XLP(index);
}

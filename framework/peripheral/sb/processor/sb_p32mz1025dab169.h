...
#ifndef _SB_P32MZ1025DAB169_H
#define _SB_P32MZ1025DAB169_H
...
typedef enum {
    ...
    PLIB_SB_INIT_ID_DMA1_RD_LRS = 0x02,
    PLIB_SB_INIT_ID_DMA1_WR_LRS = 0x03,
    PLIB_SB_INIT_ID_USB1 = 0x04,
    PLIB_SB_INIT_ID_ETH1_RD = 0x05,
    PLIB_SB_INIT_ID_ETH1_WR = 0x06,
    PLIB_SB_INIT_ID_CAN1 = 0x07,
    PLIB_SB_INIT_ID_CAN2 = 0x08,
    PLIB_SB_INIT_ID_SQI1 = 0x09,
    PLIB_SB_INIT_ID_FLASH_CTL = 0x0A,
    PLIB_SB_INIT_ID_CRYPTO = 0x0B,
    PLIB_SB_INIT_ID_GLCD = 0x0C,
    PLIB_SB_INIT_ID_GPU = 0x0D,
    PLIB_SB_INIT_ID_SDHC = 0x0E

} PLIB_SB_INIT_ID;

typedef enum {

    PLIB_SB_PG_INITIATOR_CPU = 0x00,
    ...
    PLIB_SB_PG_INITIATOR_GLCD = 0x1A,
    PLIB_SB_PG_INITIATOR_GPU = 0x1C,
    PLIB_SB_PG_INITIATOR_SDHC = 0x12

} PLIB_SB_PG_INITIATOR;

typedef enum {

    PLIB_SB_TGT_ID_T1 = 0x00,
    PLIB_SB_TGT_ID_T2 = 0x01,
    PLIB_SB_TGT_ID_T4 = 0x02,
    PLIB_SB_TGT_ID_T5 = 0x03,
    PLIB_SB_TGT_ID_T6 = 0x04,
    PLIB_SB_TGT_ID_T7 = 0x20,
    PLIB_SB_TGT_ID_T8 = 0x21,
    PLIB_SB_TGT_ID_T9 = 0x22,
    PLIB_SB_TGT_ID_T10 = 0x23,
    PLIB_SB_TGT_ID_T11 = 0x24,
    PLIB_SB_TGT_ID_T12 = 0x25,
    PLIB_SB_TGT_ID_T13 = 0x40,
    PLIB_SB_TGT_ID_T14 = 0x41,
    PLIB_SB_TGT_ID_T15 = 0x42,
    PLIB_SB_TGT_ID_T16 = 0x60
...
typedef enum {
    ...
    PLIB_SB_T4_REGION_1 = 0x0401,
    PLIB_SB_T4_REGION_2 = 0x0402,
    PLIB_SB_T4_REGION_3 = 0x0403,
    PLIB_SB_T4_REGION_4 = 0x0404,
    PLIB_SB_T5_REGION_0 = 0x0500,
    PLIB_SB_T5_REGION_1 = 0x0501,
    PLIB_SB_T5_REGION_2 = 0x0502,
    PLIB_SB_T5_REGION_3 = 0x0503,
    PLIB_SB_T5_REGION_4 = 0x0504,
    PLIB_SB_T6_REGION_0 = 0x0600,
    PLIB_SB_T6_REGION_2 = 0x0602,
    PLIB_SB_T7_REGION_0 = 0x0700,
    PLIB_SB_T7_REGION_1 = 0x0701,
    PLIB_SB_T7_REGION_2 = 0x0702,
    ...
    PLIB_SB_T10_REGION_1 = 0x0A01,
    PLIB_SB_T11_REGION_0 = 0x0B00,
    PLIB_SB_T11_REGION_1 = 0x0B01,
    PLIB_SB_T12_REGION_0 = 0x0C00,
    PLIB_SB_T13_REGION_0 = 0x0D00,
    PLIB_SB_T13_REGION_1 = 0x0D01,
    PLIB_SB_T14_REGION_0 = 0x0E00,
    PLIB_SB_T14_REGION_1 = 0x0E01,
    PLIB_SB_T15_REGION_0 = 0x0F00,
    PLIB_SB_T16_REGION_0 = 0x1000,
    PLIB_SB_T16_REGION_1 = 0x1001,
    PLIB_SB_T16_REGION_2 = 0x1002,
    PLIB_SB_T16_REGION_3 = 0x1003,
    PLIB_SB_T16_REGION_4 = 0x1004
...
typedef enum {
    ...
    PLIB_SB_PGV_GROUP0 = 0x00,
    PLIB_SB_PGV_GROUP1 = 0x01,
    PLIB_SB_PGV_GROUP2 = 0x02,
    PLIB_SB_PGV_GROUP3 = 0x03

} PLIB_SB_PGV_GROUP_ID;

typedef enum {

    PLIB_SB_PGV_GROUP0_T1_PGV = 0x00,
    PLIB_SB_PGV_GROUP0_T4_PGV = 0x01,
    PLIB_SB_PGV_GROUP0_T5_PGV = 0x02,
    PLIB_SB_PGV_GROUP0_T2_PGV = 0x03,
    PLIB_SB_PGV_GROUP0_T6_PGV = 0x04

} PLIB_SB_PGV_GROUP0_TGT;

typedef enum {

    PLIB_SB_PGV_GROUP1_T7_PGV = 0x00,
    PLIB_SB_PGV_GROUP1_T8_PGV = 0x01,
    PLIB_SB_PGV_GROUP1_T9_PGV = 0x02,
    PLIB_SB_PGV_GROUP1_T10_PGV = 0x03,
    PLIB_SB_PGV_GROUP1_T11_PGV = 0x04,
    PLIB_SB_PGV_GROUP1_T12_PGV = 0x05

} PLIB_SB_PGV_GROUP1_TGT;

typedef enum {

    PLIB_SB_PGV_GROUP2_T13_PGV = 0x00,
    PLIB_SB_PGV_GROUP2_T14_PGV = 0x01,
    PLIB_SB_PGV_GROUP2_T15_PGV = 0x02

} PLIB_SB_PGV_GROUP2_TGT;

typedef enum {

    PLIB_SB_PGV_GROUP3_T16_PGV = 0x00
...
#include "../templates/sb_PGVErrGroupStatus_Default.h"
...
#include "../templates/sb_PGVErrStatus_PIC32_DA.h"
...
#include "../templates/sb_CPUPriority_Unsupported.h"
#include "../templates/sb_DMAPriority_Unsupported.h"

/* Section 3 - PLIB dispatch function definitions */

PLIB_INLINE_API bool PLIB_SB_ExistsPGVErrGroupStatus(SB_MODULE_ID index)
{
     return SB_ExistsPGVErrGroupStatus_Default(index);
}

PLIB_INLINE_API bool PLIB_SB_PGVErrGroupStatus(SB_MODULE_ID index, PLIB_SB_PGV_GROUP_ID groupId)
{
     return SB_PGVErrGroupStatus_Default(index, groupId);
}
...
{
     return SB_ExistsPGVErrStatus_PIC32_DA(index);
}

PLIB_INLINE_API bool PLIB_SB_PGVErrorStatus(SB_MODULE_ID index, PLIB_SB_TGT_ID target)
{
     return SB_PGVErrorStatus_PIC32_DA(index, target);
}

...
#ifndef _SB_P32MK1024GPE100_H
#define _SB_P32MK1024GPE100_H
...
typedef enum {
    ...
    PLIB_SB_INIT_ID_CPU_LRS = 0x01,
    PLIB_SB_INIT_ID_CPU_HI = 0x02,
    PLIB_SB_INIT_ID_DMA1_RD_LRS = 0x03,
    PLIB_SB_INIT_ID_DMA1_RD_HI = 0x04,
    PLIB_SB_INIT_ID_ADC = 0x07,
    PLIB_SB_INIT_ID_USB1 = 0x08,
    PLIB_SB_INIT_ID_USB2 = 0x09,
    PLIB_SB_INIT_ID_CAN1 = 0x0A,
    PLIB_SB_INIT_ID_CAN2 = 0x0B,
    PLIB_SB_INIT_ID_CAN3 = 0x0C,
    PLIB_SB_INIT_ID_CAN4 = 0x0D,
    PLIB_SB_INIT_ID_FLASH_CTL = 0x05
...
typedef enum {
    ...
    PLIB_SB_PG_INITIATOR_USB2 = 0x0A,
    PLIB_SB_PG_INITIATOR_CAN1 = 0x0C,
    PLIB_SB_PG_INITIATOR_CAN2 = 0x0E,
    PLIB_SB_PG_INITIATOR_CAN3 = 0x10,
    PLIB_SB_PG_INITIATOR_CAN4 = 0x12,
    PLIB_SB_PG_INITIATOR_FLASH_CTL = 0x16,
    PLIB_SB_PG_INITIATOR_ADCPG = 0x18
...
typedef enum {
    ...
    PLIB_SB_T2_REGION_3 = 0x0203,
    PLIB_SB_T2_REGION_4 = 0x0204,
    PLIB_SB_T2_REGION_5 = 0x0205,
    PLIB_SB_T3_REGION_0 = 0x0300,
    PLIB_SB_T3_REGION_1 = 0x0301,
    PLIB_SB_T3_REGION_2 = 0x0302,
    PLIB_SB_T3_REGION_3 = 0x0303,
    PLIB_SB_T3_REGION_4 = 0x0304,
    PLIB_SB_T3_REGION_5 = 0x0305

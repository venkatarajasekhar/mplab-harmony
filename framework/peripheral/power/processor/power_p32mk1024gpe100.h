...
#ifndef _POWER_P32MK1024GPE100_H
#define _POWER_P32MK1024GPE100_H
...
typedef enum {
    ...
    POWER_MODULE_DAC1 = 0x04,
    POWER_MODULE_DAC2 = 0x05,
    POWER_MODULE_DAC3 = 0x06,
    POWER_MODULE_CTMU = 0x08,
    POWER_MODULE_EEPROM = 0x09,
    POWER_MODULE_HLVD = 0x14,
    POWER_MODULE_CMP1 = 0x20,
    POWER_MODULE_CMP2 = 0x21,
    POWER_MODULE_CMP3 = 0x22,
    POWER_MODULE_CMP4 = 0x23,
    POWER_MODULE_CMP5 = 0x24,
    POWER_MODULE_OPAMP1 = 0x30,
    POWER_MODULE_OPAMP2 = 0x31,
    POWER_MODULE_OPAMP3 = 0x32,
    POWER_MODULE_OPAMP5 = 0x34,
    ...
    POWER_MODULE_IC10 = 0x49,
    POWER_MODULE_IC11 = 0x4A,
    POWER_MODULE_IC12 = 0x4B,
    POWER_MODULE_IC13 = 0x4C,
    POWER_MODULE_IC14 = 0x4D,
    POWER_MODULE_IC15 = 0x4E,
    POWER_MODULE_IC16 = 0x4F,
    ...
    POWER_MODULE_OC10 = 0x59,
    POWER_MODULE_OC11 = 0x5A,
    POWER_MODULE_OC12 = 0x5B,
    POWER_MODULE_OC13 = 0x5C,
    POWER_MODULE_OC14 = 0x5D,
    POWER_MODULE_OC15 = 0x5E,
    POWER_MODULE_OC16 = 0x5F,
    ...
    POWER_MODULE_USB1 = 0x98,
    POWER_MODULE_USB2 = 0x9A,
    POWER_MODULE_CAN1 = 0x9C,
    POWER_MODULE_CAN2 = 0x9D,
    POWER_MODULE_CAN3 = 0x9E,
    POWER_MODULE_CAN4 = 0x9F,

...
#ifndef _ADCHS_P32MK0512GPD100_H
#define _ADCHS_P32MK0512GPD100_H
...
typedef enum {
    ...
    ADCHS_CLASS12_AN12 = 12,
    ADCHS_CLASS12_AN13 = 13,
    ADCHS_CLASS12_AN14 = 14,
    ADCHS_CLASS12_AN15 = 15,
    ADCHS_CLASS12_AN16 = 16,
    ADCHS_CLASS12_AN17 = 17,
    ADCHS_CLASS12_AN18 = 18,
    ADCHS_CLASS12_AN19 = 19,
    ADCHS_CLASS12_AN20 = 20,
    ADCHS_CLASS12_AN21 = 21,
    ADCHS_CLASS12_AN22 = 22,
    ADCHS_CLASS12_AN23 = 23,
    ADCHS_CLASS12_AN24 = 24,
    ADCHS_CLASS12_AN25 = 25,
    ADCHS_CLASS12_AN26 = 26,
    ADCHS_CLASS12_AN27 = 27
...
typedef enum {
    ...
    ADCHS_CLASS2_AN12 = 12,
    ADCHS_CLASS2_AN13 = 13,
    ADCHS_CLASS2_AN14 = 14,
    ADCHS_CLASS2_AN15 = 15,
    ADCHS_CLASS2_AN16 = 16,
    ADCHS_CLASS2_AN17 = 17,
    ADCHS_CLASS2_AN18 = 18,
    ADCHS_CLASS2_AN19 = 19,
    ADCHS_CLASS2_AN20 = 20,
    ADCHS_CLASS2_AN22 = 22,
    ADCHS_CLASS2_AN23 = 23,
    ADCHS_CLASS2_AN24 = 24,
    ADCHS_CLASS2_AN25 = 25,
    ADCHS_CLASS2_AN26 = 26,
    ADCHS_CLASS2_AN27 = 27
...
typedef enum {
    ...
    ADCHS_SCAN_TRIGGER_SOURCE_OC1 = 16,
    ADCHS_SCAN_TRIGGER_SOURCE_OC2 = 17,
    ADCHS_SCAN_TRIGGER_SOURCE_OC3 = 18,
    ADCHS_SCAN_TRIGGER_SOURCE_OC4 = 19,
    ADCHS_SCAN_TRIGGER_SOURCE_CTMU = 20
...
typedef enum {
    ...
    ADCHS_DMA_BUFFER_LENGTH_2BYTES = 0,
    ADCHS_DMA_BUFFER_LENGTH_4BYTES = 1,
    ADCHS_DMA_BUFFER_LENGTH_8BYTES = 2,
    ADCHS_DMA_BUFFER_LENGTH_16BYTES = 3,
    ADCHS_DMA_BUFFER_LENGTH_32BYTES = 4,
    ADCHS_DMA_BUFFER_LENGTH_64BYTES = 5,
    ADCHS_DMA_BUFFER_LENGTH_128BYTES = 6,
    ADCHS_DMA_BUFFER_LENGTH_256BYTES = 7

} ADCHS_DMA_BUFFER_LENGTH;

typedef enum {

    ADCHS_DMA_GLOBAL_DISABLE = 0,
    ADCHS_DMA_GLOBAL_ENABLE = 1

} ADCHS_DMA_GLOBAL;

typedef enum {

    ADCHS_DMA_BUFFER_FULL_INTERRUPT_DISABLE = 0,
    ADCHS_DMA_BUFFER_FULL_INTERRUPT_ENABLE = 1

} ADCHS_DMA_BUFFER_FULL_INTERRUPT;

typedef enum {

    ADCHS_DMA_COUNT_DISABLE = 0,
    ADCHS_DMA_COUNT_ENABLE = 1
...
typedef enum {
    ...
    ADCHS_CHANNEL_0_ALTERNATE_INP_AN3 = 1,
    ADCHS_CHANNEL_0_ALTERNATE_INP_AN5 = 2,
    ADCHS_CHANNEL_0_ALTERNATE_INP_AN24 = 3,
    ADCHS_CHANNEL_1_DEFAULT_INP_AN1 = 4,
    ADCHS_CHANNEL_1_ALTERNATE_INP_AN4 = 5,
    ADCHS_CHANNEL_1_ALTERNATE_INP_AN7 = 6,
    ADCHS_CHANNEL_1_ALTERNATE_INP_AN0 = 7,
    ADCHS_CHANNEL_2_DEFAULT_INP_AN2 = 8,
    ADCHS_CHANNEL_2_ALTERNATE_INP_AN5 = 9,
    ADCHS_CHANNEL_2_ALTERNATE_INP_AN6 = 10,
    ADCHS_CHANNEL_2_ALTERNATE_INP_AN25 = 11,
    ADCHS_CHANNEL_3_DEFAULT_INP_AN3 = 12,
    ADCHS_CHANNEL_3_ALTERNATE_INP_AN0 = 13,
    ADCHS_CHANNEL_3_ALTERNATE_INP_AN8 = 14,
    ADCHS_CHANNEL_3_ALTERNATE_INP_AN26 = 15,
    ADCHS_CHANNEL_4_DEFAULT_INP_AN4 = 16,
    ADCHS_CHANNEL_4_ALTERNATE_INP_AN1 = 17,
    ADCHS_CHANNEL_4_ALTERNATE_INP_AN9 = 18,
    ADCHS_CHANNEL_4_ALTERNATE_INP_AN0 = 19,
    ADCHS_CHANNEL_5_DEFAULT_INP_AN5 = 20,
    ADCHS_CHANNEL_5_ALTERNATE_INP_AN2 = 21,
    ADCHS_CHANNEL_5_ALTERNATE_INP_AN6 = 22,
    ADCHS_CHANNEL_5_ALTERNATE_INP_AN25 = 23
...
typedef enum {
    ...
    ADCHS_ALTERNATE_1_CLASS1_AN3 = 1,
    ADCHS_ALTERNATE_2_CLASS1_AN5 = 2,
    ADCHS_ALTERNATE_3_CLASS1_AN24 = 3
...
typedef enum {
    ...
    ADCHS_ALTERNATE_1_CLASS1_AN4 = 5,
    ADCHS_ALTERNATE_2_CLASS1_AN7 = 6,
    ADCHS_ALTERNATE_3_CLASS1_AN0 = 7
...
typedef enum {
    ...
    ADCHS_ALTERNATE_1_CLASS1_AN5 = 9,
    ADCHS_ALTERNATE_2_CLASS1_AN6 = 10,
    ADCHS_ALTERNATE_3_CLASS1_AN25 = 11
...
typedef enum {
    ...
    ADCHS_ALTERNATE_1_CLASS1_AN0 = 13,
    ADCHS_ALTERNATE_2_CLASS1_AN8 = 14,
    ADCHS_ALTERNATE_3_CLASS1_AN26 = 15
...
typedef enum {
    ...
    ADCHS_DEFAULT_CLASS1_AN5 = 16,
    ADCHS_ALTERNATE_1_CLASS1_AN2 = 17
...
typedef enum {
    ...
    ADCHS_TRIGGER_SOURCE_OC1 = 16,
    ADCHS_TRIGGER_SOURCE_OC2 = 17,
    ADCHS_TRIGGER_SOURCE_OC3 = 18,
    ADCHS_TRIGGER_SOURCE_OC4 = 19,
    ADCHS_TRIGGER_SOURCE_CTMU = 20
...
#include "../templates/adchs_Registers_pic32mk.h"
#include "../templates/adchs_EnableControl_Default.h"
#include "../templates/adchs_TurboMode_Default.h"
#include "../templates/adchs_DigitalComparator_pic32mk.h"
#include "../templates/adchs_DigitalFilter_pic32mk.h"
#include "../templates/adchs_FIFO_Unsupported.h"
#include "../templates/adchs_DMA_Default.h"
...
#include "../templates/adchs_DigitalFeatureControl_pic32mk.h"
...
#include "../templates/adchs_Setup_pic32mk.h"
...
{
     return ADCHS_ExistsRegisters_pic32mk(index);
}
...
{
     ADCHS_DigitalComparatorAnalogInputSelect_pic32mk(index, digComparator, analogInput);
}
...
{
     ADCHS_DigitalComparatorInterruptEnable_pic32mk(index, digComparator);
}
...
{
     ADCHS_DigitalComparatorInterruptDisable_pic32mk(index, digComparator);
}
...
{
     ADCHS_DigitalComparatorSetup_pic32mk(index, id, intEnable, inBetweenOrEqual, greaterEqualHi, lessThanHi, greaterEqualLo, lessThanLo, analogInput, hiLimit, loLimit);
}

PLIB_INLINE_API bool PLIB_ADCHS_DigitalComparatorEventHasOccurred(ADCHS_MODULE_ID index, ADCHS_DIGITAL_COMPARATOR_ID id)
{
     return ADCHS_DigitalComparatorEventHasOccurred_pic32mk(index, id);
}
...
{
     ADCHS_DigitalFilterOversamplingModeSetup_pic32mk(index, id, analogInput, length, ratio, intEnable);
}
...
{
     ADCHS_DigitalFilterAveragingModeSetup_pic32mk(index, id, analogInput, length, count, intEnable);
}
...
{
     ADCHS_DigitalFilterOversamplingModeRatioSelect_pic32mk(index, id, ratio);
}
...
{
     ADCHS_DigitalFilterDataReadyInterruptEnable_pic32mk(index, digFilter);
}
...
{
     ADCHS_DigitalFilterDataReadyInterruptDisable_pic32mk(index, digFilter);
}

PLIB_INLINE_API bool PLIB_ADCHS_ExistsDigitalFilter(ADCHS_MODULE_ID index)
{
     return ADCHS_ExistsDigitalFilter_pic32mk(index);
}

PLIB_INLINE_API int32_t _PLIB_UNSUPPORTED PLIB_ADCHS_FIFORead(ADCHS_MODULE_ID index)
{
     return ADCHS_FIFORead_Unsupported(index);
}

PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_ADCHS_FIFODataIsAvailable(ADCHS_MODULE_ID index)
{
     return ADCHS_FIFODataIsAvailable_Unsupported(index);
}

PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_ADCHS_FIFODataReadyInterruptEnable(ADCHS_MODULE_ID index)
{
     ADCHS_FIFODataReadyInterruptEnable_Unsupported(index);
}

PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_ADCHS_FIFODataReadyInterruptDisable(ADCHS_MODULE_ID index)
{
     ADCHS_FIFODataReadyInterruptDisable_Unsupported(index);
}

PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_ADCHS_FIFOEnable(ADCHS_MODULE_ID index)
{
     ADCHS_FIFOEnable_Unsupported(index);
}

PLIB_INLINE_API void _PLIB_UNSUPPORTED PLIB_ADCHS_FIFODisable(ADCHS_MODULE_ID index)
{
     ADCHS_FIFODisable_Unsupported(index);
}

PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_ADCHS_FIFOSourceSelect(ADCHS_MODULE_ID index, ADCHS_CHANNEL_ID channelID)
{
     return ADCHS_FIFOSourceSelect_Unsupported(index, channelID);
}

PLIB_INLINE_API uint8_t _PLIB_UNSUPPORTED PLIB_ADCHS_FIFODataCountGet(ADCHS_MODULE_ID index)
{
     return ADCHS_FIFODataCountGet_Unsupported(index);
}

PLIB_INLINE_API ADCHS_CHANNEL_ID _PLIB_UNSUPPORTED PLIB_ADCHS_FIFOSourceGet(ADCHS_MODULE_ID index)
{
     return ADCHS_FIFOSourceGet_Unsupported(index);
}

PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_ADCHS_FIFOErrorHasOccurred(ADCHS_MODULE_ID index)
{
     return ADCHS_FIFOErrorHasOccurred_Unsupported(index);
}

PLIB_INLINE_API bool _PLIB_UNSUPPORTED PLIB_ADCHS_FIFODataIsNegative(ADCHS_MODULE_ID index)
{
     return ADCHS_FIFODataIsNegative_Unsupported(index);
}

PLIB_INLINE_API bool PLIB_ADCHS_ExistsFIFO(ADCHS_MODULE_ID index)
{
     return ADCHS_ExistsFIFO_Unsupported(index);
}

PLIB_INLINE_API void PLIB_ADCHS_DMAEnable(ADCHS_MODULE_ID index)
{
     ADCHS_DMAEnable_Default(index);
}

PLIB_INLINE_API void PLIB_ADCHS_DMADisable(ADCHS_MODULE_ID index)
{
     ADCHS_DMADisable_Default(index);
}

PLIB_INLINE_API void PLIB_ADCHS_DMASetup(ADCHS_MODULE_ID index, ADCHS_DMA_BUFFER_LENGTH bufferLengthBytes, uint32_t baseAddress, ADCHS_DMA_COUNT countMode, uint32_t countBaseAddress)
{
     ADCHS_DMASetup_Default(index, bufferLengthBytes, baseAddress, countMode, countBaseAddress);
}

PLIB_INLINE_API bool PLIB_ADCHS_DMASourceEnable(ADCHS_MODULE_ID index, ADCHS_CHANNEL_ID channelID)
{
     return ADCHS_DMASourceEnable_Default(index, channelID);
}

PLIB_INLINE_API bool PLIB_ADCHS_DMASourceDisable(ADCHS_MODULE_ID index, ADCHS_CHANNEL_ID channelID)
{
     return ADCHS_DMASourceDisable_Default(index, channelID);
}

PLIB_INLINE_API bool PLIB_ADCHS_DMABuffer_A_InterruptEnable(ADCHS_MODULE_ID index, ADCHS_CHANNEL_ID channelID)
{
     return ADCHS_DMABuffer_A_InterruptEnable_Default(index, channelID);
}

PLIB_INLINE_API bool PLIB_ADCHS_DMABuffer_A_InterruptDisable(ADCHS_MODULE_ID index, ADCHS_CHANNEL_ID channelID)
{
     return ADCHS_DMABuffer_A_InterruptDisable_Default(index, channelID);
}

PLIB_INLINE_API bool PLIB_ADCHS_DMABuffer_B_InterruptEnable(ADCHS_MODULE_ID index, ADCHS_CHANNEL_ID channelID)
{
     return ADCHS_DMABuffer_B_InterruptEnable_Default(index, channelID);
}

PLIB_INLINE_API bool PLIB_ADCHS_DMABuffer_B_InterruptDisable(ADCHS_MODULE_ID index, ADCHS_CHANNEL_ID channelID)
{
     return ADCHS_DMABuffer_B_InterruptDisable_Default(index, channelID);
}

PLIB_INLINE_API int8_t PLIB_ADCHS_DMABuffer_A_IsFull(ADCHS_MODULE_ID index, ADCHS_CHANNEL_ID channelID)
{
     return ADCHS_DMABuffer_A_IsFull_Default(index, channelID);
}

PLIB_INLINE_API int8_t PLIB_ADCHS_DMABuffer_B_IsFull(ADCHS_MODULE_ID index, ADCHS_CHANNEL_ID channelID)
{
     return ADCHS_DMABuffer_B_IsFull_Default(index, channelID);
}

PLIB_INLINE_API bool PLIB_ADCHS_DMAOverflowErrorHasOccurred(ADCHS_MODULE_ID index)
{
     return ADCHS_DMAOverflowErrorHasOccurred_Default(index);
}

PLIB_INLINE_API bool PLIB_ADCHS_ExistsDMA(ADCHS_MODULE_ID index)
{
     return ADCHS_ExistsDMA_Default(index);
}
...
{
     ADCHS_Setup_pic32mk(index, voltageRefSelect, chargePump, outputFormat, stopInIdle, sysClk, periClk, intVectorShift, intVectorBase, adcClockSource, adcClockDivider, warmUpClock);
}
...
{
     ADCHS_ChannelSetup_pic32mk(index, channelID, res, channelClockDivider, sampleTimeCount, earlyInterruptClk);
}

PLIB_INLINE_API bool PLIB_ADCHS_ExistsConfiguration(ADCHS_MODULE_ID index)
{
     return ADCHS_ExistsConfiguration_pic32mk(index);
}

...
<#else>
#define DRV_SCL_PORT_IDX2                               ${CONFIG_DRV_SCL_PORT_IDX1}
#define DRV_SCL_PIN_POSITION_IDX2                       ${CONFIG_DRV_SCL_PIN_POSITION_IDX1}
#define DRV_SDA_PORT_IDX2                               ${CONFIG_DRV_SDA_PORT_IDX1}
#define DRV_SDA_PIN_POSITION_IDX2                       ${CONFIG_DRV_SDA_PIN_POSITION_IDX1}
</#if>

...
<#-- port and pin definitions included only if either bit-bang is selected or bit-bang stop condition is selected -->
<#if CONFIG_DRV_I2C_BB_USED == true || CONFIG_DRV_I2C_MZEC_ERRATA_CHOICE == "MZ_EC_ERRATA_25_BIT_BANG_STOP">

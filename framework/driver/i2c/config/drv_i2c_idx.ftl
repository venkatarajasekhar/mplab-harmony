...
config DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE}
    string "Bit Bang Timer Source"
    depends on USE_DRV_I2C
    range DRV_TMR_INDEX	
    default "DRV_TMR_INDEX_9"
    ---help---
    IDH_HTML_PLIB_I2C_Initializing_the_I2C
    ---endhelp---
...
config DRV_I2C_BIT_BANG_TMR_MODULE_IDX${INSTANCE}
    ...
    default "TMR_ID_1" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_1"
    default "TMR_ID_2" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_2"
    default "TMR_ID_3" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_3"
    default "TMR_ID_4" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_4"
    default "TMR_ID_5" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_5"
    default "TMR_ID_6" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_6"
    default "TMR_ID_7" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_7"
    default "TMR_ID_8" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_8"
    default "TMR_ID_9" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_9"
...
config DRV_I2C_BIT_BANG_INT_SRC_IDX${INSTANCE}
	...
	depends on DRV_I2C_BIT_BANG_IDX${INSTANCE}
	depends on (DRV_I2C_OPERATION_MODE_IDX${INSTANCE} = "DRV_I2C_MODE_MASTER")
    default "INT_SOURCE_TIMER_1" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_1"
    default "INT_SOURCE_TIMER_2" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_2"
    default "INT_SOURCE_TIMER_3" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_3"
    default "INT_SOURCE_TIMER_4" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_4"
    default "INT_SOURCE_TIMER_5" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_5"
    default "INT_SOURCE_TIMER_6" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_6"
    default "INT_SOURCE_TIMER_7" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_7"
    default "INT_SOURCE_TIMER_8" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_8"
    default "INT_SOURCE_TIMER_9" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_9"
...
config DRV_I2C_BIT_BANG_INT_VECTOR_IDX${INSTANCE}
    ...
    default "INT_VECTOR_T1" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_1"
    default "INT_VECTOR_T2" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_2"
    default "INT_VECTOR_T3" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_3"
    default "INT_VECTOR_T4" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_4"
    default "INT_VECTOR_T5" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_5"
    default "INT_VECTOR_T6" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_6"
    default "INT_VECTOR_T7" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_7"
    default "INT_VECTOR_T8" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_8"
    default "INT_VECTOR_T9" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_9"

config DRV_I2C_BIT_BANG_ISR_VECTOR_IDX${INSTANCE}
    string
    depends on USE_DRV_I2C
    depends on DRV_I2C_INTERRUPT_MODE
    default "_TIMER_1_VECTOR" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_1"
    default "_TIMER_2_VECTOR" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_2"
    default "_TIMER_3_VECTOR" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_3"
    default "_TIMER_4_VECTOR" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_4"
    default "_TIMER_5_VECTOR" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_5"
    default "_TIMER_6_VECTOR" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_6"
    default "_TIMER_7_VECTOR" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_7"
    default "_TIMER_8_VECTOR" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_8"
    default "_TIMER_9_VECTOR" if DRV_I2C_BIT_BANG_TIMER_INT_SRC_IDX${INSTANCE} = "DRV_TMR_INDEX_9"
...
config DRV_I2C_STATIC_SLAVE_CALLBACK_FUNCTION_IDX${INSTANCE}
	...
	depends on USE_DRV_I2C
	depends on  DRV_I2C_STATIC_OPERATION_MODE_IDX${INSTANCE} = "DRV_I2C_MODE_SLAVE"
	default "slaveRxorTXNotification"

...
//DOM-IGNORE-END
-->
<#macro DRV_CAN_STATIC_FUNCTIONS DRV_INSTANCE CAN_INT_SRC CAN_INT_ISR CAN_INT_PRINUM CAN_INTERRUPT_MODE>
...
<@DRV_CAN_STATIC_FUNCTIONS DRV_INSTANCE="0" CAN_INT_SRC=CONFIG_DRV_CAN_INTERRUPT_SOURCE_IDX0 
CAN_INT_ISR=CONFIG_DRV_CAN_ISR_VECTOR_IDX0 CAN_INT_PRINUM=CONFIG_DRV_CAN_INT_PRIO_NUM_IDX0 
CAN_INTERRUPT_MODE=CONFIG_DRV_CAN_INTERRUPT_MODE_ID0/>
</#if>

<#if CONFIG_DRV_CAN_INST_IDX1 == true>
<@DRV_CAN_STATIC_FUNCTIONS DRV_INSTANCE="1" CAN_INT_SRC=CONFIG_DRV_CAN_INTERRUPT_SOURCE_IDX1 
CAN_INT_ISR=CONFIG_DRV_CAN_ISR_VECTOR_IDX1 CAN_INT_PRINUM=CONFIG_DRV_CAN_INT_PRIO_NUM_IDX1 
CAN_INTERRUPT_MODE=CONFIG_DRV_CAN_INTERRUPT_MODE_ID1/>
</#if>

<#if CONFIG_DRV_CAN_INST_IDX2 == true>
<@DRV_CAN_STATIC_FUNCTIONS DRV_INSTANCE="2" CAN_INT_SRC=CONFIG_DRV_CAN_INTERRUPT_SOURCE_IDX2 
CAN_INT_ISR=CONFIG_DRV_CAN_ISR_VECTOR_IDX2 CAN_INT_PRINUM=CONFIG_DRV_CAN_INT_PRIO_NUM_IDX2 
CAN_INTERRUPT_MODE=CONFIG_DRV_CAN_INTERRUPT_MODE_ID1/>
</#if>

<#if CONFIG_DRV_CAN_INST_IDX3 == true>
<@DRV_CAN_STATIC_FUNCTIONS DRV_INSTANCE="3" CAN_INT_SRC=CONFIG_DRV_CAN_INTERRUPT_SOURCE_IDX3 
CAN_INT_ISR=CONFIG_DRV_CAN_ISR_VECTOR_IDX3 CAN_INT_PRINUM=CONFIG_DRV_CAN_INT_PRIO_NUM_IDX3 
CAN_INTERRUPT_MODE=CONFIG_DRV_CAN_INTERRUPT_MODE_ID1/>
</#if>
<#--
/*******************************************************************************

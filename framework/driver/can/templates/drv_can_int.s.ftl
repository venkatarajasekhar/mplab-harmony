...
<#assign CAN_ISR_VECTOR = CONFIG_DRV_CAN_ISR_VECTOR_IDX0>
</#if>
<#if DRV_CAN_ID == "CAN_ID_2">
<#assign CAN_ISR_VECTOR = CONFIG_DRV_CAN_ISR_VECTOR_IDX1>
</#if>
<#if DRV_CAN_ID == "CAN_ID_3">
<#assign CAN_ISR_VECTOR = CONFIG_DRV_CAN_ISR_VECTOR_IDX2>
</#if>
<#if DRV_CAN_ID == "CAN_ID_4">
<#assign CAN_ISR_VECTOR = CONFIG_DRV_CAN_ISR_VECTOR_IDX3>
</#if>

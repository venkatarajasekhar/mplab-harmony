...
{
    /* set this pin low, which puts MRF24WN in hibernate mode */
    SYS_PORTS_PinWrite(PORTS_ID_0, WF_HIBERNATE_PORT_CHANNEL, WF_HIBERNATE_BIT_POS, 0);
    s_hibernateMode = true;
}

void WDRV_HibernateDisable(void)
{
    /* set this pin high, which wakes MRF24WN from hibernate mode */
    SYS_PORTS_PinWrite(PORTS_ID_0, WF_HIBERNATE_PORT_CHANNEL, WF_HIBERNATE_BIT_POS, 1);
    s_hibernateMode = false;
}

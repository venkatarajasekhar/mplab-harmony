...
/*****************************************************************************
  ...
  Description:
    Determines if Wi-Fi chip has enough memory to allocate a Tx data buffer, and,
    if so, allocates it.
...
{
    /* Notify Wi-Fi device that there is a transmit frame to send .  The frame will */
...
/*****************************************************************************
  ...
  Description:
    ...
    portion of the Wi-Fi device RAM. Thus, the Scratch data is not lost when

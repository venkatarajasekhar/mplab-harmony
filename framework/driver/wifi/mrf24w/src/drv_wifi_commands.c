...
static void IwconfigDisplayHelp(SYS_CMD_DEVICE_NODE *pCmdIO)
{
    ...
    if (firstTime) {
        ...
        strcpy(s_helpInfo, "Usage:\r\n  iwconfig\r\n" \
                "  iwconfig ssid <ssid>\r\n" \
                "  iwconfig mode <mode>\r\n" \
                "  iwconfig channel <channels>\r\n" \
                "  iwconfig power <power save mode>\r\n" \
                "  iwconfig rts <rts threshold>\r\n" \
                "  iwconfig scan\r\n" \
                "  iwconfig scanget <scan index>\r\n" \

                "Mode:\r\n  managed/idle/adhoc\r\n" \
                "Channels:\r\n  valid channels depend on region, have to be comma-separated,\r\n" \
                "  use \"all\" set to all valid channels\r\n" \
                "  Ex: iwconfig channel 1, 6, 11\r\n" \

...
typedef enum
{
    /* SPI Clock Mode 0:
        ...
        - Sampling on Rising Edge for the Serial Data In(SDI) and 
          Data Changes on Rising Edge for the Serial Data Out(SDO)*/
    DRV_SPI_CLOCK_MODE_IDLE_LOW_EDGE_RISE
        /*DOM-IGNORE-BEGIN*/  = 0 /*DOM-IGNORE-END*/,

    /* SPI Clock Mode 1:
        - Idle State of the clock is Low
        - Sampling on Falling Edge for the Serial Data In(SDI) and 
          Data Changes on Falling Edge for the Serial Data Out(SDO)*/

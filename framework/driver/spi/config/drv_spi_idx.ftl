...
config DRV_SPI_TX_ISR_VECTOR_IDX${INSTANCE}
    ...
    depends on DRV_SPI_USE_DRIVER
    depends on DRV_SPI_IDX${INSTANCE}
    depends on DRV_SPI_TASK_MODE_ISR_IDX${INSTANCE} && (PIC32MZ || PIC32WK)
...
config DRV_SPI_SPI_ID_STATIC_IDX${INSTANCE}
    ...
    default "SPI_ID_1" if DRV_WIFI_SPI_INSTANCE_INDEX = ${INSTANCE} && !BSP_PIC32MZ_EC_SK_MEB2 && !BSP_CHIPKIT_WF32
    default "SPI_ID_4" if DRV_WIFI_SPI_INSTANCE_INDEX = ${INSTANCE} && (BSP_PIC32MZ_EC_SK_MEB2 || BSP_CHIPKIT_WF32)

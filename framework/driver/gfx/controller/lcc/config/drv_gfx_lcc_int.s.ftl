 ...
 *******************************************************************************/
 -->
<#macro DRV_LCC_ASM_INT DMA_CHANNEL>
...
<@RTOS_ISR VECTOR = DMA_ISR_VECTOR NAME = "LCCRefresh" PRIORITY = CONFIG_DRV_GFX_LCC_INTERRUPT_PRIORITY/>
</#macro>
<@DRV_LCC_ASM_INT DMA_CHANNEL=CONFIG_DRV_GFX_LCC_DMA_CHANNEL_INDEX/>

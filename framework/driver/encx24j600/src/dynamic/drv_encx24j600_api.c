...
// Local information
static DRV_ENCX24J600_DriverInfo drvEncX24J600DrvInst[DRV_ENCX24J600_INSTANCES_NUMBER] __attribute__((coherent, aligned(4)));
static DRV_ENCX24J600_ClientInfo drvEncX24J600ClntInst[DRV_ENCX24J600_CLIENT_INSTANCES];
...
{
    uint8_t x;
    for (x = 0; x < DRV_ENCX24J600_CLIENT_INSTANCES; x++)
    {

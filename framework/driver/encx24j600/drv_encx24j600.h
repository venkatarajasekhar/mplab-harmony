...
typedef struct _DRV_ENCX24J600_Configuration
{
    ...
    /* Port Module of the GPIO pin hooked up to the CS/SS pin of the ENCX24J600*/
	PORTS_MODULE_ID spiSSPortModule;
    /* Port Channel of the GPIO pin hooked up to the CS/SS pin of the ENCX24J600*/
	PORTS_CHANNEL spiSSPortChannel;
    /* Pin position of the GPIO pin hooked up to the CS/SS pin of the ENCX24J600*/
	PORTS_BIT_POS spiSSPortPin;
    /* Use Interrupts or not.*/
    bool intEnable;
    /* Port Module of the GPIO pin hooked up to the INT pin of the ENCX24J600*/
	PORTS_MODULE_ID intPortModule;
    /* Port Channel of the GPIO pin hooked up to the INT pin of the ENCX24J600*/
	PORTS_CHANNEL intPortChannel;
    /* Pin Position of the GPIO pin hooked up to the INT pin of the ENCX24J600*/

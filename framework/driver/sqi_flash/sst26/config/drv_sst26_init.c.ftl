<#--
/*******************************************************************************
  SST26 Driver Initialization File

  File Name:
    drv_sst26_init.c.ftl

  Summary:
    This file contains source code necessary to initialize the SST26 driver.
...
<#if CONFIG_DRV_SST26_INST_IDX1 == true>
    sysObj.drvSst26Obj1 = DRV_SST26_Initialize(DRV_SST26_INDEX_1, (SYS_MODULE_INIT *)&drvSst26InitData1);
</#if>
</#if>
<#--
/*******************************************************************************

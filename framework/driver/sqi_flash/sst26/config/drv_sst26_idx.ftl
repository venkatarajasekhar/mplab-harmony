...
config DRV_SST26_SQI_DEVICE_IDX${INSTANCE}
    int "SQI Device Index to use"
    depends on USE_DRV_SST26
    range 0 1
    default 1
    set USE_DRV_SQI_DEVICE_0 to y if DRV_SST26_SQI_DEVICE_IDX${INSTANCE} = 0
    set USE_DRV_SQI_DEVICE_1 to y if DRV_SST26_SQI_DEVICE_IDX${INSTANCE} = 1
    ---help---

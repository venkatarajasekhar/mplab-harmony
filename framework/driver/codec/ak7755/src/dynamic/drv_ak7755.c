...
//    SPI_MODULE_ID spiID;
    ...
    if (object >= DRV_AK7755_INSTANCES_NUMBER)
    {
        SYS_DEBUG(0, "Invalid driver Index \r\n");
        return;
    }

    drvObj = &gDrvak7755Obj[object];
...
SYS_STATUS DRV_AK7755_Status( SYS_MODULE_OBJ object)
{
    ...
    if (object == SYS_MODULE_OBJ_INVALID ||
        object < DRV_AK7755_INSTANCES_NUMBER)
    {
...
)
{
     ...
     */
    if (iDriver >= DRV_AK7755_INSTANCES_NUMBER)
    {
        SYS_DEBUG(0, "Bad Driver Index \r\n");
        return DRV_HANDLE_INVALID;
    }
    drvObj = (DRV_AK7755_OBJ *)&gDrvak7755Obj[iDriver];
...
void DRV_AK7755_Close( const DRV_HANDLE handle)
{
    ...
    DRV_AK7755_OBJ *drvObj;
    //DRV_AK7755_BUFFER_OBJECT *iterator1, *iterator2;
...
)
{
    ...
    return;
} /* DRV_AK7755_BufferEventHandlerSet */



void DRV_AK7755_I2SBufferHandlerSet
(
	DRV_HANDLE handle,

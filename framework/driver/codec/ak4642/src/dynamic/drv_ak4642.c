...
void DRV_AK4642_IntExtMicSet(DRV_HANDLE handle, DRV_AK4642_INT_EXT_MIC micInput)
{
    ...
    {
        case INT_MIC :
            if(drvObj->lastRegValue[AK4642A_REG_PWR_MGMT3] == (DRV_AK4642_CONTROL_REG_FIELD_WRITE(AK4642A_REG_PWR_MGMT3, 0x06, 0, 0))){
                return;
            }
        ...
        break;
        case EXT_MIC:
            if(drvObj->lastRegValue[AK4642A_REG_PWR_MGMT3] == (DRV_AK4642_CONTROL_REG_FIELD_WRITE(AK4642A_REG_PWR_MGMT3, 0x06, 1, 0x03))){
                return;
            }
            regValue = _DRV_AK4642_CONTROL_REG_FIELD_WRITE_Wrapper(drvObj,
                    AK4642A_REG_PWR_MGMT3,
    ...
    micSetCmd->command = DRV_AK4642_COMMAND_INT_EXT_MIC_SET;

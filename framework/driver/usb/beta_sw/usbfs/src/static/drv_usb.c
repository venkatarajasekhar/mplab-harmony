...
#include "driver/usb/beta_sw/usbfs/src/drv_usb_local.h"
...
// *****************************************************************************
/* Function:
    SYS_MODULE_OBJ _DRV_USB_MAKE_NAME(Initialize)
    ( 
        const SYS_MODULE_INIT * const init
    )

  Summary:
    static impementation of _DRV_USB_MAKE_NAME(Initialize) system interface function.

  Description:
    This is the static impementation of _DRV_USB_MAKE_NAME(Initialize) system interface
...
)
{
    ...
    else
    {
        ...
        if(PLIB_USB_ExistsAutomaticSuspend(DRV_USB_PERIPHERAL_ID))
        {
        ...
        switch(pusbInit->operationMode)
        {
            case DRV_USB_OPMODE_DEVICE:
                ...
                _DRV_USB_DEVICE_INIT(pUSBDrvObj, 0);
                break;

            case DRV_USB_OPMODE_HOST:
                
                /* Initialize USB Controller for Host mode */
                _DRV_USB_HOST_INIT(pUSBDrvObj, 0);
                break;
...
}/* end of _DRV_USB_MAKE_NAME(Initialize)() */

// *****************************************************************************
/* Function:
    void _DRV_USB_MAKE_NAME(Deinitialize)()

  Summary:
    static impementation of _DRV_USB_MAKE_NAME(Deinitialize) system interface function.

  Description:
    This is the static impementation of _DRV_USB_MAKE_NAME(Deinitialize) system interface
    function.
...
void _DRV_USB_MAKE_NAME(Deinitialize)()
{
    ...
    else
    {
        ...
        returnValue = _DRV_USB_InterruptSourceDisable(DRV_USB_INTERRUPT_SOURCE);
...
} /* end of _DRV_USB_MAKE_NAME(Deinitialize)() */

// *****************************************************************************
/* Function:
    SYS_STATUS _DRV_USB_MAKE_NAME(Status)()

  Summary:
    static impementation of _DRV_USB_MAKE_NAME(Status) system interface function.

  Description:
    This is the static impementation of _DRV_USB_MAKE_NAME(Status) system interface
    function.
...
}/* end of _DRV_USB_MAKE_NAME(Status) */

// *****************************************************************************
/* Function:
    DRV_HANDLE _DRV_USB_MAKE_NAME(Open)
    (
        const DRV_IO_INTENT    ioIntent 
    )

  Summary:
    static impementation of _DRV_USB_MAKE_NAME(Open) client interface function.

  Description:
    This is the static impementation of _DRV_USB_MAKE_NAME(Open) client interface function.
...
}/* end of _DRV_USB_MAKE_NAME(Open)()*/

// *****************************************************************************
/* Function:
    bool _DRV_USB_MAKE_NAME(HOST_Resume)

  Summary:
    static implementation of _DRV_USB_MAKE_NAME(HOST_Resume)
    client interface function.

  Description:
    This is the static implementation of _DRV_USB_MAKE_NAME(HOST_Resume) client interface
...
{
    /* Start of local variable */
    DRV_USB_OBJ * pUSBDrvObj = (DRV_USB_OBJ *)&(gDrvUSBGroup.gDrvUSBObj);
    bool returnValue = false;
    /* End of local variable */
    ...
    {
        /* Enable the SOF */
        PLIB_USB_SOFEnable(DRV_USB_PERIPHERAL_ID);
        PLIB_USB_InterruptEnable(DRV_USB_PERIPHERAL_ID, USB_INT_SOF);
        returnValue = true;
    }
    return returnValue;

}/* end of _DRV_USB_MAKE_NAME(HOST_Resume)() */

// *****************************************************************************
/* Function:
    bool _DRV_USB_MAKE_NAME(HOST_Suspend)()

  Summary:
    static implementation of _DRV_USB_MAKE_NAME(HOST_Suspend)
    client interface function.

  Description:
    This is the static implementation of _DRV_USB_MAKE_NAME(HOST_Suspend) client
...
bool _DRV_USB_MAKE_NAME(HOST_Suspend)()
{
    ...
    {
        /* Disable the SOF */
        PLIB_USB_SOFDisable(DRV_USB_PERIPHERAL_ID);
        PLIB_USB_InterruptDisable(DRV_USB_PERIPHERAL_ID, USB_INT_SOF);
        returnValue = true;
    }

    return returnValue;

}/* end of _DRV_USB_MAKE_NAME(HOST_Suspend)() */

// *****************************************************************************
/* Function:
    void _DRV_USB_MAKE_NAME(Close)()

  Summary:
    static impementation of _DRV_USB_MAKE_NAME(Close) client interface function.

  Description:
    This is the static impementation of _DRV_USB_MAKE_NAME(Close) client interface
    function.
...
}/* end of _DRV_USB_MAKE_NAME(Close)() */

// *****************************************************************************
/* Function:
    void _DRV_USB_MAKE_NAME(Tasks_ISR)()

  Summary:
    static impementation of _DRV_USB_MAKE_NAME(Tasks_ISR) system interface function.

  Description:
    This is the static impementation of _DRV_USB_MAKE_NAME(Tasks_ISR) system interface
    function.
...
{
    /* Start of local variable */
    DRV_USB_OBJ * pUSBDriver = &(gDrvUSBGroup.gDrvUSBObj);
    /* End of local variable */
...
}/* end of _DRV_USB_MAKE_NAME(Tasks_ISR)()*/

// *****************************************************************************
/* Function:
    void _DRV_USB_MAKE_NAME(ClientEventCallBackSet)
    (
  ...
  Summary:
    static impementation of _DRV_USB_MAKE_NAME(ClientEventCallBackSet) client interface
    function.

  Description:
    This is the static impementation of _DRV_USB_MAKE_NAME(ClientEventCallBackSet) client
    interface function.
...
)
{
    ...
    else
    {
        ...
        if(pUSBDrvObj->operationMode == USB_OPMODE_DEVICE)
        {
            ...
            PLIB_USB_OTG_InterruptEnable(DRV_USB_PERIPHERAL_ID, USB_OTG_INT_SESSION_VALID);
...
} /* end of _DRV_USB_MAKE_NAME(ClientEventCallBackSet)() */

// *****************************************************************************
/* Function:
    void _DRV_USB_MAKE_NAME(Tasks)()
...
void _DRV_USB_MAKE_NAME(Tasks)()
{
     ...
     * is configured for polled mode operation, the _DRV_USB_Tasks_ISR function
     * will map to DRV_USB_Tasks_ISR function. In interrupt mode, this function
...
void _DRV_USB_MAKE_NAME(Tasks_ISR_USBDMA)()
{

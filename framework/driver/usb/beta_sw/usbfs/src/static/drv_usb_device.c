...
// *****************************************************************************
/* Function:
      _DRV_USB_DEVICE_Initialize(DRV_USB_OBJ * drvObj, SYS_MODULE_INDEX index)

  Summary:
    static implementation of _DRV_USB_DEVICE_Initialize system interface
    function.

  Description:
    This is the static implementation of _DRV_USB_DEVICE_Initialize system
    ...
    attached (DRV_USB_DEVICE_Attach() function will be called)
...
// *****************************************************************************
/* Function:
      void _DRV_USB_MAKE_NAME(DEVICE_AddressSet)(uint8_t address)

  Summary:
    static implementation of _DRV_USB_MAKE_NAME(DEVICE_AddressSet) client
    interface function.

  Description:
    This is the static implementation of _DRV_USB_MAKE_NAME(DEVICE_AddressSet)
...
}/* end of _DRV_USB_MAKE_NAME(DEVICE_AddressSet)() */

// *****************************************************************************
/* Function:
      USB_SPEED _DRV_USB_MAKE_NAME(DEVICE_CurrentSpeedGet)()

  Summary:
    static implementation of _DRV_USB_MAKE_NAME(DEVICE_CurrentSpeedGet) client
    interface function.

  Description:
    This is the static implementation of
    _DRV_USB_MAKE_NAME(DEVICE_CurrentSpeedGet) client interface initiaization
...
}/* end of _DRV_USB_MAKE_NAME(DEVICE_CurrentSpeedGet)() */

// *****************************************************************************
/* Function:
      _DRV_USB_MAKE_NAME(DEVICE_RemoteWakeupStart)()

  Summary:
    static implementation of _DRV_USB_MAKE_NAME(DEVICE_RemoteWakeupStart)
    client interface function.

  Description:
    This is the static implementation of
    _DRV_USB_MAKE_NAME(DEVICE_RemoteWakeupStart) client interface function for
    ...
    drive RESUME for 10ms and then _DRV_USB_MAKE_NAME(DEVICE_RemoteWakeupStop)()
...
void _DRV_USB_MAKE_NAME(DEVICE_RemoteWakeupStart)()
{
    if(!(gDrvUSBGroup.gDrvUSBObj.isOpened))
    {
        SYS_DEBUG_MESSAGE(SYS_ERROR_INFO, "Driver has not been opened");
    ...
    PLIB_USB_ResumeSignalingEnable(DRV_USB_PERIPHERAL_ID);

}/* end of _DRV_USB_MAKE_NAME(DEVICE_RemoteWakeupStart)() */

// *****************************************************************************
/* Function:
    void _DRV_USB_MAKE_NAME(DEVICE_RemoteWakeupStop)()

  Summary:
    static implementation of _DRV_USB_MAKE_NAME(DEVICE_RemoteWakeupStop) client
    interface function.

  Description:
    This is the static implementation of
    _DRV_USB_MAKE_NAME(DEVICE_RemoteWakeupStop) client interface function for
    USB device.  Function checks if driver has been opened and on success
...
void _DRV_USB_MAKE_NAME(DEVICE_RemoteWakeupStop)()
{
    ...
    PLIB_USB_ResumeSignalingDisable(DRV_USB_PERIPHERAL_ID);

}/* end of _DRV_USB_MAKE_NAME(DEVICE_RemoteWakeupStop) */

// *****************************************************************************
/* Function:
      void _DRV_USB_MAKE_NAME(DEVICE_Attach)()

  Summary:
    static implementation of _DRV_USB_MAKE_NAME(DEVICE_Attach) client interface
    function.

  Description:
    This is the static implementation of _DRV_USB_MAKE_NAME(DEVICE_Attach)
...
void _DRV_USB_MAKE_NAME(DEVICE_Attach)()
{
     ...
     * getting SUSPEND */
    PLIB_USB_AllInterruptEnable(DRV_USB_PERIPHERAL_ID,
            (USB_INT_ALL & ~USB_INT_RESUME), USB_ERR_INT_ALL,
            ((~USB_OTG_INT_ALL) | USB_OTG_INT_SESSION_VALID |
            USB_OTG_INT_ACTIVITY_DETECT));

}/* end of _DRV_USB_MAKE_NAME(DEVICE_Attach)()*/

// *****************************************************************************
/* Function:
      void _DRV_USB_MAKE_NAME(DEVICE_Detach)()

  Summary:
    static implementation of _DRV_USB_MAKE_NAME(DEVICE_Detach) client interface
    function.

  Description:
    This is the static implementation of _DRV_USB_MAKE_NAME(DEVICE_Detach)
    client interface function for USB device.  Function checks if USB driver has
...
void _DRV_USB_MAKE_NAME(DEVICE_Detach)()
{
    ...
    PLIB_USB_InterruptFlagClear(DRV_USB_PERIPHERAL_ID, USB_INT_ALL);

    /* Reset the operating mode */
    PLIB_USB_OperatingModeSelect(DRV_USB_PERIPHERAL_ID, USB_OPMODE_NONE);

}/* end of _DRV_USB_MAKE_NAME(DEVICE_Detach)() */
...
/* Function:
  ...
  Summary:
    static implementation of _DRV_USB_DEVICE_EndpointObjectEnable function.

  Description:
    This is the static implementation of _DRV_USB_DEVICE_EndpointObjectEnable
...
// *****************************************************************************
/* Function:
    USB_ERROR _DRV_USB_MAKE_NAME(DEVICE_EndpointEnable)
    (
  ...
  Summary:
    static implementation of _DRV_USB_MAKE_NAME(DEVICE_EndpointEnable) client
    interface function.

  Description:
    This is the static implementation of
    _DRV_USB_MAKE_NAME(DEVICE_EndpointEnable) client interface function for USB
...
)
{
    ...
    hDriver      = (DRV_USB_OBJ *)&(gDrvUSBGroup.gDrvUSBObj);
    ...
    if(endpointType == USB_TRANSFER_TYPE_CONTROL)
    {
        ...
        _DRV_USB_DEVICE_EndpointObjectEnable(endpointObject, endpointSize, endpointType, USB_BUFFER_DATA0);
        ...
        endpointObject ++;
        _DRV_USB_DEVICE_EndpointObjectEnable(endpointObject, endpointSize, endpointType, USB_BUFFER_DATA1);
...
}/* end of _DRV_USB_MAKE_NAME(DEVICE_EndpointEnable)() */

// *****************************************************************************
/* Function:
    USB_ERROR _DRV_USB_MAKE_NAME(DEVICE_EndpointDisable)
    (
        USB_ENDPOINT endpointAndDirection
    )

  Summary:
    static implementation of _DRV_USB_MAKE_NAME(DEVICE_EndpointDisable) client
    interface function.

  Description:
    This is the static implementation of
    _DRV_USB_MAKE_NAME(DEVICE_EndpointDisable) client interface function for USB
...
}/* end of _DRV_USB_MAKE_NAME(DEVICE_EndpointDisable)() */

// *****************************************************************************
/* Function:
    bool _DRV_USB_MAKE_NAME(DEVICE_EndpointIsEnabled)
    (
        USB_ENDPOINT endpointAndDirection
    )

  Summary:
    static implementation of _DRV_USB_MAKE_NAME(DEVICE_EndpointIsEnabled)
    client interface function.

  Description:
    This is the static implementation of DRV_USB_DEVICE_EndpointIsEnabled
...
}/* end of _DRV_USB_MAKE_NAME(DEVICE_EndpointIsEnabled)() */

// *****************************************************************************
/* Function:
    bool _DRV_USB_MAKE_NAME(DEVICE_EndpointIsStalled)
    (
        USB_ENDPOINT endpointAndDirection
    )

  Summary:
    static implementation of _DRV_USB_MAKE_NAME(DEVICE_EndpointIsStalled)
    client interface function.

  Description:
    This is the static implementation of
    _DRV_USB_MAKE_NAME(DEVICE_EndpointIsStalled) client interface function for
...
)
{
    ...
    if((endpointObj->endpointState & DRV_USB_DEVICE_ENDPOINT_STATE_STALLED) != 0)
    {
        return true;
    }
    else
...
}/* end of _DRV_USB_MAKE_NAME(DEVICE_EndpointIsStalled)() */

// *****************************************************************************
/* Function:
    void _DRV_USB_DEVICE_EndpointBDTEntryArm
    (
        DRV_USB_BDT_ENTRY * pBDT,
        DRV_USB_DEVICE_ENDPOINT_OBJ * endpointObj,
  ...
  Summary:
    static implementation of _DRV_USB_DEVICE_EndpointBDTEntryArm client
    interface function.

  Description:
    This is the static implementation of _DRV_USB_DEVICE_EndpointBDTEntryArm
...
)
{
    ...
    if(USB_DATA_DIRECTION_DEVICE_TO_HOST == direction)
    {
         ...
         * bytes sent */
        currentBDTEntry->word[1] = (uint32_t) (KVA_TO_PA (irp->data + irp->size - irp->nPendingBytes));
    ...
    else
    {
        ...
        currentBDTEntry->word[1] = (uint32_t) (KVA_TO_PA (irp->data + irp->nPendingBytes));
...
}/* end of _DRV_USB_DEVICE_EndpointBDTEntryArm() */

// *****************************************************************************
/* Function:
    USB_ERROR _DRV_USB_MAKE_NAME(DEVICE_IRPSubmit)
    (
        USB_ENDPOINT endpointAndDirection,
  ...
  Summary:
    static implementation of _DRV_USB_MAKE_NAME(DEVICE_IRPSubmit) client
    interface function.

  Description:
    This is the static implementation of DRV_USB_DEVICE_IRPSubmit client
...
)
{
    ...
    if(endpointObj->irpQueue == NULL)
    {
        ...
        _DRV_USB_DEVICE_EndpointBDTEntryArm(pBDT,endpointObj, irp, direction);
    }
    else
    {
...
}/* end of _DRV_USB_MAKE_NAME(DEVICE_IRPSubmit)() */
...
/* Function:
  ...
  Summary:
    static implementation of _DRV_USB_DEVICE_IRPQueueFlush function.

  Description:
    This is the static implementation of _DRV_USB_DEVICE_IRPQueueFlush function
...
void _DRV_USB_DEVICE_IRPQueueFlush(DRV_USB_DEVICE_ENDPOINT_OBJ * endpointObject)
{
    /* Start of local variable */
...
// *****************************************************************************
/* Function:
    USB_ERROR _DRV_USB_MAKE_NAME(DEVICE_IRPCancelAll)
    (
        USB_ENDPOINT endpointAndDirection
    )

  Summary:
    static implementation of _DRV_USB_MAKE_NAME(DEVICE_IRPCancelAll) client
    interface function.

  Description:
    This is the static implementation of
    _DRV_USB_MAKE_NAME(DEVICE_IRPCancelAll) client interface function for USB
...
}/* end of _DRV_USB_MAKE_NAME(DEVICE_IRPCancelAll)() */

// *****************************************************************************
/* Function:
    USB_ERROR _DRV_USB_MAKE_NAME(DEVICE_EndpointStall)
    (
        USB_ENDPOINT endpointAndDirection
    )

  Summary:
    static implementation of _DRV_USB_MAKE_NAME(DEVICE_EndpointStall) client
    interface function.

  Description:
    This is the static implementation of
    _DRV_USB_MAKE_NAME(DEVICE_EndpointStall) client interface function for USB
...
}/* end of _DRV_USB_MAKE_NAME(DEVICE_EndpointStall)() */

// *****************************************************************************
/* Function:
    USB_ERROR _DRV_USB_MAKE_NAME(DEVICE_EndpointStallClear)
    (
        USB_ENDPOINT endpointAndDirection
    )

  Summary:
    static implementation of _DRV_USB_MAKE_NAME(DEVICE_EndpointStallClear)
    client interface function.

  Description:
    This is the static implementation of
    _DRV_USB_MAKE_NAME(DEVICE_EndpointStallClear) client interface function for
...
}/* end of _DRV_USB_MAKE_NAME(DEVICE_EndpointStallClear)() */

// *****************************************************************************
/* Function:
      uint16_t _DRV_USB_MAKE_NAME(DEVICE_SOFNumberGet)()

  Summary:
    static implementation of _DRV_USB_MAKE_NAME(DEVICE_SOFNumberGet) client
    interface function.

  Description:
    This is the static implementation of
    _DRV_USB_MAKE_NAME(DEVICE_SOFNumberGet) client interface function for USB
...
uint16_t _DRV_USB_MAKE_NAME(DEVICE_SOFNumberGet)()
{
    ...
    {
        /* Get the Frame count */
        sofNumber = PLIB_USB_FrameNumberGet(DRV_USB_PERIPHERAL_ID);
    }

    return sofNumber;

}/* end of _DRV_USB_MAKE_NAME(DEVICE_SOFNumberGet)() */
...
/* Function:
  ...
  Summary:
    static implementation of _DRV_USB_DEVICE_Tasks_ISR ISR handler function.

  Description:
    This is the static implementation of _DRV_USB_DEVICE_Tasks_ISR ISR handler
    ...
    routinely called from USB driver DRV_USB_Tasks() function.  This function
...
void _DRV_USB_DEVICE_Tasks_ISR(DRV_USB_OBJ * hDriver)
{
    ...
    DRV_USB_BDT_ENTRY           * ep0TransmitBDTEntry;
    ...
    if(PLIB_USB_OTG_InterruptFlagGet(DRV_USB_PERIPHERAL_ID, USB_OTG_INT_SESSION_VALID)
            && PLIB_USB_OTG_InterruptIsEnabled(DRV_USB_PERIPHERAL_ID, USB_OTG_INT_SESSION_VALID))
    {

        /* This means there was a change in the VBUS voltage detected level. We
         * can find out if the VBUS is valid */

        if(PLIB_USB_OTG_SessionValid(DRV_USB_PERIPHERAL_ID))
        {
            /* This means we detected a valid VBUS voltage. */
            hDriver->vbusIsValid = true;
            eventType = DRV_USB_EVENT_DEVICE_SESSION_VALID; 
        }
        else
        {
            /* This means the VBUS is not valid anymore */
            hDriver->vbusIsValid = false;
            eventType = DRV_USB_EVENT_DEVICE_SESSION_INVALID;
        }
        ...
        /* Clear the interrupt */
        PLIB_USB_OTG_InterruptFlagClear(DRV_USB_PERIPHERAL_ID, USB_OTG_INT_SESSION_VALID);
    }
    ...
    {
        PLIB_USB_ErrorInterruptFlagClear(DRV_USB_PERIPHERAL_ID, USB_ERR_INT_ALL);
        PLIB_USB_InterruptFlagClear(DRV_USB_PERIPHERAL_ID, USB_INT_ALL);
        PLIB_USB_OTG_InterruptFlagClear(DRV_USB_PERIPHERAL_ID, (USB_OTG_INT_ALL & (~ USB_OTG_INT_SESSION_VALID))); 
        return;
    }
    ...
    if(PLIB_USB_OTG_InterruptFlagGet(DRV_USB_PERIPHERAL_ID, USB_OTG_INT_ACTIVITY_DETECT)
            && PLIB_USB_OTG_InterruptIsEnabled(DRV_USB_PERIPHERAL_ID, USB_OTG_INT_ACTIVITY_DETECT ))
    {
        /* Clear the interrupt */
        PLIB_USB_OTG_InterruptFlagClear(DRV_USB_PERIPHERAL_ID, USB_OTG_INT_ACTIVITY_DETECT);

        /* Disable the interrupt */
        PLIB_USB_OTG_InterruptDisable(DRV_USB_PERIPHERAL_ID, USB_OTG_INT_ACTIVITY_DETECT);
        ...
        {
            /* Send this event to the client */
            hDriver->pEventCallBack(hDriver->hClientArg, DRV_USB_EVENT_RESUME_DETECT,  (void *)NULL);
        }

    }

    /* The RESUME event can only occur after the device has been suspended. */
    if (PLIB_USB_InterruptFlagGet(DRV_USB_PERIPHERAL_ID, USB_INT_RESUME)
            && PLIB_USB_InterruptIsEnabled(DRV_USB_PERIPHERAL_ID, USB_INT_RESUME))
    {
        /* Device is not suspended any more */
        hDriver->isSuspended = false;
        ...
        PLIB_USB_InterruptFlagClear(DRV_USB_PERIPHERAL_ID, USB_INT_RESUME);
        PLIB_USB_InterruptDisable(DRV_USB_PERIPHERAL_ID, USB_INT_RESUME);
    }

    /* Check if RESET signalling was received */
    if ( PLIB_USB_InterruptFlagGet(DRV_USB_PERIPHERAL_ID, USB_INT_DEVICE_RESET)
            && PLIB_USB_InterruptIsEnabled(DRV_USB_PERIPHERAL_ID, USB_INT_DEVICE_RESET))
    {
        /* Device is not suspended any more */
        hDriver->isSuspended = false;
        ...
        PLIB_USB_InterruptFlagClear( DRV_USB_PERIPHERAL_ID, USB_INT_RESUME );
        PLIB_USB_InterruptFlagClear( DRV_USB_PERIPHERAL_ID, USB_INT_IDLE_DETECT );
        ...
        {
            /* Send this event to the client */
            hDriver->pEventCallBack(hDriver->hClientArg, DRV_USB_EVENT_RESET_DETECT,  (void *)NULL);
        }

        /* Clear the interrupt flag */
        PLIB_USB_InterruptFlagClear(DRV_USB_PERIPHERAL_ID, USB_INT_DEVICE_RESET);

    }

    /* Check if the host has suspended the bus. */
    if (PLIB_USB_InterruptFlagGet(DRV_USB_PERIPHERAL_ID, USB_INT_IDLE_DETECT)
            && PLIB_USB_InterruptIsEnabled(DRV_USB_PERIPHERAL_ID, USB_INT_IDLE_DETECT))
    {
        /* The bus is IDLE and is suspended. Send the event to the client. */
        if(hDriver->pEventCallBack != NULL)
        {
            /* Send this event to the client */
            hDriver->pEventCallBack(hDriver->hClientArg, DRV_USB_EVENT_IDLE_DETECT,  (void *)NULL);
        }
        ...
        PLIB_USB_InterruptEnable(DRV_USB_PERIPHERAL_ID, USB_OTG_INT_ACTIVITY_DETECT);

        /* Enable the resume interrupt */
        PLIB_USB_InterruptEnable(DRV_USB_PERIPHERAL_ID, USB_INT_RESUME);
    ...
    if (PLIB_USB_InterruptFlagGet(DRV_USB_PERIPHERAL_ID,USB_INT_SOF)
            && PLIB_USB_InterruptIsEnabled(DRV_USB_PERIPHERAL_ID, USB_INT_SOF))
    {
        ...
        {
            /* Send this event to the client */
            hDriver->pEventCallBack(hDriver->hClientArg, DRV_USB_EVENT_SOF_DETECT,  (void *)NULL);
        }

        /* Clear the interrupt flag */
        PLIB_USB_InterruptFlagClear(DRV_USB_PERIPHERAL_ID, USB_INT_SOF);
    }
     ...
     * data to the client. */
    if (PLIB_USB_InterruptFlagGet(DRV_USB_PERIPHERAL_ID, USB_INT_STALL)
            && PLIB_USB_InterruptIsEnabled(DRV_USB_PERIPHERAL_ID, USB_INT_STALL))
    {
        ...
        {
            /* Send this event to the client */
            hDriver->pEventCallBack(hDriver->hClientArg, DRV_USB_EVENT_STALL,  (void *)NULL);
        }

        /* Clear the interrupt flag */
        PLIB_USB_InterruptFlagClear(DRV_USB_PERIPHERAL_ID, USB_INT_STALL);

    }

    /* Check if an error has occurred */
    if ( PLIB_USB_InterruptFlagGet(DRV_USB_PERIPHERAL_ID, USB_INT_ERROR ) &&
            PLIB_USB_InterruptIsEnabled(DRV_USB_PERIPHERAL_ID, USB_INT_ERROR))
    {
        ...
        {
            /* Send this event to the client */
            hDriver->pEventCallBack(hDriver->hClientArg, DRV_USB_EVENT_ERROR,  (void *)&errorType);
        }
    }
    ...
    while(PLIB_USB_InterruptFlagGet(DRV_USB_PERIPHERAL_ID, USB_INT_TOKEN_DONE))
    {
        ...
        if(processNextIRP)
        {
             ...
             * should not call the _DRV_USB_DEVICE_EndpointBDTEntryArm() */

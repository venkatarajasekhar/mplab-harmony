...
/* Function:
  ...
  Summary:
    Dynamic impementation of _DRV_USB_DEVICE_Initialize system interface function.

  Description:
    This is the dynamic impementation of _DRV_USB_DEVICE_Initialize system
...
void DRV_USB_DEVICE_AddressSet(DRV_HANDLE handle, uint8_t address)
{
    ...
    /* Set the address */
    PLIB_USB_DeviceAddressSet( ((DRV_USB_OBJ *)handle)->usbID, address );
...
// *****************************************************************************
/* Function:
      void DRV_USB_DEVICE_RemoteWakeup_Start(DRV_HANDLE handle)
  ...
  Description:
    This is the dynamic impementation of DRV_USB_DEVICE_RemoteWakeup_Start
    ...
    DRV_USB_DEVICE_RemoteWakeupStop() function should be called to clear
    RESUME.
...
/* Function:
  ...
  Summary:
    Dynamic impementation of DRV_USB_DEVICE_RemoteWakeupStop client interface
    function.

  Description:
    This is the dynamic impementation of DRV_USB_DEVICE_RemoteWakeupStop client
...
/* Function:
  ...
  Summary:
    Dynamic impementation of DRV_USB_DEVICE_Attach client interface
    function.

  Description:
    This is the dynamic impementation of DRV_USB_DEVICE_Attach client interface
...
/* Function:
  ...
  Summary:
    Dynamic impementation of DRV_USB_DEVICE_Detach client interface
    function.

  Description:
    This is the dynamic impementation of DRV_USB_DEVICE_Detach client interface
    function for USB device.  Function checks the input handle validity and on
...
void DRV_USB_DEVICE_Detach(DRV_HANDLE handle)
{
    ...
    ((DRV_USB_OBJ *)handle)->isAttached = false;

    /* Clear all the interrupts */
    PLIB_USB_InterruptFlagClear(((DRV_USB_OBJ *)handle)->usbID, USB_INT_ALL);

    /* Reset the operationg mode */
    PLIB_USB_OperatingModeSelect(((DRV_USB_OBJ *)handle)->usbID, USB_OPMODE_NONE);
...
)
{
    ...
    usbID        = ((DRV_USB_OBJ *)handle)->usbID;
...
/* Function:
  ...
  Summary:
    Dynamic impementation of _DRV_USB_DEVICE_EndpointBDTEntryArm client interface
    function.

  Description:
    This is the dynamic impementation of _DRV_USB_DEVICE_EndpointBDTEntryArm
...
/* Function:
  ...
  Description:
    This is the dynamic impementation of _DRV_USB_DEVICE_IRPQueueFlush function
...
)
{
    ...
    usbID        = ((DRV_USB_OBJ *)client)->usbID;
    hDriver      = ((DRV_USB_OBJ *)client);
...
/* Function:
  ...
  Description:
    This is the dynamic impementation of DRV_USB_DEVICE_EndpointStallClear

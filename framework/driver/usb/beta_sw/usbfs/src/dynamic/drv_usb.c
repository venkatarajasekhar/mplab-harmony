...
)
{
    ...
    {
        SYS_DEBUG(SYS_ERROR_INFO, "USB Driver: Invalid driver index");
...
)
{
    ...
    {
        /* Invalid object */
        SYS_DEBUG(SYS_ERROR_INFO, "USB Driver: Invalid System Module Object");
    }
    ...
    else
    {
        ...
        returnValue = _DRV_USB_InterruptSourceDisable(pUSBDrvObj->interruptSource);
...
)
{
    ...
    {
        /* Invalid object */
        SYS_DEBUG(SYS_ERROR_INFO, "USB Driver: Invalid object");
    }
    else
    {
...
/* Function:
  ...
  Description:
    This is the dynamic impementation of DRV_USB_Open client interface function.
...
)
{
    ...
    if(drvIndex >= DRV_USB_INSTANCES_NUMBER)
    {
        SYS_DEBUG(SYS_ERROR_INFO, "USB Driver: Bad Driver Index");
    }
...
/* Function:
  ...
  Description:
    This is the dynamic implementation of DRV_USB_HOST_Resume client interface
...
)
{
    ...
    else
    {
        ...
        {
            SYS_DEBUG(SYS_ERROR_INFO, "Client Handle already closed");
        }
...
/* Function:
  ...
  Summary:
    Dynamic impementation of DRV_USB_ClientEventCallBackSet client interface
    function.

  Description:
    This is the dynamic impementation of DRV_USB_ClientEventCallBackSet client
    interface function.

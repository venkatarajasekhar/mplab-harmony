...
typedef struct _DRV_SRAM_BUFFER_OBJ_STRUCT
{
    ...
    struct _DRV_SRAM_BUFFER_OBJ_STRUCT *next;

    /* Pointer to the previous buffer in the queue */
    struct _DRV_SRAM_BUFFER_OBJ_STRUCT *previous;
...
typedef struct _DRV_SRAM_OBJ_STRUCT
{
    ...
    /* The buffer queue for the read/write operations */
    DRV_SRAM_BUFFER_OBJECT *rwQueue;

...
#if defined (DRV_SRAM_SYS_FS_REGISTER)
#define _DRV_SRAM_RegisterWithSysFs(x, y, z) SYS_FS_MEDIA_MANAGER_Register((SYS_MODULE_OBJ)x, (SYS_MODULE_INDEX)y, &z, SYS_FS_MEDIA_TYPE_RAM)
#else
#define _DRV_SRAM_RegisterWithSysFs(x, y, z)
#endif

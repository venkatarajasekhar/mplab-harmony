...
typedef struct _DRV_ENC28J60_Configuration
{
    ...
    /* Bus speed to use for the SPI interface.  Section 1.0 of the ENC28J60 data sheets says the maximum is 20000000 Hz.  It is not recommended to go above this value.*/
	uint32_t spiBps;
	...
	/* Port Module of the GPIO pin hooked up to the CS/SS pin of the ENC28J60*/
	PORTS_MODULE_ID spiSSPortModule;
    /* Port Channel of the GPIO pin hooked up to the CS/SS pin of the ENC28J60*/
	PORTS_CHANNEL spiSSPortChannel;
    /* Pin position of the GPIO pin hooked up to the CS/SS pin of the ENC28J60*/
	PORTS_BIT_POS spiSSPortPin;

	/* Use Interrupts or not.*/
    bool intEnable;
    /* Port Module of the GPIO pin hooked up to the INT pin of the ENC28J60*/
	PORTS_MODULE_ID intPortModule;
    /* Port Channel of the GPIO pin hooked up to the INT pin of the ENC28J60*/
	PORTS_CHANNEL intPortChannel;
    /* Pin Position of the GPIO pin hooked up to the INT pin of the ENC28J60*/
	PORTS_BIT_POS intPortPin;
	
    /* To select the control type of the MDIX.  This is only needed for hooking up to switches that don't have auto-mdix.*/
    DRV_ENC28J60_MDIX_TYPE mdixControl;
    /* Port Module of the GPIO pin hooked up to the MDIX select pin*/    
	PORTS_MODULE_ID mdixPortModule;
    /* Port Channel of the GPIO pin hooked up to the MDIX select pin*/    
	PORTS_CHANNEL mdixPortChannel;
    /* Pin Position of the GPIO pin hooked up to the MDIX select pin*/    

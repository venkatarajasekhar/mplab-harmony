...
void __ISR(${IC_INT_ISR}, ipl${IC_INT_PRINUM}SOFT) _IntHandlerDrvICInstance${DRV_INSTANCE}(void)
<#else>
<#if CONFIG_3RDPARTY_RTOS_USED == "embOS">
void __attribute__( (interrupt(ipl${IC_INT_PRINUM}AUTO), vector(${IC_INT_ISR}))) IntHandlerDrvICInstance${DRV_INSTANCE}_ISR( void );
</#if>
...
<#if CONFIG_USE_3RDPARTY_RTOS>
<#if CONFIG_3RDPARTY_RTOS_USED == "ThreadX">
void __ISR(${IC_EINT_ISR}, ipl${IC_EINT_PRINUM}SOFT) _IntHandlerDrvICErrorInstance${DRV_INSTANCE}(void)
<#else>
<#if CONFIG_3RDPARTY_RTOS_USED == "embOS">
void __attribute__( (interrupt(ipl${IC_EINT_PRINUM}AUTO), vector(${IC_EINT_ISR}))) IntHandlerDrvICErrorInstance${DRV_INSTANCE}_ISR( void );
</#if>
...
<@DRV_IC_STATIC_FUNCTIONS DRV_INSTANCE="9" IC_INT_SRC=CONFIG_DRV_IC_INTERRUPT_SOURCE_IDX9
IC_EINT_SRC=CONFIG_DRV_IC_ERR_INTERRUPT_SOURCE_IDX9 IC_INT_ISR=CONFIG_DRV_IC_ISR_VECTOR_IDX9
IC_INT_PRINUM=CONFIG_DRV_IC_INT_PRIO_NUM_IDX9 IC_EINT_ISR=CONFIG_DRV_IC_ERR_ISR_VECTOR_IDX9
IC_EINT_PRINUM=CONFIG_DRV_IC_ERR_INT_PRIO_NUM_IDX9/>
</#if>
<#if CONFIG_DRV_IC_INST_IDX10 == true>
<@DRV_IC_STATIC_FUNCTIONS DRV_INSTANCE="10" IC_INT_SRC=CONFIG_DRV_IC_INTERRUPT_SOURCE_IDX10
IC_EINT_SRC=CONFIG_DRV_IC_ERR_INTERRUPT_SOURCE_IDX10 IC_INT_ISR=CONFIG_DRV_IC_ISR_VECTOR_IDX10
IC_INT_PRINUM=CONFIG_DRV_IC_INT_PRIO_NUM_IDX10 IC_EINT_ISR=CONFIG_DRV_IC_ERR_ISR_VECTOR_IDX10
IC_EINT_PRINUM=CONFIG_DRV_IC_ERR_INT_PRIO_NUM_IDX10/>
</#if>
<#if CONFIG_DRV_IC_INST_IDX11 == true>
<@DRV_IC_STATIC_FUNCTIONS DRV_INSTANCE="11" IC_INT_SRC=CONFIG_DRV_IC_INTERRUPT_SOURCE_IDX11
IC_EINT_SRC=CONFIG_DRV_IC_ERR_INTERRUPT_SOURCE_IDX11 IC_INT_ISR=CONFIG_DRV_IC_ISR_VECTOR_IDX11
IC_INT_PRINUM=CONFIG_DRV_IC_INT_PRIO_NUM_IDX11 IC_EINT_ISR=CONFIG_DRV_IC_ERR_ISR_VECTOR_IDX11
IC_EINT_PRINUM=CONFIG_DRV_IC_ERR_INT_PRIO_NUM_IDX11/>
</#if>
<#if CONFIG_DRV_IC_INST_IDX12 == true>
<@DRV_IC_STATIC_FUNCTIONS DRV_INSTANCE="12" IC_INT_SRC=CONFIG_DRV_IC_INTERRUPT_SOURCE_IDX12
IC_EINT_SRC=CONFIG_DRV_IC_ERR_INTERRUPT_SOURCE_IDX12 IC_INT_ISR=CONFIG_DRV_IC_ISR_VECTOR_IDX12
IC_INT_PRINUM=CONFIG_DRV_IC_INT_PRIO_NUM_IDX12 IC_EINT_ISR=CONFIG_DRV_IC_ERR_ISR_VECTOR_IDX12
IC_EINT_PRINUM=CONFIG_DRV_IC_ERR_INT_PRIO_NUM_IDX12/>
</#if>
<#if CONFIG_DRV_IC_INST_IDX13 == true>
<@DRV_IC_STATIC_FUNCTIONS DRV_INSTANCE="13" IC_INT_SRC=CONFIG_DRV_IC_INTERRUPT_SOURCE_IDX13
IC_EINT_SRC=CONFIG_DRV_IC_ERR_INTERRUPT_SOURCE_IDX13 IC_INT_ISR=CONFIG_DRV_IC_ISR_VECTOR_IDX13
IC_INT_PRINUM=CONFIG_DRV_IC_INT_PRIO_NUM_IDX13 IC_EINT_ISR=CONFIG_DRV_IC_ERR_ISR_VECTOR_IDX13
IC_EINT_PRINUM=CONFIG_DRV_IC_ERR_INT_PRIO_NUM_IDX13/>
</#if>
<#if CONFIG_DRV_IC_INST_IDX14 == true>
<@DRV_IC_STATIC_FUNCTIONS DRV_INSTANCE="14" IC_INT_SRC=CONFIG_DRV_IC_INTERRUPT_SOURCE_IDX14
IC_EINT_SRC=CONFIG_DRV_IC_ERR_INTERRUPT_SOURCE_IDX14 IC_INT_ISR=CONFIG_DRV_IC_ISR_VECTOR_IDX14
IC_INT_PRINUM=CONFIG_DRV_IC_INT_PRIO_NUM_IDX14 IC_EINT_ISR=CONFIG_DRV_IC_ERR_ISR_VECTOR_IDX14
IC_EINT_PRINUM=CONFIG_DRV_IC_ERR_INT_PRIO_NUM_IDX14/>
</#if>
<#if CONFIG_DRV_IC_INST_IDX15 == true>
<@DRV_IC_STATIC_FUNCTIONS DRV_INSTANCE="15" IC_INT_SRC=CONFIG_DRV_IC_INTERRUPT_SOURCE_IDX15
IC_EINT_SRC=CONFIG_DRV_IC_ERR_INTERRUPT_SOURCE_IDX15 IC_INT_ISR=CONFIG_DRV_IC_ISR_VECTOR_IDX15
IC_INT_PRINUM=CONFIG_DRV_IC_INT_PRIO_NUM_IDX15 IC_EINT_ISR=CONFIG_DRV_IC_ERR_ISR_VECTOR_IDX15
IC_EINT_PRINUM=CONFIG_DRV_IC_ERR_INT_PRIO_NUM_IDX15/>
</#if>
<#--
/*******************************************************************************
 End of File

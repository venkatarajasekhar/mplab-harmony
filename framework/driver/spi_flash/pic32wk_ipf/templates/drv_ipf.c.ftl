...
<#if CONFIG_DRV_IPF_HOLD_PIN_PORT_CHANNEL?has_content>
    .holdPortChannel = DRV_IPF_HOLD_PIN_PORT_CHANNEL,
</#if>
<#if CONFIG_DRV_IPF_HOLD_PIN_PORT_BIT_POS?has_content>
    .holdBitPosition = DRV_IPF_HOLD_PIN_PORT_BIT_POS,
</#if>
<#if CONFIG_DRV_IPF_WRITE_PROTECT_PIN_PORT_CHANNEL?has_content>
    .writeProtectPortChannel = DRV_IPF_WRITE_PROTECT_PIN_PORT_CHANNEL,
</#if>
<#if CONFIG_DRV_IPF_WRITE_PROTECT_PIN_BIT_POS?has_content>
    .writeProtectBitPosition = DRV_IPF_WRITE_PROTECT_PIN_BIT_POS,
</#if>
<#if CONFIG_DRV_IPF_CHIP_SELECT_PORT_CHANNEL?has_content>
    .chipSelectPortChannel = DRV_IPF_CHIP_SELECT_PORT_CHANNEL,
</#if>
<#if CONFIG_DRV_IPF_CHIP_SELECT_PORT_BIT_POS?has_content>
    .chipSelectBitPosition = DRV_IPF_CHIP_SELECT_PORT_BIT_POS,
</#if>
<#if CONFIG_DRV_IPF_QUEUE_SIZE?has_content>

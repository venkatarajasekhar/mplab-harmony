...
/* Function:
  ...
  Parameters:
    ...
    blockStart -   Start block address of SST25 Flash where the write 
  ...
  Example:
    ...
    uint8_t myBuffer[MY_BUFFER_SIZE];
    uint32_t blockStart = SST25_BASE_ADDRESS_TO_WRITE_TO;
    uint32_t    nBlock = 2;
    DRV_SST25_BLOCK_COMMAND_HANDLE commandHandle;
    MY_APP_OBJ myAppObj;    
...
/* Function:
  ...
  Parameters:
    ...
    writeBlockStart - Start block address of SST25 Flash where the write should begin.

...
typedef enum
{
    ...
    // MRF24WN Wi-Fi MAC:  room for 16 MRF24WN devices
...
typedef struct
{
    ...
    /* Ethernet module ID for this driver instance */
    ETH_MODULE_ID                   ethModuleId;

    /* Non-volatile pointer to the PHY vendor object associated with this MAC */

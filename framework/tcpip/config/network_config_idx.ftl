...
ifblock PIC32WK
config TCPIP_NETWORK_DEFAULT_INTERFACE_WK_NAME_IDX${INSTANCE}
    string "Interface"
    depends on TCPIP_STACK_NETWORK_CONFIG_IDX${INSTANCE}    
    default "PIC32WK"
    ---help---
...
config TCPIP_NETWORK_DEFAULT_HOST_NAME_IDX${INSTANCE}
    ...
    default "PIC32WK" if TCPIP_NETWORK_DEFAULT_INTERFACE_WK_NAME_IDX${INSTANCE} = "PIC32WK"
    ---help---
    IDH_HTML_TCPIP_NETWORK_CONFIG
    ---endhelp---
...
config TCPIP_NETWORK_DEFAULT_IP_ADDRESS_IDX${INSTANCE}
    ...
    default "192.168.100.15${INSTANCE}" if TCPIP_NETWORK_DEFAULT_INTERFACE_WK_NAME_IDX${INSTANCE} = "PIC32WK"
    depends on TCPIP_STACK_NETWORK_CONFIG_IDX${INSTANCE}
    ---help---
    IDH_HTML_TCPIP_NETWORK_CONFIG
    ---endhelp---
...
config TCPIP_NETWORK_DEFAULT_GATEWAY_IDX${INSTANCE}
    ...
    default "192.168.100.1" if TCPIP_NETWORK_DEFAULT_INTERFACE_WK_NAME_IDX${INSTANCE} = "PIC32WK"
    ---help---
    IDH_HTML_TCPIP_NETWORK_CONFIG
    ---endhelp---
...
config TCPIP_NETWORK_CONFIG_MULTICAST_IDX${INSTANCE}
    depends on TCPIP_STACK_NETWORK_CONFIG_IDX${INSTANCE}
    bool "Multicast Enabled on this Interface"
    default n
    ---help---
    IDH_HTML_TCPIP_NETWORK_CONFIG_FLAGS
    ---endhelp---
...
config TCPIP_NETWORK_DEFAULT_MAC_DRIVER_IDX${INSTANCE}
    ...
    default "DRV_PIC32WK_MACObject" if TCPIP_NETWORK_DEFAULT_INTERFACE_WK_NAME_IDX${INSTANCE} = "PIC32WK"
    ---help---
    IDH_HTML_TCPIP_NETWORK_CONFIG
    ---endhelp---

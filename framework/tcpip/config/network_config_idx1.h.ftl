...
#define TCPIP_NETWORK_DEFAULT_INTERFACE_NAME_IDX1 		"${CONFIG_TCPIP_NETWORK_DEFAULT_INTERFACE_WK_NAME_IDX1}"
<#else>
/*** Network Configuration Index 0 ***/
...
<#elseif CONFIG_TCPIP_NETWORK_DEFAULT_INTERFACE_WK_NAME_IDX1 = "PIC32WK">
...
<#if CONFIG_TCPIP_NETWORK_CONFIG_MULTICAST_IDX1>
...
<#if CONFIG_TCPIP_NETWORK_DEFAULT_IPV6_PREFIX_LENGTH_IDX1?has_content>

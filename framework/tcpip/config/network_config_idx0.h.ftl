...
<#if CONFIG_TCPIP_NETWORK_DEFAULT_INTERFACE_WK_NAME_IDX0 == "PIC32WK">  
/*** Network Configuration Index 0 ***/
#define TCPIP_NETWORK_DEFAULT_INTERFACE_NAME 			"${CONFIG_TCPIP_NETWORK_DEFAULT_INTERFACE_WK_NAME_IDX0}"
<#else>  
/*** Network Configuration Index 0 ***/
...
<#elseif CONFIG_TCPIP_NETWORK_DEFAULT_INTERFACE_WK_NAME_IDX0 = "PIC32WK">
...
<#if CONFIG_TCPIP_NETWORK_CONFIG_MULTICAST_IDX0>
...
<#if CONFIG_TCPIP_NETWORK_DEFAULT_IPV6_PREFIX_LENGTH_IDX0?has_content>
